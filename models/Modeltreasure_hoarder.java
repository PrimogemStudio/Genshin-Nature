...
public static class Modeltreasure_hoarder extends EntityModel<Entity> {
	...
	public Modeltreasure_hoarder() {
		...
		RightArm.setTextureOffset(40, 16).addBox(-3.0F, -2.0F, -2.0F, 4.0F, 12.0F, 4.0F, 0.0F, true);
