...
public class Modelcryo_regisvine<T extends Entity> extends EntityModel<T> {
	// This layer location should be baked with EntityRendererProvider.Context in the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("modid", "cryo_regisvine"), "main");
	...
	public Modelcryo_regisvine(ModelPart root) {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition cube_r5 = bone.addOrReplaceChild("cube_r5", CubeListBuilder.create().texOffs(94, 91).addBox(-4.5F, -25.6577F, -3.3126F, 9.0F, 29.0F, 8.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.5F, -16.5668F, 10.9249F, 0.2618F, 0.0F, 0.0F));

		PartDefinition cube_r6 = bone.addOrReplaceChild("cube_r6", CubeListBuilder.create().texOffs(94, 92).addBox(-4.0F, -20.5F, -2.0F, 9.0F, 28.0F, 8.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, -0.5672F, 0.0F, 0.0F));

		PartDefinition head = partdefinition.addOrReplaceChild("head", CubeListBuilder.create(), PartPose.offset(0.5F, -53.3932F, 7.5616F));

		PartDefinition cube_r7 = head.addOrReplaceChild("cube_r7", CubeListBuilder.create().texOffs(96, 101).addBox(-4.5F, -15.6264F, -2.7579F, 9.0F, 20.0F, 7.0F, new CubeDeformation(0.0F))
		...
		PartDefinition cube_r8 = head.addOrReplaceChild("cube_r8", CubeListBuilder.create().texOffs(25, 30).mirror().addBox(-1.5F, -2.1493F, -0.5711F, 3.0F, 3.0F, 6.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(-3.0F, -8.6706F, -18.0576F, 1.4366F, -0.1726F, -0.9047F));

		PartDefinition cube_r9 = head.addOrReplaceChild("cube_r9", CubeListBuilder.create().texOffs(25, 30).addBox(-1.5F, -2.1493F, -0.5711F, 3.0F, 3.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(3.0F, -8.6706F, -18.0576F, 1.4366F, 0.1726F, 0.9047F));
		...
		PartDefinition cube_r10 = bone2.addOrReplaceChild("cube_r10", CubeListBuilder.create().texOffs(0, 50).addBox(-47.9591F, -3.0862F, 4.7932F, 49.0F, 3.0F, 5.0F, new CubeDeformation(0.0F))
		...
		.texOffs(104, 0).addBox(43.0409F, -3.0862F, 9.7932F, 7.0F, 3.0F, 5.0F, new CubeDeformation(0.0F))
		.texOffs(0, 50).mirror().addBox(5.0409F, -3.0862F, 4.7932F, 49.0F, 3.0F, 5.0F, new CubeDeformation(0.0F)).mirror(false)
		.texOffs(0, 0).mirror().addBox(5.0409F, 0.9138F, 0.7932F, 19.0F, 1.0F, 13.0F, new CubeDeformation(0.0F)).mirror(false)
		.texOffs(0, 0).addBox(-17.9591F, 0.9138F, 0.7932F, 19.0F, 1.0F, 13.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 1.4153F, 0.1536F, 0.7734F));
		...
		PartDefinition cube_r11 = bone3.addOrReplaceChild("cube_r11", CubeListBuilder.create().texOffs(0, 0).addBox(-17.3668F, 0.9432F, -0.1464F, 19.0F, 1.0F, 13.0F, new CubeDeformation(0.0F))
		...
		.texOffs(104, 0).addBox(-14.3668F, -4.0568F, -1.1464F, 7.0F, 3.0F, 5.0F, new CubeDeformation(0.0F))
		...
		.texOffs(104, 0).addBox(13.6332F, -4.0568F, 8.8536F, 7.0F, 3.0F, 5.0F, new CubeDeformation(0.0F))
		...
		.texOffs(104, 0).addBox(43.6332F, -4.0568F, -1.1464F, 7.0F, 3.0F, 5.0F, new CubeDeformation(0.0F))
		.texOffs(0, 50).mirror().addBox(5.6332F, -4.0568F, 3.8536F, 49.0F, 3.0F, 5.0F, new CubeDeformation(0.0F)).mirror(false)
		.texOffs(0, 50).addBox(-48.3668F, -4.0568F, 3.8536F, 49.0F, 3.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-2.9502F, 4.3243F, -0.7707F, 1.4153F, 0.1536F, 0.7734F));
		...
		PartDefinition cube_r12 = bone4.addOrReplaceChild("cube_r12", CubeListBuilder.create().texOffs(0, 0).mirror().addBox(5.6332F, 0.9432F, -0.1464F, 19.0F, 1.0F, 13.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(-2.9502F, 4.3243F, -0.7707F, 1.4153F, 0.1536F, 0.7734F));
		...
		PartDefinition cube_r13 = leftarm.addOrReplaceChild("cube_r13", CubeListBuilder.create().texOffs(64, 67).addBox(15.1987F, -2.0671F, -11.3556F, 3.0F, 5.0F, 9.0F, new CubeDeformation(0.0F))
		...
		PartDefinition cube_r14 = leftarm.addOrReplaceChild("cube_r14", CubeListBuilder.create().texOffs(21, 96).mirror().addBox(-1.9995F, -3.3704F, -1.0152F, 21.0F, 5.0F, 5.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(19.0869F, 20.1019F, -4.4707F, 1.3598F, 0.056F, 0.2559F));

		PartDefinition cube_r15 = leftarm.addOrReplaceChild("cube_r15", CubeListBuilder.create().texOffs(0, 86).addBox(3.0409F, 3.9138F, 4.7932F, 30.0F, 5.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-9.7976F, -0.2742F, -7.4145F, 1.4153F, 0.1536F, 0.7734F));
		...
		PartDefinition cube_r16 = rightarm.addOrReplaceChild("cube_r16", CubeListBuilder.create().texOffs(64, 67).addBox(15.1987F, -2.0671F, -11.3556F, 3.0F, 5.0F, 9.0F, new CubeDeformation(0.0F))
		.texOffs(64, 67).addBox(15.1987F, -2.0671F, 2.6444F, 3.0F, 5.0F, 9.0F, new CubeDeformation(0.0F))
		.texOffs(48, 67).addBox(15.1987F, 2.9329F, -2.3556F, 3.0F, 9.0F, 5.0F, new CubeDeformation(0.0F))
		.texOffs(48, 67).addBox(15.1987F, -11.0671F, -2.3556F, 3.0F, 9.0F, 5.0F, new CubeDeformation(0.0F))
		.texOffs(46, 122).addBox(19.1987F, -1.0671F, -1.3556F, 12.0F, 3.0F, 3.0F, new CubeDeformation(0.0F))
		...
		PartDefinition cube_r17 = rightarm.addOrReplaceChild("cube_r17", CubeListBuilder.create().texOffs(21, 96).mirror().addBox(-1.9995F, -3.3704F, -1.0152F, 21.0F, 5.0F, 5.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(19.1418F, 21.2136F, -3.3504F, 1.3598F, 0.056F, 0.2559F));

		PartDefinition cube_r18 = rightarm.addOrReplaceChild("cube_r18", CubeListBuilder.create().texOffs(0, 86).addBox(3.0409F, 3.9138F, 4.7932F, 30.0F, 5.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-9.7427F, 0.8375F, -6.2942F, 1.4153F, 0.1536F, 0.7734F));
