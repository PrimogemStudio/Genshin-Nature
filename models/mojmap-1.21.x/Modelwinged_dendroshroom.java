...
public class Modelwinged_dendroshroom<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("modid", "winged_dendroshroom"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		.texOffs(97, 5).addBox(-4.0F, -2.0F, -1.5F, 4.0F, 1.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-2.0F, 8.5F, 1.5F, 0.0F, 0.0F, -0.5236F));
		...
		.texOffs(97, 5).mirror().addBox(0.0F, -2.0F, -1.5F, 4.0F, 1.0F, 3.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(2.0F, 8.5F, 1.5F, 0.0F, 0.0F, 0.5236F));
