...
public class Modelhilichurl_woodenshield_guard<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("modid", "hilichurl_woodenshield_guard"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		.texOffs(0, 55).addBox(-1.0F, 9.5F, -4.0F, 1.0F, 1.0F, 8.0F, new CubeDeformation(0.0F))
		.texOffs(12, 50).addBox(-2.0F, 8.5F, -12.0F, 3.0F, 3.0F, 8.0F, new CubeDeformation(0.0F)), PartPose.offset(-5.0F, 2.0F, 0.0F));
		...
		.texOffs(50, 52).addBox(2.0F, 4.0F, -3.0F, 1.0F, 6.0F, 6.0F, new CubeDeformation(0.0F))
		.texOffs(58, 47).addBox(2.0F, 5.0F, 3.0F, 1.0F, 2.0F, 2.0F, new CubeDeformation(0.0F))
		.texOffs(52, 48).addBox(2.0F, 3.0F, 4.0F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F))
		.texOffs(52, 48).mirror().addBox(2.0F, 3.0F, -5.0F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false)
		.texOffs(58, 47).mirror().addBox(2.0F, 5.0F, -5.0F, 1.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).mirror(false)
		.texOffs(45, 51).addBox(2.0F, 10.0F, -2.0F, 1.0F, 2.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offset(5.0F, 2.0F, 0.0F));
