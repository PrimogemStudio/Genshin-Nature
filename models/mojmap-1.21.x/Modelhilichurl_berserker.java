...
public class Modelhilichurl_berserker<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("modid", "hilichurl_berserker"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		.texOffs(0, 56).addBox(-1.0F, 9.5F, -4.0F, 1.0F, 1.0F, 7.0F, new CubeDeformation(0.0F))
		.texOffs(42, 53).addBox(-2.0F, 8.5F, -12.0F, 3.0F, 3.0F, 8.0F, new CubeDeformation(0.0F)), PartPose.offset(-5.0F, 2.0F, 0.0F));
