...
public class Modellargegeoslime<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("modid", "largegeoslime"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition helmet = partdefinition.addOrReplaceChild("helmet", CubeListBuilder.create().texOffs(0, 43).addBox(14.0F, -23.0F, -11.0F, 2.0F, 10.0F, 21.0F, new CubeDeformation(0.0F))
		.texOffs(0, 43).addBox(-16.0F, -23.0F, -11.0F, 2.0F, 10.0F, 21.0F, new CubeDeformation(0.0F))
		.texOffs(0, 43).addBox(-15.0F, -23.0F, 9.0F, 30.0F, 10.0F, 2.0F, new CubeDeformation(0.0F))
		.texOffs(0, 43).addBox(-14.0F, -26.0F, -10.0F, 28.0F, 3.0F, 19.0F, new CubeDeformation(0.0F))
		.texOffs(0, 43).addBox(2.0F, -23.0F, -12.0F, 13.0F, 9.0F, 2.0F, new CubeDeformation(0.0F))
		.texOffs(0, 43).addBox(-1.0F, -23.0F, -12.0F, 3.0F, 11.0F, 2.0F, new CubeDeformation(0.0F))
		.texOffs(0, 43).addBox(-15.0F, -23.0F, -12.0F, 14.0F, 9.0F, 2.0F, new CubeDeformation(0.0F))
		.texOffs(0, 43).addBox(-13.0F, -14.0F, -12.0F, 5.0F, 5.0F, 2.0F, new CubeDeformation(0.0F))
		.texOffs(0, 43).addBox(8.0F, -14.0F, -12.0F, 5.0F, 5.0F, 2.0F, new CubeDeformation(0.0F))
		.texOffs(0, 43).addBox(-15.0F, -14.0F, -12.0F, 2.0F, 4.0F, 2.0F, new CubeDeformation(0.0F))
		.texOffs(0, 43).addBox(13.0F, -14.0F, -12.0F, 2.0F, 4.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 24.0F, 0.0F));

		PartDefinition cube_r1 = helmet.addOrReplaceChild("cube_r1", CubeListBuilder.create().texOffs(60, 70).mirror().addBox(6.0F, -14.0F, -3.0F, 6.0F, 14.0F, 6.0F, new CubeDeformation(0.0F)).mirror(false)
		.texOffs(60, 70).addBox(-12.0F, -14.0F, -3.0F, 6.0F, 14.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -25.0F, 4.0F, -0.4363F, 0.0F, 0.0F));

		PartDefinition cube_r2 = helmet.addOrReplaceChild("cube_r2", CubeListBuilder.create().texOffs(60, 70).mirror().addBox(-3.0F, -11.5F, -3.0F, 6.0F, 14.0F, 6.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(15.0F, -22.5F, -4.0F, 0.0F, 0.0F, 0.6109F));

		PartDefinition cube_r3 = helmet.addOrReplaceChild("cube_r3", CubeListBuilder.create().texOffs(60, 70).addBox(-3.0F, -11.5F, -3.0F, 6.0F, 14.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-15.0F, -22.5F, -4.0F, 0.0F, 0.0F, -0.6109F));

		PartDefinition cube_r4 = helmet.addOrReplaceChild("cube_r4", CubeListBuilder.create().texOffs(60, 70).addBox(-3.0F, -10.5F, -11.0F, 6.0F, 11.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -25.5F, -2.0F, 0.3054F, 0.0F, 0.0F));
