...
public class Modeldusk_bird_flying<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("modid", "dusk_bird_flying"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition bone = partdefinition.addOrReplaceChild("bone", CubeListBuilder.create().texOffs(26, 45).addBox(-1.0F, 2.6667F, 2.6667F, 2.0F, 1.0F, 5.0F, new CubeDeformation(0.0F))
		.texOffs(43, 37).addBox(-1.0F, 1.6667F, 5.6667F, 2.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 18.3333F, 0.3333F, 0.6545F, 0.0F, 0.0F));

		PartDefinition cube_r1 = bone.addOrReplaceChild("cube_r1", CubeListBuilder.create().texOffs(16, 19).addBox(-2.0F, -2.0F, -3.5F, 4.0F, 4.0F, 7.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.6667F, 0.1667F, -0.3491F, 0.0F, 0.0F));
		...
		.texOffs(22, 0).addBox(-1.0F, -3.9F, -6.4F, 2.0F, 3.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -0.4333F, -1.9333F, -0.3927F, 0.0F, 0.0F));
		...
		.texOffs(60, 51).addBox(-0.5F, -0.5F, -1.0F, 1.0F, 3.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-1.4F, 2.0667F, -0.3333F, 0.48F, 0.0F, 0.0F));
