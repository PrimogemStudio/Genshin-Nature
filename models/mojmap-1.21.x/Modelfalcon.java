...
public class Modelfalcon<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("modid", "falcon"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		.texOffs(0, 0).addBox(-0.5F, -0.25F, -0.25F, 1.0F, 4.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-2.0F, 2.8803F, 0.4207F, 0.0F, 0.2182F, 0.0F));
		...
		.texOffs(0, 32).addBox(-0.5F, 1.1F, 13.8F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offset(3.0F, 0.0303F, -3.6293F));
