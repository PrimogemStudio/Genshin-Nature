...
public class Modeldendroslime<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("modid", "dendroslime"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition leaves = partdefinition.addOrReplaceChild("leaves", CubeListBuilder.create().texOffs(15, 27).addBox(-0.5F, -2.0937F, -0.0774F, 1.0F, 3.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-1.5F, 13.0937F, -2.9226F, 0.3771F, 0.5603F, 0.0662F));

		PartDefinition cube_r1 = leaves.addOrReplaceChild("cube_r1", CubeListBuilder.create().texOffs(26, 34).addBox(-1.5F, -3.2352F, -2.9643F, 3.0F, 5.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -7.5315F, -1.1131F, 1.1781F, 0.0F, 0.0F));

		PartDefinition cube_r2 = leaves.addOrReplaceChild("cube_r2", CubeListBuilder.create().texOffs(19, 29).addBox(-0.5F, -1.0F, -1.5F, 1.0F, 3.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -4.0937F, 0.4226F, 0.4363F, 0.0F, 0.0F));

		PartDefinition leaves2 = partdefinition.addOrReplaceChild("leaves2", CubeListBuilder.create().texOffs(15, 27).addBox(-0.5F, -2.0937F, -0.0774F, 1.0F, 3.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(1.5F, 13.0937F, -2.9226F, 0.3064F, -0.6225F, 0.0005F));

		PartDefinition cube_r3 = leaves2.addOrReplaceChild("cube_r3", CubeListBuilder.create().texOffs(26, 34).addBox(-1.5F, -3.2352F, -2.9643F, 3.0F, 5.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -7.5315F, -1.1131F, 1.1781F, 0.0F, 0.0F));

		PartDefinition cube_r4 = leaves2.addOrReplaceChild("cube_r4", CubeListBuilder.create().texOffs(19, 29).addBox(-0.5F, -1.0F, -1.5F, 1.0F, 3.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -4.0937F, 0.4226F, 0.4363F, 0.0F, 0.0F));

		PartDefinition leaves3 = partdefinition.addOrReplaceChild("leaves3", CubeListBuilder.create().texOffs(15, 27).addBox(-0.5F, -2.0937F, -0.0774F, 1.0F, 3.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.5F, 13.0937F, 2.0774F, -2.9273F, 0.1281F, 3.128F));

		PartDefinition cube_r5 = leaves3.addOrReplaceChild("cube_r5", CubeListBuilder.create().texOffs(26, 34).addBox(-1.5F, -3.2352F, -2.9643F, 3.0F, 5.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -7.5315F, -1.1131F, 1.1781F, 0.0F, 0.0F));

		PartDefinition cube_r6 = leaves3.addOrReplaceChild("cube_r6", CubeListBuilder.create().texOffs(19, 29).addBox(-0.5F, -1.0F, -1.5F, 1.0F, 3.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -4.0937F, 0.4226F, 0.4363F, 0.0F, 0.0F));
