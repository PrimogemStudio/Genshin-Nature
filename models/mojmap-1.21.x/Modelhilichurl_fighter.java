...
public class Modelhilichurl_fighter<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("modid", "hilichurl_fighter"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		.texOffs(0, 52).addBox(-1.0F, 9.5F, -4.0F, 1.0F, 1.0F, 7.0F, new CubeDeformation(0.0F))
		.texOffs(48, 51).addBox(-2.0F, 8.5F, -9.0F, 3.0F, 3.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offset(-5.0F, 2.0F, 0.0F));
