...
public class Modelruin_guard<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("modid", "ruin_guard"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition left_leg_ANIM = partdefinition.addOrReplaceChild("left_leg_ANIM", CubeListBuilder.create().texOffs(105, 107).addBox(-1.9117F, -4.402F, -5.0F, 25.0F, 9.0F, 9.0F, new CubeDeformation(0.0F))
		...
		.texOffs(212, 153).addBox(0.0883F, -5.402F, -6.0F, 3.0F, 11.0F, 11.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(9.4939F, -19.6533F, 8.0F, 0.0F, 0.0F, 1.5708F));
		...
		.texOffs(208, 25).addBox(1.0883F, -5.402F, -6.0F, 3.0F, 11.0F, 11.0F, new CubeDeformation(0.0F)), PartPose.offset(20.0F, 0.0F, 0.0F));
		...
		.texOffs(45, 91).addBox(-1.0F, -1.0F, -17.0F, 4.0F, 4.0F, 7.0F, new CubeDeformation(0.0F)), PartPose.offset(20.0F, -1.0F, 0.0F));

		PartDefinition right_leg_ANIM = partdefinition.addOrReplaceChild("right_leg_ANIM", CubeListBuilder.create().texOffs(96, 125).addBox(-1.9117F, -4.402F, -5.0F, 25.0F, 9.0F, 9.0F, new CubeDeformation(0.0F))
		...
		.texOffs(173, 222).addBox(0.0883F, -5.402F, -6.0F, 3.0F, 11.0F, 11.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-9.5061F, -19.6533F, 8.0F, 0.0F, 0.0F, 1.5708F));
		...
		.texOffs(214, 189).addBox(0.0883F, -5.402F, -6.0F, 3.0F, 11.0F, 11.0F, new CubeDeformation(0.0F)), PartPose.offset(21.0F, 0.0F, 0.0F));
		...
		.texOffs(100, 191).addBox(-1.0F, -1.0F, -17.0F, 4.0F, 4.0F, 7.0F, new CubeDeformation(0.0F)), PartPose.offset(19.0F, -1.0F, 0.0F));
		...
		PartDefinition LRuinMid = LRuinShoulder.addOrReplaceChild("LRuinMid", CubeListBuilder.create().texOffs(94, 18).addBox(-27.0F, -5.0F, -5.0F, 29.0F, 9.0F, 9.0F, new CubeDeformation(0.0F))
		.texOffs(17, 208).addBox(-10.0F, -6.0F, -6.0F, 3.0F, 11.0F, 11.0F, new CubeDeformation(0.0F))
		...
		.texOffs(203, 102).addBox(-25.0F, -6.0F, -6.0F, 3.0F, 11.0F, 11.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(7.0F, 12.0F, 0.0F, 0.0F, 0.0F, -1.5708F));
		...
		PartDefinition cube_r16 = LRuinLower.addOrReplaceChild("cube_r16", CubeListBuilder.create().texOffs(197, 178).addBox(11.0F, -44.0F, -6.0F, 3.0F, 11.0F, 11.0F, new CubeDeformation(0.0F))
		...
		PartDefinition cube_r17 = LPod.addOrReplaceChild("cube_r17", CubeListBuilder.create().texOffs(45, 107).addBox(-18.0F, -95.0F, 4.0F, 15.0F, 5.0F, 15.0F, new CubeDeformation(0.0F))
		...
		PartDefinition cube_r18 = RRuinShoulder.addOrReplaceChild("cube_r18", CubeListBuilder.create().texOffs(116, 161).addBox(-26.0F, -76.0F, 2.0F, 23.0F, 14.0F, 1.0F, new CubeDeformation(0.0F))
		...
		.texOffs(179, 189).addBox(-24.9117F, -4.402F, -6.0F, 3.0F, 11.0F, 11.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-12.5061F, 0.3467F, 0.0F, 0.0F, 0.0F, -0.7854F));

		PartDefinition RRuinLower = RRuinMid.addOrReplaceChild("RRuinLower", CubeListBuilder.create(), PartPose.offset(-25.0F, 0.0F, 0.0F));

		PartDefinition cube_r19 = RRuinLower.addOrReplaceChild("cube_r19", CubeListBuilder.create().texOffs(27, 186).addBox(11.0F, -44.0F, -6.0F, 3.0F, 11.0F, 11.0F, new CubeDeformation(0.0F))
		...
		PartDefinition cube_r20 = RPod.addOrReplaceChild("cube_r20", CubeListBuilder.create().texOffs(0, 91).addBox(-18.0F, -95.0F, 4.0F, 15.0F, 5.0F, 15.0F, new CubeDeformation(0.0F))
	...
	public void renderToBuffer(PoseStack poseStack, VertexConsumer vertexConsumer, int packedLight, int packedOverlay, float red, float green, float blue, float alpha) {
		...
		left_leg_ANIM.render(poseStack, vertexConsumer, packedLight, packedOverlay, red, green, blue, alpha);
		right_leg_ANIM.render(poseStack, vertexConsumer, packedLight, packedOverlay, red, green, blue, alpha);
		left_arm_ANIM.render(poseStack, vertexConsumer, packedLight, packedOverlay, red, green, blue, alpha);
		right_arm_ANIM.render(poseStack, vertexConsumer, packedLight, packedOverlay, red, green, blue, alpha);
	}
}