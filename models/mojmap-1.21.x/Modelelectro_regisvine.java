...
public class Modelelectro_regisvine<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("modid", "electro_regisvine"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition cube_r6 = bone.addOrReplaceChild("cube_r6", CubeListBuilder.create().texOffs(94, 92).addBox(-3.9F, -20.5F, -1.9F, 9.0F, 28.0F, 8.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, -0.5672F, 0.0F, 0.0F));

		PartDefinition head = partdefinition.addOrReplaceChild("head", CubeListBuilder.create(), PartPose.offset(0.5F, -53.3932F, 7.5616F));

		PartDefinition cube_r7 = head.addOrReplaceChild("cube_r7", CubeListBuilder.create().texOffs(0, 58).addBox(-4.49F, -15.6264F, -2.7579F, 9.0F, 20.0F, 7.0F, new CubeDeformation(0.0F))
		...
		PartDefinition cube_r14 = leftarm.addOrReplaceChild("cube_r14", CubeListBuilder.create().texOffs(28, 108).mirror().addBox(-1.9995F, -3.3997F, -1.0152F, 21.0F, 5.0F, 5.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(19.0869F, 20.1019F, -4.4707F, 1.3598F, 0.056F, 0.2559F));
		...
		PartDefinition cube_r17 = rightarm.addOrReplaceChild("cube_r17", CubeListBuilder.create().texOffs(28, 108).mirror().addBox(-1.9995F, -3.4037F, -1.0152F, 21.0F, 5.0F, 5.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(19.1418F, 21.2136F, -3.3504F, 1.3598F, 0.056F, 0.2559F));
