...
public class Modelruin_drake_earthwatch<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("modid", "ruin_drake_earthwatch"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition left_wing = bone.addOrReplaceChild("left_wing", CubeListBuilder.create().texOffs(0, 120).addBox(-3.622F, -9.7541F, -3.9306F, 12.0F, 10.0F, 10.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-19.5402F, -33.5393F, -0.0694F, 0.0F, 0.0F, 0.8727F));

		PartDefinition right_wing = bone.addOrReplaceChild("right_wing", CubeListBuilder.create().texOffs(0, 120).addBox(-2.6904F, -9.2961F, -6.0694F, 12.0F, 10.0F, 10.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(18.8498F, -34.3858F, 4.0008F, 3.1416F, 0.0F, 2.1817F));
		...
		PartDefinition cube_r2 = right_leg.addOrReplaceChild("cube_r2", CubeListBuilder.create().texOffs(0, 46).addBox(-3.0F, 0.0F, -6.0F, 5.0F, 14.0F, 8.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-0.01F, 16.421F, 3.0031F, -0.3054F, 0.0F, 0.0F));
		...
		PartDefinition cube_r3 = left_leg.addOrReplaceChild("cube_r3", CubeListBuilder.create().texOffs(0, 46).addBox(-2.0F, 0.0F, -6.0F, 5.0F, 14.0F, 8.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-0.01F, 16.421F, 3.0031F, -0.3054F, 0.0F, 0.0F));
		...
		PartDefinition cube_r4 = tail.addOrReplaceChild("cube_r4", CubeListBuilder.create().texOffs(76, 0).addBox(-10.5F, -1.0F, -0.5F, 21.0F, 2.0F, 21.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-0.25F, 0.0F, 35.75F, 0.3927F, 0.0F, 0.0F));
