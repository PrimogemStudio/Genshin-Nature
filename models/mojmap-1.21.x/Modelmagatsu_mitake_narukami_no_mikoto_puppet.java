...
public class Modelmagatsu_mitake_narukami_no_mikoto_puppet<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("modid", "magatsu_mitake_narukami_no_mikoto_puppet"), "main");
	private final ModelPart bone60;
	private final ModelPart baal;
	...
	private final ModelPart puppet_stuff;
	private final ModelPart bone47;
	private final ModelPart bone48;
	private final ModelPart bone49;
	private final ModelPart rotate_puppet_arm;
	private final ModelPart rotate_puppet_arm2;
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition head = baal.addOrReplaceChild("head", CubeListBuilder.create().texOffs(0, 0).addBox(-4.0F, -8.1F, -4.0F, 8.0F, 8.0F, 8.0F, new CubeDeformation(0.0F))
		.texOffs(32, 0).addBox(-4.0F, -8.1F, -4.0F, 8.0F, 8.0F, 8.0F, new CubeDeformation(0.2F)), PartPose.offset(0.0F, -20.9F, 0.0F));
		...
		PartDefinition armRight = baal.addOrReplaceChild("armRight", CubeListBuilder.create().texOffs(83, 95).addBox(-0.8823F, 1.0305F, -1.0F, 2.0F, 8.0F, 2.0F, new CubeDeformation(0.0F))
		.texOffs(82, 106).addBox(-1.3823F, 0.2805F, -1.5F, 3.0F, 8.0F, 3.0F, new CubeDeformation(-0.3F)), PartPose.offsetAndRotation(-4.0F, -20.5F, 0.0F, -0.6941F, 0.0749F, 0.5438F));

		PartDefinition armLeft = baal.addOrReplaceChild("armLeft", CubeListBuilder.create().texOffs(97, 82).addBox(-1.6177F, 0.2805F, -1.5F, 3.0F, 8.0F, 3.0F, new CubeDeformation(-0.3F))
		.texOffs(98, 106).addBox(-1.1177F, 1.0307F, -1.0F, 2.0F, 8.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(4.0F, -20.5F, 0.0F, 0.0F, -0.48F, -0.4363F));
		...
		PartDefinition body = baal.addOrReplaceChild("body", CubeListBuilder.create().texOffs(16, 16).addBox(-4.0F, -10.499F, -2.3F, 8.0F, 12.0F, 4.6F, new CubeDeformation(-0.1F))
		.texOffs(16, 32).addBox(-4.2F, -10.799F, -2.4F, 8.4F, 12.6F, 4.8F, new CubeDeformation(-0.1F)), PartPose.offset(0.0F, -10.5F, 0.0F));
		...
		PartDefinition cube_r1 = bone32.addOrReplaceChild("cube_r1", CubeListBuilder.create().texOffs(11, 76).addBox(-2.0F, -0.5F, -0.8F, 4.0F, 9.0F, 1.6F, new CubeDeformation(-0.1F)), PartPose.offsetAndRotation(1.9F, 0.4F, -0.7F, 0.2618F, 0.0F, 0.0F));
		...
		PartDefinition cube_r2 = bone33.addOrReplaceChild("cube_r2", CubeListBuilder.create().texOffs(11, 97).addBox(-2.0F, -0.5F, -0.8F, 4.0F, 9.0F, 1.6F, new CubeDeformation(-0.1F)), PartPose.offsetAndRotation(-1.9F, 0.4F, -0.7F, 0.2618F, 0.0F, 0.0F));
		...
		PartDefinition legLeft = baal.addOrReplaceChild("legLeft", CubeListBuilder.create().texOffs(82, 55).addBox(-1.751F, 0.0F, -1.5F, 3.0F, 9.0F, 3.0F, new CubeDeformation(0.0F))
		.texOffs(82, 68).addBox(-1.951F, 0.0F, -1.7F, 3.4F, 9.1F, 3.4F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(2.0F, -9.0F, 0.0F, 0.0F, 0.0F, -0.1745F));

		PartDefinition legRight = baal.addOrReplaceChild("legRight", CubeListBuilder.create().texOffs(82, 42).addBox(-1.249F, 0.0F, -1.5F, 3.0F, 9.0F, 3.0F, new CubeDeformation(0.0F))
		.texOffs(82, 81).addBox(-1.449F, 0.0F, -1.7F, 3.4F, 9.1F, 3.4F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-2.0F, -9.0F, 0.0F, 0.0F, 0.0F, 0.1745F));
		...
		PartDefinition puppet_stuff = bone60.addOrReplaceChild("puppet_stuff", CubeListBuilder.create().texOffs(215, 104).addBox(-18.0F, -44.0F, 8.0F, 11.0F, 14.0F, 3.0F, new CubeDeformation(0.0F))
		.texOffs(178, 162).addBox(-6.0F, -49.0F, 14.0F, 2.0F, 10.0F, 1.0F, new CubeDeformation(0.0F))
		.texOffs(171, 194).addBox(-24.0F, -42.0F, 13.0F, 4.0F, 4.0F, 3.0F, new CubeDeformation(0.0F))
		.texOffs(210, 197).addBox(-26.0F, -41.0F, 14.0F, 2.0F, 2.0F, 1.0F, new CubeDeformation(0.0F))
		.texOffs(210, 197).addBox(-20.0F, -41.0F, 14.0F, 2.0F, 2.0F, 1.0F, new CubeDeformation(0.0F))
		.texOffs(210, 197).addBox(-3.0F, -41.0F, 14.0F, 2.0F, 2.0F, 1.0F, new CubeDeformation(0.0F))
		.texOffs(210, 197).addBox(-9.0F, -41.0F, 14.0F, 2.0F, 2.0F, 1.0F, new CubeDeformation(0.0F))
		.texOffs(171, 194).addBox(-7.0F, -42.0F, 13.0F, 4.0F, 4.0F, 3.0F, new CubeDeformation(0.0F))
		.texOffs(200, 193).addBox(-16.0F, -54.0F, 13.0F, 6.0F, 6.0F, 3.0F, new CubeDeformation(0.0F))
		.texOffs(210, 197).addBox(-14.0F, -56.0F, 14.0F, 2.0F, 2.0F, 1.0F, new CubeDeformation(0.0F))
		.texOffs(210, 197).addBox(-14.0F, -48.0F, 14.0F, 2.0F, 2.0F, 1.0F, new CubeDeformation(0.0F))
		.texOffs(178, 162).addBox(-23.0F, -49.0F, 14.0F, 2.0F, 10.0F, 1.0F, new CubeDeformation(0.0F))
		.texOffs(178, 162).addBox(-20.0F, -52.0F, 14.0F, 13.0F, 2.0F, 1.0F, new CubeDeformation(0.0F))
		.texOffs(234, 242).addBox(-19.0F, -42.0F, 6.0F, 8.0F, 11.0F, 3.0F, new CubeDeformation(0.0F))
		.texOffs(236, 245).addBox(-21.0F, -40.0F, 5.0F, 7.0F, 8.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 0.0F, 0.0F));

		PartDefinition cube_r3 = puppet_stuff.addOrReplaceChild("cube_r3", CubeListBuilder.create().texOffs(220, 168).addBox(-1.0F, -2.5F, -1.0F, 3.0F, 4.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-27.3377F, -24.2898F, -15.0358F, -0.5968F, -0.9721F, -0.6857F));

		PartDefinition cube_r4 = puppet_stuff.addOrReplaceChild("cube_r4", CubeListBuilder.create().texOffs(220, 168).addBox(-2.1674F, 0.2753F, -0.5769F, 3.0F, 5.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-25.6738F, -24.6495F, -14.6565F, -0.9905F, -0.5545F, -0.1356F));

		PartDefinition cube_r5 = puppet_stuff.addOrReplaceChild("cube_r5", CubeListBuilder.create().texOffs(6, 218).addBox(-3.0F, -3.0F, 1.5F, 6.0F, 6.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(13.0F, -38.0F, 20.5F, -0.3927F, 0.0F, 0.0F));

		PartDefinition cube_r6 = puppet_stuff.addOrReplaceChild("cube_r6", CubeListBuilder.create().texOffs(178, 162).addBox(-1.0F, -3.5F, -0.5F, 2.0F, 4.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-22.0F, -48.5F, 14.5F, 0.0F, 0.0F, 0.7854F));

		PartDefinition cube_r7 = puppet_stuff.addOrReplaceChild("cube_r7", CubeListBuilder.create().texOffs(178, 162).addBox(-0.5F, 8.5F, -0.5F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F))
		.texOffs(178, 162).addBox(-1.0F, -0.5F, -0.5F, 2.0F, 9.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-22.0F, -38.5F, 14.5F, 0.0F, 0.0F, -0.3054F));

		PartDefinition cube_r8 = puppet_stuff.addOrReplaceChild("cube_r8", CubeListBuilder.create().texOffs(178, 162).addBox(-1.0F, 8.2F, -0.5F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F))
		.texOffs(178, 162).addBox(-1.3F, -0.8F, -0.5F, 2.0F, 9.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-5.0F, -38.5F, 14.5F, 0.0F, 0.0F, 0.3054F));

		PartDefinition cube_r9 = puppet_stuff.addOrReplaceChild("cube_r9", CubeListBuilder.create().texOffs(178, 162).addBox(-0.5F, -4.0F, -0.5F, 2.0F, 4.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-5.0F, -48.0F, 14.5F, 0.0F, 0.0F, -0.7854F));

		PartDefinition cube_r10 = puppet_stuff.addOrReplaceChild("cube_r10", CubeListBuilder.create().texOffs(210, 197).addBox(-4.0F, -1.0F, -0.5F, 2.0F, 2.0F, 1.0F, new CubeDeformation(0.0F))
		.texOffs(210, 197).addBox(2.0F, -1.0F, -0.5F, 2.0F, 2.0F, 1.0F, new CubeDeformation(0.0F))
		.texOffs(171, 194).addBox(-2.0F, -2.0F, -1.5F, 4.0F, 4.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-5.0F, -47.0F, 14.5F, 0.0F, 0.0F, -0.3491F));

		PartDefinition cube_r11 = puppet_stuff.addOrReplaceChild("cube_r11", CubeListBuilder.create().texOffs(210, 197).addBox(-4.0F, -1.0F, -0.5F, 2.0F, 2.0F, 1.0F, new CubeDeformation(0.0F))
		.texOffs(210, 197).addBox(2.0F, -1.0F, -0.5F, 2.0F, 2.0F, 1.0F, new CubeDeformation(0.0F))
		.texOffs(171, 194).addBox(-2.0F, -2.0F, -1.5F, 4.0F, 4.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-22.0F, -47.0F, 14.5F, 0.0F, 0.0F, 0.3491F));
		...
		PartDefinition cube_r12 = bone47.addOrReplaceChild("cube_r12", CubeListBuilder.create().texOffs(6, 218).addBox(-2.0F, -1.7102F, -14.0391F, 4.0F, 4.0F, 15.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, -0.1916F, 0.2815F, -0.1201F));

		PartDefinition cube_r13 = bone47.addOrReplaceChild("cube_r13", CubeListBuilder.create().texOffs(6, 218).addBox(-2.0F, -2.0F, -17.5F, 4.0F, 4.0F, 19.0F, new CubeDeformation(0.0F))
		.texOffs(6, 218).addBox(-1.0F, -1.0F, 5.5F, 2.0F, 2.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 7.3325F, 16.9447F, -0.3927F, 0.0F, 0.0F));
		...
		PartDefinition cube_r14 = bone48.addOrReplaceChild("cube_r14", CubeListBuilder.create().texOffs(6, 218).addBox(-2.0F, -1.7102F, -14.0391F, 4.0F, 4.0F, 15.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(2.7549F, -22.2562F, -9.0693F, -0.1916F, 0.2815F, -0.1201F));

		PartDefinition cube_r15 = bone48.addOrReplaceChild("cube_r15", CubeListBuilder.create().texOffs(6, 218).addBox(-2.0F, -2.0F, -17.5F, 4.0F, 4.0F, 19.0F, new CubeDeformation(0.0F))
		.texOffs(6, 218).addBox(-1.0F, -1.0F, 1.5F, 2.0F, 2.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(2.7549F, -14.9237F, 7.8755F, -0.3927F, 0.0F, 0.0F));
		...
		PartDefinition cube_r16 = bone49.addOrReplaceChild("cube_r16", CubeListBuilder.create().texOffs(6, 218).addBox(-2.0F, -1.7102F, -14.0391F, 4.0F, 4.0F, 15.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.6336F, -4.5785F, -9.0693F, -0.1916F, 0.2815F, -0.1201F));

		PartDefinition cube_r17 = bone49.addOrReplaceChild("cube_r17", CubeListBuilder.create().texOffs(6, 218).addBox(-2.0F, -2.0F, -17.5F, 4.0F, 4.0F, 19.0F, new CubeDeformation(0.0F))
		.texOffs(6, 218).addBox(-1.0F, -1.0F, 1.5F, 2.0F, 2.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.6336F, 2.754F, 7.8755F, -0.3927F, 0.0F, 0.0F));

		PartDefinition rotate_puppet_arm = puppet_stuff.addOrReplaceChild("rotate_puppet_arm", CubeListBuilder.create().texOffs(164, 236).addBox(-2.5F, -1.5F, -3.0F, 5.0F, 15.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-19.5F, -34.5F, 6.0F, -0.413F, -0.1451F, 0.9904F));
		...
		PartDefinition cube_r18 = rotate_puppet_arm2.addOrReplaceChild("cube_r18", CubeListBuilder.create().texOffs(138, 162).addBox(-3.7147F, -0.0075F, -3.7396F, 6.0F, 10.0F, 8.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(2.9147F, 10.486F, -4.2335F, -1.027F, -0.2324F, 0.2F));

		PartDefinition cube_r19 = rotate_puppet_arm2.addOrReplaceChild("cube_r19", CubeListBuilder.create().texOffs(124, 239).addBox(-3.5F, 0.5F, -2.0F, 6.0F, 11.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(3.5F, 2.0F, 2.0F, -0.7F, -0.0668F, 0.0562F));
		...
		PartDefinition cube_r20 = bone44.addOrReplaceChild("cube_r20", CubeListBuilder.create().texOffs(220, 168).addBox(-1.6843F, -1.572F, -0.393F, 2.0F, 5.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(2.5353F, 7.2421F, -4.7208F, 0.5404F, -0.9433F, -1.8702F));

		PartDefinition cube_r21 = bone44.addOrReplaceChild("cube_r21", CubeListBuilder.create().texOffs(220, 168).addBox(-2.3531F, -6.9497F, -0.393F, 2.0F, 7.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(2.5353F, 7.2421F, -4.7208F, -0.7717F, -0.792F, -0.2932F));

		PartDefinition cube_r22 = bone44.addOrReplaceChild("cube_r22", CubeListBuilder.create().texOffs(220, 168).addBox(-2.2024F, -2.7726F, -0.3072F, 2.0F, 5.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-1.7262F, 3.4445F, -1.0007F, -1.027F, -0.2324F, 0.2F));
		...
		PartDefinition cube_r23 = bone45.addOrReplaceChild("cube_r23", CubeListBuilder.create().texOffs(220, 168).addBox(-1.5712F, -1.4229F, -3.5497F, 2.0F, 5.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(1.5091F, 8.8568F, -4.268F, 0.5404F, -0.9433F, -1.8702F));

		PartDefinition cube_r24 = bone45.addOrReplaceChild("cube_r24", CubeListBuilder.create().texOffs(220, 168).addBox(-2.166F, -6.9568F, -3.5497F, 2.0F, 7.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(1.5091F, 8.8568F, -4.268F, -0.7717F, -0.792F, -0.2932F));

		PartDefinition cube_r25 = bone45.addOrReplaceChild("cube_r25", CubeListBuilder.create().texOffs(220, 168).addBox(-2.2785F, -3.0932F, -3.4523F, 2.0F, 5.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-2.7524F, 5.0591F, -0.5479F, -1.027F, -0.2324F, 0.2F));
		...
		PartDefinition cube_r26 = bone43.addOrReplaceChild("cube_r26", CubeListBuilder.create().texOffs(220, 168).addBox(-1.5712F, -1.4229F, -3.5497F, 2.0F, 5.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(1.5091F, 8.8568F, -4.268F, 0.5404F, -0.9433F, -1.8702F));

		PartDefinition cube_r27 = bone43.addOrReplaceChild("cube_r27", CubeListBuilder.create().texOffs(220, 168).addBox(-2.166F, -6.9568F, -3.5497F, 2.0F, 7.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(1.5091F, 8.8568F, -4.268F, -0.7717F, -0.792F, -0.2932F));

		PartDefinition cube_r28 = bone43.addOrReplaceChild("cube_r28", CubeListBuilder.create().texOffs(220, 168).addBox(-2.2785F, -3.0932F, -3.4523F, 2.0F, 5.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-2.7524F, 5.0591F, -0.5479F, -1.027F, -0.2324F, 0.2F));

		PartDefinition bone46 = bone42.addOrReplaceChild("bone46", CubeListBuilder.create(), PartPose.offset(6.4909F, -9.8568F, 0.268F));

		PartDefinition cube_r29 = bone46.addOrReplaceChild("cube_r29", CubeListBuilder.create().texOffs(220, 168).addBox(-1.5712F, -1.4229F, -3.5497F, 2.0F, 5.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(1.5091F, 8.8568F, -4.268F, 0.5404F, -0.9433F, -1.8702F));

		PartDefinition cube_r30 = bone46.addOrReplaceChild("cube_r30", CubeListBuilder.create().texOffs(220, 168).addBox(-2.166F, -6.9568F, -3.5497F, 2.0F, 7.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(1.5091F, 8.8568F, -4.268F, -0.7717F, -0.792F, -0.2932F));

		PartDefinition cube_r31 = bone46.addOrReplaceChild("cube_r31", CubeListBuilder.create().texOffs(220, 168).addBox(-2.2785F, -3.0932F, -3.4523F, 2.0F, 5.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-2.7524F, 5.0591F, -0.5479F, -1.027F, -0.2324F, 0.2F));

		PartDefinition bone54 = puppet_stuff.addOrReplaceChild("bone54", CubeListBuilder.create().texOffs(206, 0).addBox(-6.0F, -1.5F, -6.5F, 12.0F, 3.0F, 13.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-8.0F, -3.5F, -8.5F, 0.3193F, 0.2909F, 0.0945F));

		PartDefinition cube_r32 = bone54.addOrReplaceChild("cube_r32", CubeListBuilder.create().texOffs(237, 56).addBox(-4.4129F, -1.5F, -1.4383F, 5.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-10.5669F, 0.0F, -1.5296F, 0.0F, -1.3526F, 0.0F));

		PartDefinition cube_r33 = bone54.addOrReplaceChild("cube_r33", CubeListBuilder.create().texOffs(150, 20).addBox(-6.5F, -1.49F, -1.5F, 9.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-6.5F, 0.0F, 3.0F, 0.0F, -0.829F, 0.0F));

		PartDefinition bone50 = bone54.addOrReplaceChild("bone50", CubeListBuilder.create().texOffs(176, 0).addBox(-1.01F, -0.8018F, -4.7172F, 2.0F, 2.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-5.0F, -0.1982F, -5.7828F, 0.1331F, 0.1264F, 0.0341F));

		PartDefinition cube_r34 = bone50.addOrReplaceChild("cube_r34", CubeListBuilder.create().texOffs(213, 41).addBox(-1.01F, -2.9912F, -0.5328F, 2.0F, 2.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -1.4806F, -9.6844F, -0.829F, 0.0F, 0.0F));

		PartDefinition cube_r35 = bone50.addOrReplaceChild("cube_r35", CubeListBuilder.create().texOffs(176, 0).addBox(-1.01F, -1.0F, -2.5F, 2.0F, 2.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.1982F, -4.2172F, -0.3927F, 0.0F, 0.0F));

		PartDefinition bone51 = bone54.addOrReplaceChild("bone51", CubeListBuilder.create().texOffs(176, 0).addBox(-1.0F, -0.8018F, -4.7172F, 2.0F, 2.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-2.0F, -0.1982F, -5.7828F, -0.2618F, 0.0F, 0.0F));

		PartDefinition cube_r36 = bone51.addOrReplaceChild("cube_r36", CubeListBuilder.create().texOffs(213, 41).addBox(-1.0F, -2.5212F, -1.8328F, 2.0F, 2.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -1.4806F, -9.6844F, -0.829F, 0.0F, 0.0F));

		PartDefinition cube_r37 = bone51.addOrReplaceChild("cube_r37", CubeListBuilder.create().texOffs(166, 53).addBox(-1.0F, -1.0F, -3.5F, 2.0F, 2.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.1982F, -4.2172F, -0.3927F, 0.0F, 0.0F));

		PartDefinition bone53 = bone54.addOrReplaceChild("bone53", CubeListBuilder.create().texOffs(176, 0).addBox(-1.0F, -0.8018F, -4.7172F, 2.0F, 2.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(5.0F, -0.1982F, -5.7828F, -0.0866F, -0.1744F, -0.0077F));

		PartDefinition cube_r38 = bone53.addOrReplaceChild("cube_r38", CubeListBuilder.create().texOffs(213, 41).addBox(-1.0F, -2.5212F, -1.8328F, 2.0F, 2.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -1.4806F, -9.6844F, -0.829F, 0.0F, 0.0F));

		PartDefinition cube_r39 = bone53.addOrReplaceChild("cube_r39", CubeListBuilder.create().texOffs(166, 53).addBox(-1.0F, -1.0F, -3.5F, 2.0F, 2.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.1982F, -4.2172F, -0.3927F, 0.0F, 0.0F));

		PartDefinition bone52 = bone54.addOrReplaceChild("bone52", CubeListBuilder.create().texOffs(176, 0).addBox(-1.0F, -0.8018F, -4.7172F, 2.0F, 2.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(2.0F, -0.1982F, -5.7828F, -0.3054F, 0.0F, 0.0F));

		PartDefinition cube_r40 = bone52.addOrReplaceChild("cube_r40", CubeListBuilder.create().texOffs(213, 41).addBox(-1.0F, -1.6212F, -3.5328F, 2.0F, 2.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -1.4806F, -9.6844F, -0.829F, 0.0F, 0.0F));

		PartDefinition cube_r41 = bone52.addOrReplaceChild("cube_r41", CubeListBuilder.create().texOffs(166, 53).addBox(-1.0F, -1.0F, -5.5F, 2.0F, 2.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.1982F, -4.2172F, -0.3927F, 0.0F, 0.0F));

		PartDefinition bone55 = puppet_stuff.addOrReplaceChild("bone55", CubeListBuilder.create().texOffs(206, 0).mirror().addBox(-6.0F, -1.5F, -6.5F, 12.0F, 3.0F, 13.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(11.0F, -3.5F, -8.5F, 0.3193F, -0.2909F, -0.0945F));

		PartDefinition cube_r42 = bone55.addOrReplaceChild("cube_r42", CubeListBuilder.create().texOffs(237, 56).mirror().addBox(-0.4129F, -1.5F, -1.4383F, 5.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(10.4331F, 0.0F, -1.5296F, 0.0F, 1.3526F, 0.0F));

		PartDefinition cube_r43 = bone55.addOrReplaceChild("cube_r43", CubeListBuilder.create().texOffs(150, 20).mirror().addBox(-2.5F, -1.49F, -1.5F, 9.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(6.5F, 0.0F, 3.0F, 0.0F, 0.829F, 0.0F));

		PartDefinition bone56 = bone55.addOrReplaceChild("bone56", CubeListBuilder.create().texOffs(176, 0).addBox(-1.01F, -0.8018F, -4.7172F, 2.0F, 2.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-5.0F, -0.1982F, -5.7828F, 0.1331F, 0.1264F, 0.0341F));

		PartDefinition cube_r44 = bone56.addOrReplaceChild("cube_r44", CubeListBuilder.create().texOffs(213, 41).addBox(-1.01F, -2.9912F, -0.5328F, 2.0F, 2.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -1.4806F, -9.6844F, -0.829F, 0.0F, 0.0F));

		PartDefinition cube_r45 = bone56.addOrReplaceChild("cube_r45", CubeListBuilder.create().texOffs(176, 0).addBox(-1.01F, -1.0F, -2.5F, 2.0F, 2.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.1982F, -4.2172F, -0.3927F, 0.0F, 0.0F));

		PartDefinition bone57 = bone55.addOrReplaceChild("bone57", CubeListBuilder.create().texOffs(176, 0).addBox(-1.0F, -0.8018F, -4.7172F, 2.0F, 2.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-2.0F, -0.1982F, -5.7828F, -0.2618F, 0.0F, 0.0F));

		PartDefinition cube_r46 = bone57.addOrReplaceChild("cube_r46", CubeListBuilder.create().texOffs(213, 41).addBox(-1.0F, -2.5212F, -1.8328F, 2.0F, 2.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -1.4806F, -9.6844F, -0.829F, 0.0F, 0.0F));

		PartDefinition cube_r47 = bone57.addOrReplaceChild("cube_r47", CubeListBuilder.create().texOffs(166, 53).addBox(-1.0F, -1.0F, -3.5F, 2.0F, 2.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.1982F, -4.2172F, -0.3927F, 0.0F, 0.0F));

		PartDefinition bone58 = bone55.addOrReplaceChild("bone58", CubeListBuilder.create().texOffs(176, 0).addBox(-1.0F, -0.8018F, -4.7172F, 2.0F, 2.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(5.0F, -0.1982F, -5.7828F, -0.0866F, -0.1744F, -0.0077F));

		PartDefinition cube_r48 = bone58.addOrReplaceChild("cube_r48", CubeListBuilder.create().texOffs(213, 41).addBox(-1.0F, -2.5212F, -1.8328F, 2.0F, 2.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -1.4806F, -9.6844F, -0.829F, 0.0F, 0.0F));

		PartDefinition cube_r49 = bone58.addOrReplaceChild("cube_r49", CubeListBuilder.create().texOffs(166, 53).addBox(-1.0F, -1.0F, -3.5F, 2.0F, 2.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.1982F, -4.2172F, -0.3927F, 0.0F, 0.0F));

		PartDefinition bone59 = bone55.addOrReplaceChild("bone59", CubeListBuilder.create().texOffs(176, 0).addBox(-1.0F, -0.8018F, -4.7172F, 2.0F, 2.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(2.0F, -0.1982F, -5.7828F, -0.3054F, 0.0F, 0.0F));

		PartDefinition cube_r50 = bone59.addOrReplaceChild("cube_r50", CubeListBuilder.create().texOffs(213, 41).addBox(-1.0F, -1.6212F, -3.5328F, 2.0F, 2.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -1.4806F, -9.6844F, -0.829F, 0.0F, 0.0F));

		PartDefinition cube_r51 = bone59.addOrReplaceChild("cube_r51", CubeListBuilder.create().texOffs(166, 53).addBox(-1.0F, -1.0F, -5.5F, 2.0F, 2.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.1982F, -4.2172F, -0.3927F, 0.0F, 0.0F));
	...
	public void renderToBuffer(PoseStack poseStack, VertexConsumer vertexConsumer, int packedLight, int packedOverlay, float red, float green, float blue, float alpha) {
		bone60.render(poseStack, vertexConsumer, packedLight, packedOverlay, red, green, blue, alpha);
	}
}