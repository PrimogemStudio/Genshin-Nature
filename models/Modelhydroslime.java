...
public static class Modelhydroslime extends EntityModel<Entity> {
	private final ModelRenderer bb_main;

	public Modelhydroslime() {
		textureWidth = 64;
		textureHeight = 64;
		...
		bb_main.setTextureOffset(12, 54).addBox(-3.0F, -10.0F, -5.0F, 6.0F, 1.0F, 1.0F, 0.0F, false);
		bb_main.setTextureOffset(0, 58).addBox(5.0F, -7.0F, 4.0F, 1.0F, 4.0F, 1.0F, 0.0F, false);
		bb_main.setTextureOffset(0, 55).addBox(4.0F, -8.0F, 4.0F, 1.0F, 6.0F, 1.0F, 0.0F, false);
		bb_main.setTextureOffset(9, 55).addBox(-3.0F, -10.0F, 4.0F, 6.0F, 1.0F, 1.0F, 0.0F, false);
		...
		bb_main.setTextureOffset(0, 58).addBox(-6.0F, -7.0F, 4.0F, 1.0F, 4.0F, 1.0F, 0.0F, false);
	}
