...
public static class Modelhilichurl_woodenshield_guard extends EntityModel<Entity> {
	...
	public Modelhilichurl_woodenshield_guard() {
		textureWidth = 64;
		textureHeight = 64;
		...
		RightArm.setTextureOffset(0, 55).addBox(-1.0F, 9.5F, -4.0F, 1.0F, 1.0F, 8.0F, 0.0F, false);
		RightArm.setTextureOffset(12, 50).addBox(-2.0F, 8.5F, -12.0F, 3.0F, 3.0F, 8.0F, 0.0F, false);

		LeftArm = new ModelRenderer(this);
		LeftArm.setRotationPoint(5.0F, 2.0F, 0.0F);
		LeftArm.setTextureOffset(40, 16).addBox(-1.0F, -2.0F, -2.0F, 3.0F, 12.0F, 4.0F, 0.0F, true);
		LeftArm.setTextureOffset(50, 52).addBox(2.0F, 4.0F, -3.0F, 1.0F, 6.0F, 6.0F, 0.0F, false);
		LeftArm.setTextureOffset(58, 47).addBox(2.0F, 5.0F, 3.0F, 1.0F, 2.0F, 2.0F, 0.0F, false);
		LeftArm.setTextureOffset(52, 48).addBox(2.0F, 3.0F, 4.0F, 1.0F, 2.0F, 1.0F, 0.0F, false);
		LeftArm.setTextureOffset(52, 48).addBox(2.0F, 3.0F, -5.0F, 1.0F, 2.0F, 1.0F, 0.0F, true);
		LeftArm.setTextureOffset(58, 47).addBox(2.0F, 5.0F, -5.0F, 1.0F, 2.0F, 2.0F, 0.0F, true);
		LeftArm.setTextureOffset(45, 51).addBox(2.0F, 10.0F, -2.0F, 1.0F, 2.0F, 4.0F, 0.0F, false);
