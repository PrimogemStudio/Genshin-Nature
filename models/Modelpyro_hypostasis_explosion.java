...
public static class Modelpyro_hypostasis_explosion extends EntityModel<Entity> {
	private final ModelRenderer bone;
	private final ModelRenderer inside_cube;
	private final ModelRenderer outside_cubes;

	public Modelpyro_hypostasis_explosion() {
		textureWidth = 128;
		textureHeight = 128;
		...
		inside_cube.setTextureOffset(0, 0).addBox(-12.0F, -16.0F, -12.0F, 24.0F, 16.0F, 24.0F, 0.0F, false);
		...
		outside_cubes.setTextureOffset(88, 108).addBox(-11.0F, -20.0F, -11.0F, 10.0F, 10.0F, 10.0F, 0.0F, true);
		...
		outside_cubes.setTextureOffset(88, 108).addBox(1.0F, -8.0F, 1.0F, 10.0F, 10.0F, 10.0F, 0.0F, true);
	}
