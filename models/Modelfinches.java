...
public static class Modelfinches extends EntityModel<Entity> {
	...
	public Modelfinches() {
		...
		bone.setTextureOffset(20, 0).addBox(-2.0F, -8.0F, -3.0F, 5.0F, 5.0F, 7.0F, 0.0F, false);

		cube_r1 = new ModelRenderer(this);
		cube_r1.setRotationPoint(0.5F, -3.5F, 3.5F);
		bone.addChild(cube_r1);
		setRotationAngle(cube_r1, 0.2618F, 0.0F, 0.0F);
		cube_r1.setTextureOffset(48, 0).addBox(-1.5F, -1.0F, 0.5F, 3.0F, 1.0F, 5.0F, 0.0F, false);

		cube_r2 = new ModelRenderer(this);
		cube_r2.setRotationPoint(-2.0F, -7.0F, 0.0F);
		...
		cube_r2.setTextureOffset(34, 44).addBox(4.0F, -2.0F, 0.0F, 2.0F, 4.0F, 6.0F, 0.0F, false);

		head = new ModelRenderer(this);
		head.setRotationPoint(0.5F, -8.0F, -1.0F);
		bone.addChild(head);
		...
		cube_r3.setRotationPoint(0.0F, -3.5F, -1.5F);
		head.addChild(cube_r3);
		setRotationAngle(cube_r3, 0.3927F, 0.0F, 0.0F);
		cube_r3.setTextureOffset(5, 37).addBox(-1.0F, 0.0F, -0.5F, 2.0F, 1.0F, 5.0F, 0.0F, false);

		left_leg = new ModelRenderer(this);
		left_leg.setRotationPoint(1.5F, -3.25F, 0.25F);
		...
		right_leg.setRotationPoint(-0.5F, -3.25F, 0.25F);
