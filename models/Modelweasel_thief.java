...
public static class Modelweasel_thief extends EntityModel<Entity> {
	...
	public Modelweasel_thief() {
		...
		bag.setRotationPoint(0.0F, 24.0F, 0.0F);

		cube_r3 = new ModelRenderer(this);
		cube_r3.setRotationPoint(-0.5F, -10.0F, 0.5F);
		bag.addChild(cube_r3);
		setRotationAngle(cube_r3, 0.3054F, 0.0F, 0.0F);
		cube_r3.setTextureOffset(17, 25).addBox(-2.5F, -3.0F, -0.5F, 5.0F, 6.0F, 3.0F, 0.0F, false);
	}
