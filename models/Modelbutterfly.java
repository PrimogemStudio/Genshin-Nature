...
public static class Modelbutterfly extends EntityModel<Entity> {
	...
	public Modelbutterfly() {
		...
		cube_r1.setTextureOffset(0, 0).addBox(-4.0F, -0.5F, -2.0F, 4.0F, 1.0F, 4.0F, 0.0F, true);

		cube_r2 = new ModelRenderer(this);
		cube_r2.setRotationPoint(-0.0738F, 0.0F, 1.7538F);
		wing.addChild(cube_r2);
		setRotationAngle(cube_r2, 0.0F, 0.1745F, 0.0F);
		cube_r2.setTextureOffset(46, 0).addBox(-4.0F, -0.5F, -2.0F, 4.0F, 1.0F, 5.0F, 0.0F, true);
		...
		cube_r3.setTextureOffset(0, 0).addBox(0.0F, -0.5F, -2.0F, 4.0F, 1.0F, 4.0F, 0.0F, false);

		cube_r4 = new ModelRenderer(this);
		cube_r4.setRotationPoint(0.0738F, 0.0F, 1.7538F);
		wing2.addChild(cube_r4);
		setRotationAngle(cube_r4, 0.0F, -0.1745F, 0.0F);
		cube_r4.setTextureOffset(46, 0).addBox(0.0F, -0.5F, -2.0F, 4.0F, 1.0F, 5.0F, 0.0F, false);

		bb_main = new ModelRenderer(this);
		bb_main.setRotationPoint(0.0F, 24.0F, 0.0F);
		bb_main.setTextureOffset(0, 54).addBox(-1.0F, -3.0F, -4.0F, 2.0F, 2.0F, 8.0F, 0.0F, false);

		cube_r5 = new ModelRenderer(this);
		cube_r5.setRotationPoint(0.5F, -2.5F, -4.5F);
		bb_main.addChild(cube_r5);
		setRotationAngle(cube_r5, -0.9113F, -0.2485F, 0.3073F);
		cube_r5.setTextureOffset(0, 31).addBox(-0.5F, -1.5F, -2.5F, 1.0F, 1.0F, 3.0F, 0.0F, false);

		cube_r6 = new ModelRenderer(this);
		cube_r6.setRotationPoint(-0.5F, -2.5F, -4.5F);
		bb_main.addChild(cube_r6);
		setRotationAngle(cube_r6, -0.8897F, 0.1671F, -0.2024F);
		cube_r6.setTextureOffset(0, 31).addBox(-0.5F, -1.5F, -2.5F, 1.0F, 1.0F, 3.0F, 0.0F, false);
	}
