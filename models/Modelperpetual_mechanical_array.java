...
public static class Modelperpetual_mechanical_array extends EntityModel<Entity> {
	private final ModelRenderer bone;
	private final ModelRenderer inside_cube;
	private final ModelRenderer outside_cubes;

	public Modelperpetual_mechanical_array() {
		textureWidth = 128;
		textureHeight = 128;

		bone = new ModelRenderer(this);
		bone.setRotationPoint(0.0F, 10.0F, 0.0F);
		setRotationAngle(bone, 2.4702F, -0.5156F, -2.6325F);
