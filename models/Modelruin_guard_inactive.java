...
public static class Modelruin_guard_inactive extends EntityModel<Entity> {
	...
	public Modelruin_guard_inactive() {
		textureWidth = 256;
		textureHeight = 256;

		RuinGuard = new ModelRenderer(this);
		RuinGuard.setRotationPoint(0.0F, 55.0F, 0.0F);
		...
		left_leg_ANIM.setRotationPoint(9.4939F, -34.6533F, 8.0F);
		RuinGuard.addChild(left_leg_ANIM);
		setRotationAngle(left_leg_ANIM, -2.0333F, 1.4733F, -0.4644F);
		...
		setRotationAngle(LRuinLegBottom2, 0.0F, -0.3054F, 0.0F);
		...
		setRotationAngle(LRuinLegFoot, 0.0F, -0.3491F, 0.0F);
		...
		right_leg_ANIM.setRotationPoint(-9.5061F, -34.6533F, 8.0F);
		RuinGuard.addChild(right_leg_ANIM);
		setRotationAngle(right_leg_ANIM, 2.0333F, 1.4733F, -2.6772F);
		...
		setRotationAngle(RRuinLegBottom, 0.0F, -0.3054F, 0.0F);
		...
		setRotationAngle(RRuinLegFoot2, 0.0F, -0.3491F, 0.0F);
		...
		left_arm_ANIM.setRotationPoint(15.0F, -68.0F, 12.0F);
		RuinGuard.addChild(left_arm_ANIM);
		setRotationAngle(left_arm_ANIM, -0.3503F, -0.082F, 0.0299F);
		...
		setRotationAngle(LRuinMid, 0.0F, -0.4363F, -1.5708F);
		...
		cube_r16.setRotationPoint(-51.0F, 38.0F, -12.0F);
		LRuinMid.addChild(cube_r16);
		setRotationAngle(cube_r16, 0.0F, 0.0F, 0.0F);
		cube_r16.setTextureOffset(94, 18).addBox(24.0F, -43.0F, 7.0F, 29.0F, 9.0F, 9.0F, 0.0F, false);

		LRuinLower = new ModelRenderer(this);
		LRuinLower.setRotationPoint(-25.5061F, -0.6533F, 0.0F);
		LRuinMid.addChild(LRuinLower);
		setRotationAngle(LRuinLower, 0.0F, -0.1309F, 0.0F);

		cube_r17 = new ModelRenderer(this);
		cube_r17.setRotationPoint(-25.9117F, 38.598F, -12.0F);
		LRuinLower.addChild(cube_r17);
		setRotationAngle(cube_r17, 0.0F, -0.4363F, 0.0F);
		cube_r17.setTextureOffset(197, 178).addBox(11.0F, -44.0F, -6.0F, 3.0F, 11.0F, 11.0F, 0.0F, false);
		cube_r17.setTextureOffset(196, 200).addBox(16.0F, -44.0F, -6.0F, 3.0F, 11.0F, 11.0F, 0.0F, false);
		cube_r17.setTextureOffset(128, 202).addBox(21.0F, -44.0F, -6.0F, 3.0F, 11.0F, 11.0F, 0.0F, false);
		cube_r17.setTextureOffset(152, 36).addBox(10.0F, -43.0F, -5.0F, 19.0F, 9.0F, 9.0F, -0.02F, false);
		...
		cube_r18.setRotationPoint(-24.0F, 74.0F, -12.0F);
		LPod.addChild(cube_r18);
		setRotationAngle(cube_r18, 0.0F, 0.0F, 0.4363F);
		cube_r18.setTextureOffset(45, 107).addBox(-18.0F, -95.0F, 4.0F, 15.0F, 5.0F, 15.0F, 0.0F, false);
		cube_r18.setTextureOffset(39, 127).addBox(-17.0F, -90.0F, 5.0F, 13.0F, 12.0F, 13.0F, 0.0F, false);

		right_arm_ANIM = new ModelRenderer(this);
		right_arm_ANIM.setRotationPoint(-20.0F, -69.0F, 12.0F);
		RuinGuard.addChild(right_arm_ANIM);
		setRotationAngle(right_arm_ANIM, -0.3503F, 0.082F, -0.0299F);
		...
		cube_r19.setRotationPoint(-20.5061F, 64.3467F, -12.0F);
		RRuinShoulder.addChild(cube_r19);
		setRotationAngle(cube_r19, 0.0F, 0.0F, 0.4363F);
		cube_r19.setTextureOffset(116, 161).addBox(-26.0F, -76.0F, 2.0F, 23.0F, 14.0F, 1.0F, 0.0F, false);
		cube_r19.setTextureOffset(134, 73).addBox(-18.0F, -78.0F, 4.0F, 15.0F, 1.0F, 15.0F, 0.0F, false);
		cube_r19.setTextureOffset(0, 58).addBox(-27.0F, -77.0F, 3.0F, 25.0F, 16.0F, 17.0F, 0.0F, false);
		cube_r19.setTextureOffset(163, 54).addBox(-26.0F, -76.0F, 20.0F, 23.0F, 14.0F, 1.0F, 0.0F, false);

		RRuinMid = new ModelRenderer(this);
		RRuinMid.setRotationPoint(-12.5061F, 0.3467F, 0.0F);
		RRuinShoulder.addChild(RRuinMid);
		setRotationAngle(RRuinMid, 0.0F, -0.4363F, -0.7854F);
		...
		setRotationAngle(RRuinLower, 0.0F, -0.1309F, 0.0F);

		cube_r20 = new ModelRenderer(this);
		cube_r20.setRotationPoint(-25.9117F, 39.598F, -12.0F);
		RRuinLower.addChild(cube_r20);
		setRotationAngle(cube_r20, 0.0F, -0.4363F, 0.0F);
		cube_r20.setTextureOffset(27, 186).addBox(11.0F, -44.0F, -6.0F, 3.0F, 11.0F, 11.0F, 0.0F, false);
		cube_r20.setTextureOffset(55, 186).addBox(16.0F, -44.0F, -6.0F, 3.0F, 11.0F, 11.0F, 0.0F, false);
		cube_r20.setTextureOffset(151, 189).addBox(21.0F, -44.0F, -6.0F, 3.0F, 11.0F, 11.0F, 0.0F, false);
		cube_r20.setTextureOffset(0, 152).addBox(10.0F, -43.0F, -5.0F, 19.0F, 9.0F, 9.0F, -0.02F, false);
		...
		cube_r21.setRotationPoint(-22.5061F, 74.3467F, -12.0F);
		RPod.addChild(cube_r21);
		setRotationAngle(cube_r21, 0.0F, 0.0F, 0.4363F);
		cube_r21.setTextureOffset(0, 91).addBox(-18.0F, -95.0F, 4.0F, 15.0F, 5.0F, 15.0F, 0.0F, false);
		cube_r21.setTextureOffset(0, 114).addBox(-17.0F, -90.0F, 5.0F, 13.0F, 12.0F, 13.0F, 0.0F, false);
	}
