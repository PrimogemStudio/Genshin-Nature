...
public static class Modelcrystalfly extends EntityModel<Entity> {
	...
	public Modelcrystalfly() {
		...
		cube_r1.setTextureOffset(0, 0).addBox(-6.0F, -0.5F, -2.0F, 6.0F, 1.0F, 4.0F, 0.0F, true);

		cube_r2 = new ModelRenderer(this);
		cube_r2.setRotationPoint(-0.0738F, 0.0F, 1.7538F);
		wing.addChild(cube_r2);
		setRotationAngle(cube_r2, 0.0F, -0.4363F, 0.0F);
		cube_r2.setTextureOffset(46, 0).addBox(-2.0F, -0.5F, -1.0F, 3.0F, 1.0F, 6.0F, 0.0F, true);
		...
		cube_r3.setTextureOffset(0, 0).addBox(0.0F, -0.5F, -2.0F, 6.0F, 1.0F, 4.0F, 0.0F, false);

		cube_r4 = new ModelRenderer(this);
		cube_r4.setRotationPoint(0.0738F, 0.0F, 1.7538F);
		wing2.addChild(cube_r4);
		setRotationAngle(cube_r4, 0.0F, 0.4363F, 0.0F);
		cube_r4.setTextureOffset(46, 0).addBox(-1.0F, -0.5F, -1.0F, 3.0F, 1.0F, 6.0F, 0.0F, false);
