...
public static class Modelabyssmage_shielded extends EntityModel<Entity> {
	...
	public Modelabyssmage_shielded() {
		textureWidth = 64;
		textureHeight = 128;
		...
		shield.setTextureOffset(18, 73).addBox(11.0F, -40.0F, -8.0F, 2.0F, 40.0F, 2.0F, 0.0F, false);
		shield.setTextureOffset(8, 71).addBox(-13.0F, -40.0F, -8.0F, 2.0F, 40.0F, 2.0F, 0.0F, false);
		shield.setTextureOffset(8, 71).addBox(-11.0F, -38.0F, -7.5F, 2.0F, 36.0F, 1.0F, 0.0F, false);
		shield.setTextureOffset(8, 71).addBox(9.0F, -38.0F, -7.5F, 2.0F, 36.0F, 1.0F, 0.0F, false);
		shield.setTextureOffset(8, 71).addBox(9.0F, -38.0F, 8.5F, 2.0F, 36.0F, 1.0F, 0.0F, false);
		shield.setTextureOffset(8, 71).addBox(-11.0F, -38.0F, 8.5F, 2.0F, 36.0F, 1.0F, 0.0F, false);
		shield.setTextureOffset(8, 71).addBox(-12.5F, -38.0F, -6.0F, 1.0F, 36.0F, 2.0F, 0.0F, false);
		shield.setTextureOffset(8, 71).addBox(-12.5F, -38.0F, 6.0F, 1.0F, 36.0F, 2.0F, 0.0F, false);
		shield.setTextureOffset(8, 71).addBox(11.5F, -38.0F, 6.0F, 1.0F, 36.0F, 2.0F, 0.0F, false);
		shield.setTextureOffset(8, 71).addBox(11.5F, -38.0F, -6.0F, 1.0F, 36.0F, 2.0F, 0.0F, false);
		shield.setTextureOffset(0, 71).addBox(-13.0F, -40.0F, 8.0F, 2.0F, 40.0F, 2.0F, 0.0F, false);
		shield.setTextureOffset(0, 72).addBox(11.0F, -40.0F, 8.0F, 2.0F, 40.0F, 2.0F, 0.0F, false);
		shield.setTextureOffset(17, 88).addBox(11.0F, -40.0F, -6.0F, 2.0F, 2.0F, 14.0F, 0.0F, false);
		shield.setTextureOffset(17, 88).addBox(-13.0F, -40.0F, -6.0F, 2.0F, 2.0F, 14.0F, 0.0F, false);
		shield.setTextureOffset(17, 88).addBox(-13.0F, -2.0F, -6.0F, 2.0F, 2.0F, 14.0F, 0.0F, false);
		shield.setTextureOffset(17, 88).addBox(11.0F, -2.0F, -6.0F, 2.0F, 2.0F, 14.0F, 0.0F, false);
		shield.setTextureOffset(16, 94).addBox(-11.0F, -40.0F, 8.0F, 22.0F, 2.0F, 2.0F, 0.0F, false);
		shield.setTextureOffset(16, 93).addBox(-11.0F, -40.0F, -8.0F, 22.0F, 2.0F, 2.0F, 0.0F, false);
		shield.setTextureOffset(16, 93).addBox(-11.0F, -2.0F, -8.0F, 22.0F, 2.0F, 2.0F, 0.0F, false);
		shield.setTextureOffset(16, 93).addBox(-11.0F, -2.0F, 8.0F, 22.0F, 2.0F, 2.0F, 0.0F, false);
	}
