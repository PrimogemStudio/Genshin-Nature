...
public static class Modelfrozen_soul_withered extends EntityModel<Entity> {
	...
	public Modelfrozen_soul_withered() {
		textureWidth = 64;
		textureHeight = 64;

		bone = new ModelRenderer(this);
		bone.setRotationPoint(0.0F, 2.5803F, 6.9538F);
		setRotationAngle(bone, 0.6109F, 0.0F, 0.0F);
		bone.setTextureOffset(0, 0).addBox(-5.0F, -10.6577F, -6.4538F, 10.0F, 14.0F, 10.0F, 0.0F, false);

		cube_r1 = new ModelRenderer(this);
		cube_r1.setRotationPoint(0.0F, -9.6577F, -1.4538F);
		bone.addChild(cube_r1);
		setRotationAngle(cube_r1, 0.829F, 0.0F, 0.0F);
		cube_r1.setTextureOffset(0, 25).addBox(-4.0F, -12.0F, -4.0F, 8.0F, 14.0F, 8.0F, 0.0F, false);

		flower = new ModelRenderer(this);
		flower.setRotationPoint(0.0F, -19.0F, -12.0F);
		...
		setRotationAngle(cube_r2, -0.1745F, 0.0F, -1.0036F);
		...
		setRotationAngle(cube_r4, -0.1745F, 0.0F, 2.0944F);
		...
		cube_r7.setRotationPoint(0.0F, 0.0995F, -0.45F);
		flower.addChild(cube_r7);
		setRotationAngle(cube_r7, -0.1745F, 0.0F, 1.0036F);
		cube_r7.setTextureOffset(43, 48).addBox(-5.0F, -15.5F, 1.2962F, 10.0F, 15.0F, 0.0F, 0.0F, false);
