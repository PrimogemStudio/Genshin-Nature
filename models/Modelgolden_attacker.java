...
public static class Modelgolden_attacker extends EntityModel<Entity> {
	...
	public Modelgolden_attacker() {
		...
		cube_r1.setRotationPoint(1.0F, -5.3561F, 22.9545F);
		body.addChild(cube_r1);
		setRotationAngle(cube_r1, 0.1309F, 0.0F, 0.0F);
		cube_r1.setTextureOffset(0, 53).addBox(-1.0F, -1.3282F, 0.5884F, 2.0F, 2.0F, 9.0F, 0.0F, false);

		cube_r2 = new ModelRenderer(this);
		cube_r2.setRotationPoint(2.0F, -11.0F, -6.5F);
		body.addChild(cube_r2);
		setRotationAngle(cube_r2, -0.2618F, 0.0F, 0.0F);
		cube_r2.setTextureOffset(0, 45).addBox(-3.0F, -3.5F, 27.5F, 4.0F, 3.0F, 3.0F, 0.0F, false);

		cube_r3 = new ModelRenderer(this);
		cube_r3.setRotationPoint(1.0F, -10.0F, -3.5F);
		body.addChild(cube_r3);
		setRotationAngle(cube_r3, -0.2618F, 0.0F, 0.0F);
		cube_r3.setTextureOffset(0, 45).addBox(0.0F, -3.5F, 18.5F, 4.0F, 3.0F, 3.0F, 0.0F, false);
		cube_r3.setTextureOffset(0, 45).addBox(-3.0F, -3.5F, 13.5F, 4.0F, 3.0F, 3.0F, 0.0F, false);
		cube_r3.setTextureOffset(0, 26).addBox(-4.0F, -4.0F, 0.5F, 8.0F, 4.0F, 11.0F, 0.0F, false);

		lefthand = new ModelRenderer(this);
		lefthand.setRotationPoint(8.9745F, 15.3064F, 0.4619F);
		setRotationAngle(lefthand, 0.0F, 0.2182F, 0.0F);
		lefthand.setTextureOffset(21, 45).addBox(0.2505F, -1.3064F, -11.411F, 1.0F, 1.0F, 5.0F, 0.0F, false);
		lefthand.setTextureOffset(21, 45).addBox(0.2505F, -2.3064F, -8.411F, 1.0F, 1.0F, 2.0F, 0.0F, false);
		lefthand.setTextureOffset(21, 45).addBox(0.2505F, -0.3064F, -8.411F, 1.0F, 1.0F, 2.0F, 0.0F, false);
		lefthand.setTextureOffset(21, 45).addBox(-0.2495F, -3.3064F, -6.411F, 2.0F, 5.0F, 5.0F, 0.0F, false);
		lefthand.setTextureOffset(21, 45).addBox(-0.2495F, -0.3064F, -1.411F, 2.0F, 1.0F, 2.0F, 0.0F, false);

		cube_r4 = new ModelRenderer(this);
		cube_r4.setRotationPoint(-0.7405F, 2.8651F, -10.1104F);
		lefthand.addChild(cube_r4);
		setRotationAngle(cube_r4, 0.2618F, -0.829F, 0.0F);
		cube_r4.setTextureOffset(54, 49).addBox(0.0325F, -1.8098F, -7.1351F, 1.0F, 1.0F, 4.0F, 0.0F, false);

		cube_r5 = new ModelRenderer(this);
		cube_r5.setRotationPoint(-0.7405F, 2.8651F, -10.1104F);
		lefthand.addChild(cube_r5);
		setRotationAngle(cube_r5, 0.0F, -0.3491F, 0.0F);
		cube_r5.setTextureOffset(54, 49).addBox(1.1898F, -0.6715F, -6.3054F, 1.0F, 1.0F, 2.0F, 0.0F, false);

		cube_r6 = new ModelRenderer(this);
		cube_r6.setRotationPoint(-0.7405F, 2.8651F, -10.1104F);
		lefthand.addChild(cube_r6);
		setRotationAngle(cube_r6, 0.0F, -0.2182F, 0.0F);
		cube_r6.setTextureOffset(54, 49).addBox(-0.2506F, -0.6715F, -6.2563F, 1.0F, 1.0F, 2.0F, 0.0F, false);

		cube_r7 = new ModelRenderer(this);
		cube_r7.setRotationPoint(-0.7405F, 2.8651F, -10.1104F);
		lefthand.addChild(cube_r7);
		setRotationAngle(cube_r7, 0.3054F, 0.3491F, 0.0F);
		cube_r7.setTextureOffset(54, 49).addBox(1.0473F, -1.7235F, -6.2071F, 1.0F, 1.0F, 4.0F, 0.0F, false);

		cube_r8 = new ModelRenderer(this);
		cube_r8.setRotationPoint(-0.7405F, 2.8651F, -10.1104F);
		lefthand.addChild(cube_r8);
		setRotationAngle(cube_r8, 0.5236F, -0.2182F, 0.0F);
		cube_r8.setTextureOffset(54, 49).addBox(1.991F, -3.5715F, -7.8006F, 1.0F, 1.0F, 3.0F, 0.0F, false);

		cube_r9 = new ModelRenderer(this);
		cube_r9.setRotationPoint(-0.7405F, 2.8651F, -10.1104F);
		lefthand.addChild(cube_r9);
		setRotationAngle(cube_r9, 0.0F, -0.3054F, 0.0F);
		cube_r9.setTextureOffset(48, 58).addBox(-1.123F, -1.2287F, -4.239F, 4.0F, 2.0F, 4.0F, 0.0F, false);

		cube_r10 = new ModelRenderer(this);
		cube_r10.setRotationPoint(0.7505F, -2.3064F, -1.411F);
		lefthand.addChild(cube_r10);
		setRotationAngle(cube_r10, 0.6981F, 0.0F, 0.0F);
		cube_r10.setTextureOffset(29, 43).addBox(-1.0F, -1.0F, -1.0F, 2.0F, 2.0F, 5.0F, 0.0F, false);

		cube_r11 = new ModelRenderer(this);
		cube_r11.setRotationPoint(0.7505F, 1.6936F, -1.911F);
		lefthand.addChild(cube_r11);
		setRotationAngle(cube_r11, 0.829F, 0.0F, 0.0F);
		cube_r11.setTextureOffset(21, 45).addBox(-1.0F, -1.0F, -0.5F, 2.0F, 3.0F, 1.0F, 0.0F, false);

		righthand = new ModelRenderer(this);
		righthand.setRotationPoint(-7.1906F, 15.3002F, 1.0825F);
		setRotationAngle(righthand, 0.0F, -0.2182F, 0.0F);
		righthand.setTextureOffset(21, 45).addBox(-1.1171F, -1.3002F, -12.0546F, 1.0F, 1.0F, 5.0F, 0.0F, false);
		righthand.setTextureOffset(21, 45).addBox(-1.1171F, -2.3002F, -9.0546F, 1.0F, 1.0F, 2.0F, 0.0F, false);
		righthand.setTextureOffset(21, 45).addBox(-1.1171F, -0.3002F, -9.0546F, 1.0F, 1.0F, 2.0F, 0.0F, false);
		righthand.setTextureOffset(21, 45).addBox(-1.6171F, -3.3002F, -7.0546F, 2.0F, 5.0F, 5.0F, 0.0F, false);
		righthand.setTextureOffset(21, 45).addBox(-1.6171F, -0.3002F, -2.0546F, 2.0F, 1.0F, 2.0F, 0.0F, false);

		cube_r12 = new ModelRenderer(this);
		cube_r12.setRotationPoint(-1.0615F, 2.1427F, -15.1846F);
		...
		cube_r13.setRotationPoint(-1.0615F, 2.1427F, -15.1846F);
		...
		cube_r14.setRotationPoint(-3.0444F, 2.1427F, -14.9235F);
		...
		cube_r15.setRotationPoint(-3.4351F, 2.6998F, -16.8922F);
		...
		cube_r16.setRotationPoint(-3.0444F, 2.1427F, -14.9235F);
		...
		cube_r17.setRotationPoint(-0.6171F, -1.3573F, -6.1481F);
		righthand.addChild(cube_r17);
		setRotationAngle(cube_r17, 0.0F, 0.1309F, 0.0F);
		cube_r17.setTextureOffset(48, 58).addBox(-2.0F, 3.0F, -9.0F, 4.0F, 2.0F, 4.0F, 0.0F, true);

		cube_r18 = new ModelRenderer(this);
		cube_r18.setRotationPoint(-0.6171F, -2.3002F, -2.0546F);
		righthand.addChild(cube_r18);
		setRotationAngle(cube_r18, 0.6981F, 0.0F, 0.0F);
		cube_r18.setTextureOffset(29, 43).addBox(-1.0F, -1.0F, -1.0F, 2.0F, 2.0F, 5.0F, 0.0F, false);

		cube_r19 = new ModelRenderer(this);
		cube_r19.setRotationPoint(-0.6171F, 1.6998F, -2.5546F);
		righthand.addChild(cube_r19);
		setRotationAngle(cube_r19, 0.829F, 0.0F, 0.0F);
		cube_r19.setTextureOffset(21, 45).addBox(-1.0F, -1.0F, -0.5F, 2.0F, 3.0F, 1.0F, 0.0F, false);
	}
