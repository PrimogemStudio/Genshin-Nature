...
public static class Modelhilichurl_electro_grenadier extends EntityModel<Entity> {
	...
	public Modelhilichurl_electro_grenadier() {
		textureWidth = 64;
		textureHeight = 64;
		...
		Head.setTextureOffset(44, 10).addBox(3.0F, -5.0F, -5.0F, 3.0F, 1.0F, 1.0F, 0.0F, false);
		Head.setTextureOffset(44, 10).addBox(-6.0F, -5.0F, -5.0F, 3.0F, 1.0F, 1.0F, 0.0F, false);
