...
public static class Modelprimal_construct_repulsor extends EntityModel<Entity> {
	...
	public Modelprimal_construct_repulsor() {
		textureWidth = 64;
		textureHeight = 64;
		...
		weapon.setRotationPoint(12.5F, 11.5F, -1.6667F);
		setRotationAngle(weapon, 0.1745F, -0.3491F, 0.0F);
		...
		weapon2.setRotationPoint(-12.5F, 11.5F, -1.6667F);
		setRotationAngle(weapon2, 0.1745F, 0.3491F, 0.0F);
		weapon2.setTextureOffset(29, 17).addBox(-2.5F, -2.5F, -2.8333F, 5.0F, 5.0F, 1.0F, 0.0F, false);
		weapon2.setTextureOffset(29, 17).addBox(-2.5F, -2.5F, 0.1667F, 5.0F, 5.0F, 1.0F, 0.0F, false);
		weapon2.setTextureOffset(3, 32).addBox(-3.5F, -3.5F, 0.6667F, 7.0F, 7.0F, 2.0F, 0.0F, true);
	}
