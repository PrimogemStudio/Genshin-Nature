...
public static class Modelcryo_regisvine extends EntityModel<Entity> {
	...
	public Modelcryo_regisvine() {
		...
		cube_r6.setTextureOffset(94, 92).addBox(-4.0F, -20.5F, -2.0F, 9.0F, 28.0F, 8.0F, 0.0F, false);
		...
		cube_r7.setTextureOffset(96, 101).addBox(-4.5F, -15.6264F, -2.7579F, 9.0F, 20.0F, 7.0F, 0.0F, false);
		...
		cube_r14.setTextureOffset(21, 96).addBox(-1.9995F, -3.3704F, -1.0152F, 21.0F, 5.0F, 5.0F, 0.0F, true);
		...
		cube_r17.setTextureOffset(21, 96).addBox(-1.9995F, -3.3704F, -1.0152F, 21.0F, 5.0F, 5.0F, 0.0F, true);
