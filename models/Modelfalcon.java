...
public static class Modelfalcon extends EntityModel<Entity> {
	...
	public Modelfalcon() {
		...
		setRotationAngle(left_leg, 0.0F, 0.2182F, 0.0F);
		...
		setRotationAngle(right_leg, 0.0F, -0.2182F, 0.0F);
		...
		wing1.setRotationPoint(3.0F, 0.0303F, -3.6293F);
		bone.addChild(wing1);
		...
		wing2.setRotationPoint(-3.0F, 0.0303F, -3.6293F);
		bone.addChild(wing2);
