...
public static class Modelstretchy_geo_fungus extends EntityModel<Entity> {
	private final ModelRenderer bone;
	private final ModelRenderer hat;

	public Modelstretchy_geo_fungus() {
		textureWidth = 128;
		textureHeight = 128;
		...
		hat.setTextureOffset(4, 75).addBox(-6.0F, -24.0F, -4.0F, 10.0F, 1.0F, 10.0F, 0.0F, false);
	}
