...
public class HourofsoothingthundereffectMobEffect extends MobEffect {
	public HourofsoothingthundereffectMobEffect() {
		super(MobEffectCategory.BENEFICIAL, -14662003);
	}
