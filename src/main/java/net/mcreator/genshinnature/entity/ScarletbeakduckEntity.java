...
public class ScarletbeakduckEntity extends PathfinderMob {
	public ScarletbeakduckEntity(EntityType<ScarletbeakduckEntity> type, Level world) {
		super(type, world);
		xpReward = 2;
		setNoAi(false);
	}
	...
	public static void init(RegisterSpawnPlacementsEvent event) {
		event.register(GenshinNatureModEntities.SCARLETBEAKDUCK.get(), SpawnPlacementTypes.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
