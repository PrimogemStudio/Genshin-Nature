...
import net.mcreator.genshinnature.procedures.HitcicinmageelectroProcedure;
import net.mcreator.genshinnature.procedures.DropfatuiinsigniasProcedure;
import net.mcreator.genshinnature.init.GenshinNatureModItems;

public class FatuielectrocicinmageEntity extends Monster {
	...
	public boolean hurt(DamageSource damagesource, float amount) {
		...
		HitcicinmageelectroProcedure.execute(world, x, y, z, entity, sourceentity);
