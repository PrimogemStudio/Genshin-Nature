...
import net.mcreator.genshinnature.procedures.BrownwingfalcontolandProcedure;
import net.mcreator.genshinnature.procedures.BirdflyingProcedure;
import net.mcreator.genshinnature.init.GenshinNatureModItems;

import javax.annotation.Nullable;

public class BrownwingfalconflyingEntity extends PathfinderMob {
	public BrownwingfalconflyingEntity(EntityType<BrownwingfalconflyingEntity> type, Level world) {
		super(type, world);
		xpReward = 1;
		setNoAi(false);
	...
	public void baseTick() {
		super.baseTick();
		BrownwingfalcontolandProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this);
	}
