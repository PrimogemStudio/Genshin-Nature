...
import net.mcreator.genshinnature.procedures.ElectrohypostasisdropsProcedure;
import net.mcreator.genshinnature.init.GenshinNatureModItems;

public class Electrohypostasisphase8Entity extends Monster {
	...
	public Electrohypostasisphase8Entity(EntityType<Electrohypostasisphase8Entity> type, Level world) {
		super(type, world);
		xpReward = 14;
		setNoAi(false);
	...
	protected void dropCustomDeathLoot(ServerLevel serverLevel, DamageSource source, boolean recentlyHitIn) {
		...
		this.spawnAtLocation(new ItemStack(GenshinNatureModItems.LIGHTNINGPRISM.get()));
	}
	...
	public void die(DamageSource source) {
		super.die(source);
		ElectrohypostasisdropsProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ());
	}
