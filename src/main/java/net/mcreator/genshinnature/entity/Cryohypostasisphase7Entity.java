...
import net.mcreator.genshinnature.procedures.Spawncryohypostasisphase8Procedure;
import net.mcreator.genshinnature.procedures.CryobehaviorProcedure;

public class Cryohypostasisphase7Entity extends Monster {
	...
	public Cryohypostasisphase7Entity(EntityType<Cryohypostasisphase7Entity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	...
	public void die(DamageSource source) {
		super.die(source);
		Spawncryohypostasisphase8Procedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this);
	}
