...
public class HilichurlpyroshooterEntity extends Monster implements RangedAttackMob {
	public HilichurlpyroshooterEntity(EntityType<HilichurlpyroshooterEntity> type, Level world) {
		super(type, world);
		xpReward = 4;
		setNoAi(false);
	...
	public void performRangedAttack(LivingEntity target, float flval) {
		HilichurlpyroshooterEntityProjectile entityarrow = new HilichurlpyroshooterEntityProjectile(GenshinNatureModEntities.HILICHURLPYROSHOOTER_PROJECTILE.get(), this, this.level());
