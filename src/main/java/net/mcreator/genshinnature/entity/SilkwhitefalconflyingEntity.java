...
import net.mcreator.genshinnature.procedures.SilkwhitefalcontolandProcedure;
import net.mcreator.genshinnature.procedures.BirdflyingProcedure;
import net.mcreator.genshinnature.init.GenshinNatureModItems;

import javax.annotation.Nullable;

public class SilkwhitefalconflyingEntity extends PathfinderMob {
	public SilkwhitefalconflyingEntity(EntityType<SilkwhitefalconflyingEntity> type, Level world) {
		super(type, world);
		xpReward = 1;
		setNoAi(false);
	...
	public void baseTick() {
		super.baseTick();
		SilkwhitefalcontolandProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this);
	}
