...
import net.mcreator.genshinnature.procedures.Geohypostasisphase5spawnProcedure;

public class Geohypostasisphase4Entity extends Monster {
	...
	public Geohypostasisphase4Entity(EntityType<Geohypostasisphase4Entity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	...
	public void die(DamageSource source) {
		super.die(source);
		Geohypostasisphase5spawnProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this);
	}
