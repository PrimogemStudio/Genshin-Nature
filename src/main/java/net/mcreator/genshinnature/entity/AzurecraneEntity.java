...
public class AzurecraneEntity extends PathfinderMob {
	public AzurecraneEntity(EntityType<AzurecraneEntity> type, Level world) {
		super(type, world);
		xpReward = 2;
		setNoAi(false);
	}
	...
	public static void init(RegisterSpawnPlacementsEvent event) {
		event.register(GenshinNatureModEntities.AZURECRANE.get(), SpawnPlacementTypes.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
