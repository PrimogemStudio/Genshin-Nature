...
import net.mcreator.genshinnature.procedures.Spawncryohypostasisphase2Procedure;
import net.mcreator.genshinnature.procedures.CryobehaviorProcedure;

public class CryohypostasisEntity extends Monster {
	...
	public CryohypostasisEntity(EntityType<CryohypostasisEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	...
	public void die(DamageSource source) {
		super.die(source);
		Spawncryohypostasisphase2Procedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this);
	}
