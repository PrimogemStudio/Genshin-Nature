...
import net.mcreator.genshinnature.procedures.Spawncryohypostasisphase5Procedure;
import net.mcreator.genshinnature.procedures.CryobehaviorProcedure;

public class Cryohypostasisphase4Entity extends Monster {
	...
	public Cryohypostasisphase4Entity(EntityType<Cryohypostasisphase4Entity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	...
	public void die(DamageSource source) {
		super.die(source);
		Spawncryohypostasisphase5Procedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this);
	}
