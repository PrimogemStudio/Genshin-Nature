...
import net.mcreator.genshinnature.procedures.CatchanemocrystalflyProcedure;
...
public class AnemocrystalflyEntity extends PathfinderMob {
	...
	public InteractionResult mobInteract(Player sourceentity, InteractionHand hand) {
		...
		CatchanemocrystalflyProcedure.execute(entity, sourceentity);
		return retval;
	}
	...
	public static void init(RegisterSpawnPlacementsEvent event) {
		event.register(GenshinNatureModEntities.ANEMOCRYSTALFLY.get(), SpawnPlacementTypes.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
