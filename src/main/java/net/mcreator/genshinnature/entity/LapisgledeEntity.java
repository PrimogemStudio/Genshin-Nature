...
import net.mcreator.genshinnature.procedures.LapisgledetoairProcedure;
import net.mcreator.genshinnature.init.GenshinNatureModItems;
import net.mcreator.genshinnature.init.GenshinNatureModEntities;

public class LapisgledeEntity extends PathfinderMob {
	public LapisgledeEntity(EntityType<LapisgledeEntity> type, Level world) {
		super(type, world);
		xpReward = 1;
		setNoAi(false);
	...
	public boolean causeFallDamage(float l, float d, DamageSource source) {
		LapisgledetoairProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this);
	...
	public static void init(RegisterSpawnPlacementsEvent event) {
		event.register(GenshinNatureModEntities.LAPISGLEDE.get(), SpawnPlacementTypes.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
