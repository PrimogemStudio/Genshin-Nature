...
import net.mcreator.genshinnature.procedures.Geohypostasisphase2spawnProcedure;

public class GeohypostasisEntity extends Monster {
	...
	public GeohypostasisEntity(EntityType<GeohypostasisEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	...
	public void die(DamageSource source) {
		super.die(source);
		Geohypostasisphase2spawnProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this);
	}
