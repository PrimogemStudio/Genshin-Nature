...
import net.mcreator.genshinnature.procedures.Geohypostasisphase8spawnProcedure;

public class Geohypostasisphase7Entity extends Monster {
	...
	public Geohypostasisphase7Entity(EntityType<Geohypostasisphase7Entity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	...
	public void die(DamageSource source) {
		super.die(source);
		Geohypostasisphase8spawnProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this);
	}
