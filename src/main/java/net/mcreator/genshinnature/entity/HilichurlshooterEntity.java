...
public class HilichurlshooterEntity extends Monster implements RangedAttackMob {
	public HilichurlshooterEntity(EntityType<HilichurlshooterEntity> type, Level world) {
		super(type, world);
		xpReward = 4;
		setNoAi(false);
	...
	public void performRangedAttack(LivingEntity target, float flval) {
		HilichurlshooterEntityProjectile entityarrow = new HilichurlshooterEntityProjectile(GenshinNatureModEntities.HILICHURLSHOOTER_PROJECTILE.get(), this, this.level());
