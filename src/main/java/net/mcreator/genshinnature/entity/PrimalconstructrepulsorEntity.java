...
import net.mcreator.genshinnature.procedures.WeaponrepulsorspawnProcedure;
import net.mcreator.genshinnature.init.GenshinNatureModItems;

public class PrimalconstructrepulsorEntity extends Monster {
	public PrimalconstructrepulsorEntity(EntityType<PrimalconstructrepulsorEntity> type, Level world) {
		super(type, world);
		xpReward = 5;
		setNoAi(false);
	...
	protected void registerGoals() {
		...
		this.goalSelector.addGoal(6, new RandomStrollGoal(this, 1, 20) {
			...
			protected Vec3 getPosition() {
				RandomSource random = PrimalconstructrepulsorEntity.this.getRandom();
				double dir_x = PrimalconstructrepulsorEntity.this.getX() + ((random.nextFloat() * 2 - 1) * 16);
				double dir_y = PrimalconstructrepulsorEntity.this.getY() + ((random.nextFloat() * 2 - 1) * 16);
				double dir_z = PrimalconstructrepulsorEntity.this.getZ() + ((random.nextFloat() * 2 - 1) * 16);
	...
	public boolean hurt(DamageSource damagesource, float amount) {
		...
		WeaponrepulsorspawnProcedure.execute(world, x, y, z, entity);
