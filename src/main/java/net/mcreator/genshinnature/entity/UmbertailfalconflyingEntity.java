...
import net.mcreator.genshinnature.procedures.UmbertailfalcontolandProcedure;
import net.mcreator.genshinnature.procedures.BirdflyingProcedure;
import net.mcreator.genshinnature.init.GenshinNatureModItems;

import javax.annotation.Nullable;

public class UmbertailfalconflyingEntity extends PathfinderMob {
	public UmbertailfalconflyingEntity(EntityType<UmbertailfalconflyingEntity> type, Level world) {
		super(type, world);
		xpReward = 1;
		setNoAi(false);
	...
	public void baseTick() {
		super.baseTick();
		UmbertailfalcontolandProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this);
	}
