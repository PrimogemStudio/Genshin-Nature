...
import net.mcreator.genshinnature.procedures.GeohypostasisdropsProcedure;
import net.mcreator.genshinnature.init.GenshinNatureModItems;

public class Geohypostasisphase8Entity extends Monster {
	...
	public Geohypostasisphase8Entity(EntityType<Geohypostasisphase8Entity> type, Level world) {
		super(type, world);
		xpReward = 14;
		setNoAi(false);
	...
	protected void dropCustomDeathLoot(ServerLevel serverLevel, DamageSource source, boolean recentlyHitIn) {
		...
		this.spawnAtLocation(new ItemStack(GenshinNatureModItems.BASALTPILLARITEM.get()));
	}
	...
	public void die(DamageSource source) {
		super.die(source);
		GeohypostasisdropsProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ());
	}
