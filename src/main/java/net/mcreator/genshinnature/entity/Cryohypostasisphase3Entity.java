...
import net.mcreator.genshinnature.procedures.Spawncryohypostasisphase4Procedure;
import net.mcreator.genshinnature.procedures.CryobehaviorProcedure;

public class Cryohypostasisphase3Entity extends Monster {
	...
	public Cryohypostasisphase3Entity(EntityType<Cryohypostasisphase3Entity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	...
	public void die(DamageSource source) {
		super.die(source);
		Spawncryohypostasisphase4Procedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this);
	}
