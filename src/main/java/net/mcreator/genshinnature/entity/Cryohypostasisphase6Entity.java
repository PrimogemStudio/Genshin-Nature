...
import net.mcreator.genshinnature.procedures.Spawncryohypostasisphase7Procedure;
...
public class Cryohypostasisphase6Entity extends Monster {
	...
	public Cryohypostasisphase6Entity(EntityType<Cryohypostasisphase6Entity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	...
	public void die(DamageSource source) {
		super.die(source);
		Spawncryohypostasisphase7Procedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this);
	}
