...
public class HilichurlcryoshooterEntity extends Monster implements RangedAttackMob {
	public HilichurlcryoshooterEntity(EntityType<HilichurlcryoshooterEntity> type, Level world) {
		super(type, world);
		xpReward = 4;
		setNoAi(false);
	...
	public void performRangedAttack(LivingEntity target, float flval) {
		HilichurlcryoshooterEntityProjectile entityarrow = new HilichurlcryoshooterEntityProjectile(GenshinNatureModEntities.HILICHURLCRYOSHOOTER_PROJECTILE.get(), this, this.level());
