...
@EventBusSubscriber
public class ScarletvesselprocedProcedure {
	@SubscribeEvent
	...
	private static void execute(@Nullable Event event, Entity sourceentity) {
		...
		if (sourceentity.getType().is(TagKey.create(Registries.ENTITY_TYPE, ResourceLocation.parse("genshin_nature:isaplayer")))) {
			if (sourceentity instanceof LivingEntity _livEnt1 && _livEnt1.hasEffect(GenshinNatureModMobEffects.SCARLETVESSELEFFECT)) {
