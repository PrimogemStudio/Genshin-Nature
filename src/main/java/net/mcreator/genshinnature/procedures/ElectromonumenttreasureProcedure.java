...
public class ElectromonumenttreasureProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z) {
		if (world instanceof ServerLevel _serverworld) {
			StructureTemplate template = _serverworld.getStructureManager().getOrCreate(ResourceLocation.fromNamespaceAndPath("genshin_nature", "electro_monument_treasure"));
			if (template != null) {
		...
		}
		{
			...
			BlockState _bs = GenshinNatureModBlocks.BLANKMONUMENT.get().defaultBlockState();
