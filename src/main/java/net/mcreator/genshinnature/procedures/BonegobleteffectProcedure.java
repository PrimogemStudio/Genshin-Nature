...
@EventBusSubscriber
public class BonegobleteffectProcedure {
	@SubscribeEvent
	...
	private static void execute(@Nullable Event event, Entity entity) {
		...
		if (entity.getType().is(TagKey.create(Registries.ENTITY_TYPE, ResourceLocation.parse("genshin_nature:isaplayer")))) {
			if ((entity instanceof LivingEntity _livEnt ? _livEnt.getHealth() : -1) <= 5) {
				if (entity instanceof LivingEntity _livEnt2 && _livEnt2.hasEffect(GenshinNatureModMobEffects.BERSERKERSBONEGOBLETEFFECT)) {
