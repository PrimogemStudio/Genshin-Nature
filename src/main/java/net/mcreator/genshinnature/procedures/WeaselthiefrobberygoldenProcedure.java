...
public class WeaselthiefrobberygoldenProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity, Entity sourceentity) {
		...
		if (world instanceof ServerLevel _level) {
			Entity entityToSpawn = GenshinNatureModEntities.GOLDENWEASELTHIEFSCARED.get().spawn(_level, BlockPos.containing(x, y, z), MobSpawnType.MOB_SUMMONED);
