...
public class ApprenticesnotesItem extends Item {
	public ApprenticesnotesItem() {
	...
	public void appendHoverText(ItemStack itemstack, Item.TooltipContext context, List<Component> list, TooltipFlag flag) {
		...
		list.add(Component.translatable("item.genshin_nature.apprenticesnotes.description_0"));
	}
	...
	public void releaseUsing(ItemStack itemstack, Level world, LivingEntity entity, int time) {
		if (!world.isClientSide() && entity instanceof ServerPlayer player) {
			...
			if (player.getAbilities().instabuild || stack != ItemStack.EMPTY) {
				ApprenticesnotesProjectileEntity projectile = ApprenticesnotesProjectileEntity.shoot(world, entity, world.getRandom());
				itemstack.hurtAndBreak(1, entity, LivingEntity.getSlotForHand(entity.getUsedItemHand()));
	...
	private ItemStack findAmmo(Player player) {
		return new ItemStack(ApprenticesnotesProjectileEntity.PROJECTILE_ITEM.getItem());
	}
}
