...
public class CrimsonagateshovelItem extends ShovelItem {
	...
	public CrimsonagateshovelItem() {
		super(TOOL_TIER, new Item.Properties().attributes(DiggerItem.createAttributes(TOOL_TIER, 3.5f, -3f)).fireResistant());
	}
