...
import net.mcreator.genshinnature.network.Quest3ButtonMessage;
...
public class Quest3Screen extends AbstractContainerScreen<Quest3Menu> {
	...
	private static final ResourceLocation texture = ResourceLocation.parse("genshin_nature:textures/screens/quest_3.png");
	...
	public void init() {
		super.init();
		button_click = Button.builder(Component.translatable("gui.genshin_nature.quest_3.button_click"), e -> {
			if (true) {
				PacketDistributor.sendToServer(new Quest3ButtonMessage(0, x, y, z));
