...
import net.mcreator.genshinnature.network.Quest12ButtonMessage;
...
public class Quest12Screen extends AbstractContainerScreen<Quest12Menu> {
	...
	private static final ResourceLocation texture = ResourceLocation.parse("genshin_nature:textures/screens/quest_12.png");
	...
	public void init() {
		super.init();
		button_click = Button.builder(Component.translatable("gui.genshin_nature.quest_12.button_click"), e -> {
			if (true) {
				PacketDistributor.sendToServer(new Quest12ButtonMessage(0, x, y, z));
