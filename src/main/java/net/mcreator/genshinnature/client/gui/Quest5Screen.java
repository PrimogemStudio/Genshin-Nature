...
import net.mcreator.genshinnature.network.Quest5ButtonMessage;
...
public class Quest5Screen extends AbstractContainerScreen<Quest5Menu> {
	...
	private static final ResourceLocation texture = ResourceLocation.parse("genshin_nature:textures/screens/quest_5.png");
	...
	public void init() {
		super.init();
		button_click = Button.builder(Component.translatable("gui.genshin_nature.quest_5.button_click"), e -> {
			if (true) {
				PacketDistributor.sendToServer(new Quest5ButtonMessage(0, x, y, z));
