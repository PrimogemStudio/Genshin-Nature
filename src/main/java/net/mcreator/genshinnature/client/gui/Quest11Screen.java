...
import net.mcreator.genshinnature.network.Quest11ButtonMessage;
...
public class Quest11Screen extends AbstractContainerScreen<Quest11Menu> {
	...
	private static final ResourceLocation texture = ResourceLocation.parse("genshin_nature:textures/screens/quest_11.png");
	...
	public void init() {
		super.init();
		button_click = Button.builder(Component.translatable("gui.genshin_nature.quest_11.button_click"), e -> {
			if (true) {
				PacketDistributor.sendToServer(new Quest11ButtonMessage(0, x, y, z));
