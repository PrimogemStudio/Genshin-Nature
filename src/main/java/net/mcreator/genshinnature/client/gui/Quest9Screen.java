...
import net.mcreator.genshinnature.network.Quest9ButtonMessage;
...
public class Quest9Screen extends AbstractContainerScreen<Quest9Menu> {
	...
	private static final ResourceLocation texture = ResourceLocation.parse("genshin_nature:textures/screens/quest_9.png");
	...
	public void init() {
		super.init();
		button_click = Button.builder(Component.translatable("gui.genshin_nature.quest_9.button_click"), e -> {
			if (true) {
				PacketDistributor.sendToServer(new Quest9ButtonMessage(0, x, y, z));
