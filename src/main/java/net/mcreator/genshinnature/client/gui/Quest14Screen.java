...
import net.mcreator.genshinnature.network.Quest14ButtonMessage;
...
public class Quest14Screen extends AbstractContainerScreen<Quest14Menu> {
	...
	private static final ResourceLocation texture = ResourceLocation.parse("genshin_nature:textures/screens/quest_14.png");
	...
	public void init() {
		super.init();
		button_click = Button.builder(Component.translatable("gui.genshin_nature.quest_14.button_click"), e -> {
			if (true) {
				PacketDistributor.sendToServer(new Quest14ButtonMessage(0, x, y, z));
