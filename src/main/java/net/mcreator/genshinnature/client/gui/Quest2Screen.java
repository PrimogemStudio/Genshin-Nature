...
import net.mcreator.genshinnature.network.Quest2ButtonMessage;
...
public class Quest2Screen extends AbstractContainerScreen<Quest2Menu> {
	...
	private static final ResourceLocation texture = ResourceLocation.parse("genshin_nature:textures/screens/quest_2.png");
	...
	public void init() {
		super.init();
		button_click = Button.builder(Component.translatable("gui.genshin_nature.quest_2.button_click"), e -> {
			if (true) {
				PacketDistributor.sendToServer(new Quest2ButtonMessage(0, x, y, z));
