...
import net.mcreator.genshinnature.network.Quest8ButtonMessage;
...
public class Quest8Screen extends AbstractContainerScreen<Quest8Menu> {
	...
	private static final ResourceLocation texture = ResourceLocation.parse("genshin_nature:textures/screens/quest_8.png");
	...
	public void init() {
		super.init();
		button_click = Button.builder(Component.translatable("gui.genshin_nature.quest_8.button_click"), e -> {
			if (true) {
				PacketDistributor.sendToServer(new Quest8ButtonMessage(0, x, y, z));
