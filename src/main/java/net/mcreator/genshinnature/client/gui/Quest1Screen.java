...
import net.mcreator.genshinnature.network.Quest1ButtonMessage;
...
public class Quest1Screen extends AbstractContainerScreen<Quest1Menu> {
	...
	private static final ResourceLocation texture = ResourceLocation.parse("genshin_nature:textures/screens/quest_1.png");
	...
	public void init() {
		super.init();
		button_click = Button.builder(Component.translatable("gui.genshin_nature.quest_1.button_click"), e -> {
			if (true) {
				PacketDistributor.sendToServer(new Quest1ButtonMessage(0, x, y, z));
