...
public class MoonfinRenderer extends HumanoidMobRenderer<MoonfinEntity, HumanoidModel<MoonfinEntity>> {
	public MoonfinRenderer(EntityRendererProvider.Context context) {
		super(context, new HumanoidModel<MoonfinEntity>(context.bakeLayer(ModelLayers.PLAYER)), 0.5f);
