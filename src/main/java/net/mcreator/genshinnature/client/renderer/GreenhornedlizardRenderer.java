...
public class GreenhornedlizardRenderer extends HumanoidMobRenderer<GreenhornedlizardEntity, HumanoidModel<GreenhornedlizardEntity>> {
	public GreenhornedlizardRenderer(EntityRendererProvider.Context context) {
		super(context, new HumanoidModel<GreenhornedlizardEntity>(context.bakeLayer(ModelLayers.PLAYER)), 0.5f);
