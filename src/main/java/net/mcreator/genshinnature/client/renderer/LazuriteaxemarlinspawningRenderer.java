...
public class LazuriteaxemarlinspawningRenderer extends HumanoidMobRenderer<LazuriteaxemarlinspawningEntity, HumanoidModel<LazuriteaxemarlinspawningEntity>> {
	public LazuriteaxemarlinspawningRenderer(EntityRendererProvider.Context context) {
		super(context, new HumanoidModel<LazuriteaxemarlinspawningEntity>(context.bakeLayer(ModelLayers.PLAYER)), 0.5f);
