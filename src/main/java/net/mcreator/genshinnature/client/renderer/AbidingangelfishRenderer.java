...
public class AbidingangelfishRenderer extends HumanoidMobRenderer<AbidingangelfishEntity, HumanoidModel<AbidingangelfishEntity>> {
	public AbidingangelfishRenderer(EntityRendererProvider.Context context) {
		super(context, new HumanoidModel<AbidingangelfishEntity>(context.bakeLayer(ModelLayers.PLAYER)), 0.5f);
