...
public class GlazemedakaspawningRenderer extends HumanoidMobRenderer<GlazemedakaspawningEntity, HumanoidModel<GlazemedakaspawningEntity>> {
	public GlazemedakaspawningRenderer(EntityRendererProvider.Context context) {
		super(context, new HumanoidModel<GlazemedakaspawningEntity>(context.bakeLayer(ModelLayers.PLAYER)), 0.6f);
