...
public class Cryohypostasisphase4Renderer extends HumanoidMobRenderer<Cryohypostasisphase4Entity, HumanoidModel<Cryohypostasisphase4Entity>> {
	public Cryohypostasisphase4Renderer(EntityRendererProvider.Context context) {
		super(context, new HumanoidModel<Cryohypostasisphase4Entity>(context.bakeLayer(ModelLayers.PLAYER)), 1f);
		this.addLayer(new HumanoidArmorLayer(this, new HumanoidModel(context.bakeLayer(ModelLayers.PLAYER_INNER_ARMOR)), new HumanoidModel(context.bakeLayer(ModelLayers.PLAYER_OUTER_ARMOR)), context.getModelManager()));
		this.addLayer(new RenderLayer<Cryohypostasisphase4Entity, HumanoidModel<Cryohypostasisphase4Entity>>(this) {
