...
public class UnlitpyroslimeRenderer extends HumanoidMobRenderer<UnlitpyroslimeEntity, HumanoidModel<UnlitpyroslimeEntity>> {
	public UnlitpyroslimeRenderer(EntityRendererProvider.Context context) {
		super(context, new HumanoidModel<UnlitpyroslimeEntity>(context.bakeLayer(ModelLayers.PLAYER)), 0.5f);
