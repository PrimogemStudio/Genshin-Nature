...
public class HilichurlpyrogrenadierRenderer extends HumanoidMobRenderer<HilichurlpyrogrenadierEntity, HumanoidModel<HilichurlpyrogrenadierEntity>> {
	public HilichurlpyrogrenadierRenderer(EntityRendererProvider.Context context) {
		super(context, new HumanoidModel<HilichurlpyrogrenadierEntity>(context.bakeLayer(ModelLayers.PLAYER)), 0.5f);
