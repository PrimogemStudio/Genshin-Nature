...
public class Questnpc4Renderer extends HumanoidMobRenderer<Questnpc4Entity, HumanoidModel<Questnpc4Entity>> {
	public Questnpc4Renderer(EntityRendererProvider.Context context) {
		super(context, new HumanoidModel<Questnpc4Entity>(context.bakeLayer(ModelLayers.PLAYER)), 0.5f);
