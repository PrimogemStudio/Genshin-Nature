...
public class OceancrabRenderer extends HumanoidMobRenderer<OceancrabEntity, HumanoidModel<OceancrabEntity>> {
	public OceancrabRenderer(EntityRendererProvider.Context context) {
		super(context, new HumanoidModel<OceancrabEntity>(context.bakeLayer(ModelLayers.PLAYER)), 0.6f);
