...
public class PurpleshirakodaispawningRenderer extends HumanoidMobRenderer<PurpleshirakodaispawningEntity, HumanoidModel<PurpleshirakodaispawningEntity>> {
	public PurpleshirakodaispawningRenderer(EntityRendererProvider.Context context) {
		super(context, new HumanoidModel<PurpleshirakodaispawningEntity>(context.bakeLayer(ModelLayers.PLAYER)), 0.5f);
