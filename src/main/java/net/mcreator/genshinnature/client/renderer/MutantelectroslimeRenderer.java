...
public class MutantelectroslimeRenderer extends MobRenderer<MutantelectroslimeEntity, Modellargeelectroslime_finished<MutantelectroslimeEntity>> {
	public MutantelectroslimeRenderer(EntityRendererProvider.Context context) {
		super(context, new Modellargeelectroslime_finished<MutantelectroslimeEntity>(context.bakeLayer(Modellargeelectroslime_finished.LAYER_LOCATION)), 1f);
		this.addLayer(new RenderLayer<MutantelectroslimeEntity, Modellargeelectroslime_finished<MutantelectroslimeEntity>>(this) {
