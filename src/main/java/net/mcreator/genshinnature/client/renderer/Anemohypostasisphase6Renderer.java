...
public class Anemohypostasisphase6Renderer extends MobRenderer<Anemohypostasisphase6Entity, Modelanemo_hypostasis<Anemohypostasisphase6Entity>> {
	public Anemohypostasisphase6Renderer(EntityRendererProvider.Context context) {
		super(context, new Modelanemo_hypostasis<Anemohypostasisphase6Entity>(context.bakeLayer(Modelanemo_hypostasis.LAYER_LOCATION)), 1f);
		this.addLayer(new RenderLayer<Anemohypostasisphase6Entity, Modelanemo_hypostasis<Anemohypostasisphase6Entity>>(this) {
