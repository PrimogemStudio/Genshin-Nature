...
public class WeaponreshaperRenderer extends HumanoidMobRenderer<WeaponreshaperEntity, HumanoidModel<WeaponreshaperEntity>> {
	public WeaponreshaperRenderer(EntityRendererProvider.Context context) {
		super(context, new HumanoidModel<WeaponreshaperEntity>(context.bakeLayer(ModelLayers.PLAYER)), 0.4f);
