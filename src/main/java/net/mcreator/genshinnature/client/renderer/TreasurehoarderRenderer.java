...
public class TreasurehoarderRenderer extends HumanoidMobRenderer<TreasurehoarderEntity, HumanoidModel<TreasurehoarderEntity>> {
	public TreasurehoarderRenderer(EntityRendererProvider.Context context) {
		super(context, new HumanoidModel<TreasurehoarderEntity>(context.bakeLayer(ModelLayers.PLAYER)), 0.5f);
