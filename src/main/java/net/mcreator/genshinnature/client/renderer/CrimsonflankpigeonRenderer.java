...
public class CrimsonflankpigeonRenderer extends HumanoidMobRenderer<CrimsonflankpigeonEntity, HumanoidModel<CrimsonflankpigeonEntity>> {
	public CrimsonflankpigeonRenderer(EntityRendererProvider.Context context) {
		super(context, new HumanoidModel<CrimsonflankpigeonEntity>(context.bakeLayer(ModelLayers.PLAYER)), 0.6f);
