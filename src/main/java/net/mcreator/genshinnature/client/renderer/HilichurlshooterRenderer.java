...
public class HilichurlshooterRenderer extends HumanoidMobRenderer<HilichurlshooterEntity, HumanoidModel<HilichurlshooterEntity>> {
	public HilichurlshooterRenderer(EntityRendererProvider.Context context) {
		super(context, new HumanoidModel<HilichurlshooterEntity>(context.bakeLayer(ModelLayers.PLAYER)), 0.5f);
