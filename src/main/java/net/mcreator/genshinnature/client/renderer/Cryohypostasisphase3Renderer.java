...
public class Cryohypostasisphase3Renderer extends HumanoidMobRenderer<Cryohypostasisphase3Entity, HumanoidModel<Cryohypostasisphase3Entity>> {
	public Cryohypostasisphase3Renderer(EntityRendererProvider.Context context) {
		super(context, new HumanoidModel<Cryohypostasisphase3Entity>(context.bakeLayer(ModelLayers.PLAYER)), 2f);
		this.addLayer(new HumanoidArmorLayer(this, new HumanoidModel(context.bakeLayer(ModelLayers.PLAYER_INNER_ARMOR)), new HumanoidModel(context.bakeLayer(ModelLayers.PLAYER_OUTER_ARMOR)), context.getModelManager()));
		this.addLayer(new RenderLayer<Cryohypostasisphase3Entity, HumanoidModel<Cryohypostasisphase3Entity>>(this) {
