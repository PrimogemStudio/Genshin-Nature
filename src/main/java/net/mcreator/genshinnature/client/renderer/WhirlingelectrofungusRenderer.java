...
public class WhirlingelectrofungusRenderer extends HumanoidMobRenderer<WhirlingelectrofungusEntity, HumanoidModel<WhirlingelectrofungusEntity>> {
	public WhirlingelectrofungusRenderer(EntityRendererProvider.Context context) {
		super(context, new HumanoidModel<WhirlingelectrofungusEntity>(context.bakeLayer(ModelLayers.PLAYER)), 0.6f);
