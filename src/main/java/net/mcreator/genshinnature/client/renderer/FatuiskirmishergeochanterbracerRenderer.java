...
public class FatuiskirmishergeochanterbracerRenderer extends HumanoidMobRenderer<FatuiskirmishergeochanterbracerEntity, HumanoidModel<FatuiskirmishergeochanterbracerEntity>> {
	public FatuiskirmishergeochanterbracerRenderer(EntityRendererProvider.Context context) {
		super(context, new HumanoidModel<FatuiskirmishergeochanterbracerEntity>(context.bakeLayer(ModelLayers.PLAYER)), 0.5f);
		this.addLayer(new HumanoidArmorLayer(this, new HumanoidModel(context.bakeLayer(ModelLayers.PLAYER_INNER_ARMOR)), new HumanoidModel(context.bakeLayer(ModelLayers.PLAYER_OUTER_ARMOR)), context.getModelManager()));
		this.addLayer(new RenderLayer<FatuiskirmishergeochanterbracerEntity, HumanoidModel<FatuiskirmishergeochanterbracerEntity>>(this) {
