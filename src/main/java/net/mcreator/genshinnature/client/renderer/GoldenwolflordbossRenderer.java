...
public class GoldenwolflordbossRenderer extends HumanoidMobRenderer<GoldenwolflordbossEntity, HumanoidModel<GoldenwolflordbossEntity>> {
	public GoldenwolflordbossRenderer(EntityRendererProvider.Context context) {
		super(context, new HumanoidModel<GoldenwolflordbossEntity>(context.bakeLayer(ModelLayers.PLAYER)), 5f);
		this.addLayer(new HumanoidArmorLayer(this, new HumanoidModel(context.bakeLayer(ModelLayers.PLAYER_INNER_ARMOR)), new HumanoidModel(context.bakeLayer(ModelLayers.PLAYER_OUTER_ARMOR)), context.getModelManager()));
		this.addLayer(new RenderLayer<GoldenwolflordbossEntity, HumanoidModel<GoldenwolflordbossEntity>>(this) {
