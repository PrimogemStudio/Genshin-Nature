...
public class BrownwingfalconflyingRenderer extends HumanoidMobRenderer<BrownwingfalconflyingEntity, HumanoidModel<BrownwingfalconflyingEntity>> {
	public BrownwingfalconflyingRenderer(EntityRendererProvider.Context context) {
		super(context, new HumanoidModel<BrownwingfalconflyingEntity>(context.bakeLayer(ModelLayers.PLAYER)), 0.7f);
