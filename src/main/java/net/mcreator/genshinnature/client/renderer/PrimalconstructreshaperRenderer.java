...
public class PrimalconstructreshaperRenderer extends HumanoidMobRenderer<PrimalconstructreshaperEntity, HumanoidModel<PrimalconstructreshaperEntity>> {
	public PrimalconstructreshaperRenderer(EntityRendererProvider.Context context) {
		super(context, new HumanoidModel<PrimalconstructreshaperEntity>(context.bakeLayer(ModelLayers.PLAYER)), 0.7f);
		this.addLayer(new HumanoidArmorLayer(this, new HumanoidModel(context.bakeLayer(ModelLayers.PLAYER_INNER_ARMOR)), new HumanoidModel(context.bakeLayer(ModelLayers.PLAYER_OUTER_ARMOR)), context.getModelManager()));
		this.addLayer(new RenderLayer<PrimalconstructreshaperEntity, HumanoidModel<PrimalconstructreshaperEntity>>(this) {
