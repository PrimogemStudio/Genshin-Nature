...
public class ElectroslimeRenderer extends HumanoidMobRenderer<ElectroslimeEntity, HumanoidModel<ElectroslimeEntity>> {
	public ElectroslimeRenderer(EntityRendererProvider.Context context) {
		super(context, new HumanoidModel<ElectroslimeEntity>(context.bakeLayer(ModelLayers.PLAYER)), 0.5f);
		this.addLayer(new HumanoidArmorLayer(this, new HumanoidModel(context.bakeLayer(ModelLayers.PLAYER_INNER_ARMOR)), new HumanoidModel(context.bakeLayer(ModelLayers.PLAYER_OUTER_ARMOR)), context.getModelManager()));
		this.addLayer(new RenderLayer<ElectroslimeEntity, HumanoidModel<ElectroslimeEntity>>(this) {
