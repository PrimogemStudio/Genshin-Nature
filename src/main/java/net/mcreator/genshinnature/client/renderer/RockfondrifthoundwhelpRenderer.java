...
public class RockfondrifthoundwhelpRenderer extends HumanoidMobRenderer<RockfondrifthoundwhelpEntity, HumanoidModel<RockfondrifthoundwhelpEntity>> {
	public RockfondrifthoundwhelpRenderer(EntityRendererProvider.Context context) {
		super(context, new HumanoidModel<RockfondrifthoundwhelpEntity>(context.bakeLayer(ModelLayers.PLAYER)), 1f);
		this.addLayer(new HumanoidArmorLayer(this, new HumanoidModel(context.bakeLayer(ModelLayers.PLAYER_INNER_ARMOR)), new HumanoidModel(context.bakeLayer(ModelLayers.PLAYER_OUTER_ARMOR)), context.getModelManager()));
		this.addLayer(new RenderLayer<RockfondrifthoundwhelpEntity, HumanoidModel<RockfondrifthoundwhelpEntity>>(this) {
