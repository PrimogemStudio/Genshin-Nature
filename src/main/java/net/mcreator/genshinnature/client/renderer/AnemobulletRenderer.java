...
public class AnemobulletRenderer extends HumanoidMobRenderer<AnemobulletEntity, HumanoidModel<AnemobulletEntity>> {
	public AnemobulletRenderer(EntityRendererProvider.Context context) {
		super(context, new HumanoidModel<AnemobulletEntity>(context.bakeLayer(ModelLayers.PLAYER)), 0.5f);
