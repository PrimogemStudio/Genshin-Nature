...
public class PeachofthedeepwavesspawningRenderer extends HumanoidMobRenderer<PeachofthedeepwavesspawningEntity, HumanoidModel<PeachofthedeepwavesspawningEntity>> {
	public PeachofthedeepwavesspawningRenderer(EntityRendererProvider.Context context) {
		super(context, new HumanoidModel<PeachofthedeepwavesspawningEntity>(context.bakeLayer(ModelLayers.PLAYER)), 0.7f);
