...
public class RockfondrifthoundRenderer extends HumanoidMobRenderer<RockfondrifthoundEntity, HumanoidModel<RockfondrifthoundEntity>> {
	public RockfondrifthoundRenderer(EntityRendererProvider.Context context) {
		super(context, new HumanoidModel<RockfondrifthoundEntity>(context.bakeLayer(ModelLayers.PLAYER)), 1f);
		this.addLayer(new HumanoidArmorLayer(this, new HumanoidModel(context.bakeLayer(ModelLayers.PLAYER_INNER_ARMOR)), new HumanoidModel(context.bakeLayer(ModelLayers.PLAYER_OUTER_ARMOR)), context.getModelManager()));
		this.addLayer(new RenderLayer<RockfondrifthoundEntity, HumanoidModel<RockfondrifthoundEntity>>(this) {
