...
public class WaterminionboarRenderer extends HumanoidMobRenderer<WaterminionboarEntity, HumanoidModel<WaterminionboarEntity>> {
	public WaterminionboarRenderer(EntityRendererProvider.Context context) {
		super(context, new HumanoidModel<WaterminionboarEntity>(context.bakeLayer(ModelLayers.PLAYER)), 0.5f);
