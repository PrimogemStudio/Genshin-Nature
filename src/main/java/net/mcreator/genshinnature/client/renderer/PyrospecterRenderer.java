...
public class PyrospecterRenderer extends HumanoidMobRenderer<PyrospecterEntity, HumanoidModel<PyrospecterEntity>> {
	public PyrospecterRenderer(EntityRendererProvider.Context context) {
		super(context, new HumanoidModel<PyrospecterEntity>(context.bakeLayer(ModelLayers.PLAYER)), 0.5f);
		this.addLayer(new HumanoidArmorLayer(this, new HumanoidModel(context.bakeLayer(ModelLayers.PLAYER_INNER_ARMOR)), new HumanoidModel(context.bakeLayer(ModelLayers.PLAYER_OUTER_ARMOR)), context.getModelManager()));
		this.addLayer(new RenderLayer<PyrospecterEntity, HumanoidModel<PyrospecterEntity>>(this) {
