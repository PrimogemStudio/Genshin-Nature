...
public class RuinserpentRenderer extends HumanoidMobRenderer<RuinserpentEntity, HumanoidModel<RuinserpentEntity>> {
	public RuinserpentRenderer(EntityRendererProvider.Context context) {
		super(context, new HumanoidModel<RuinserpentEntity>(context.bakeLayer(ModelLayers.PLAYER)), 1.3f);
		this.addLayer(new HumanoidArmorLayer(this, new HumanoidModel(context.bakeLayer(ModelLayers.PLAYER_INNER_ARMOR)), new HumanoidModel(context.bakeLayer(ModelLayers.PLAYER_OUTER_ARMOR)), context.getModelManager()));
		this.addLayer(new RenderLayer<RuinserpentEntity, HumanoidModel<RuinserpentEntity>>(this) {
