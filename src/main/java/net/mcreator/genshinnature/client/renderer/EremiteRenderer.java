...
public class EremiteRenderer extends HumanoidMobRenderer<EremiteEntity, HumanoidModel<EremiteEntity>> {
	public EremiteRenderer(EntityRendererProvider.Context context) {
		super(context, new HumanoidModel<EremiteEntity>(context.bakeLayer(ModelLayers.PLAYER)), 0.5f);
