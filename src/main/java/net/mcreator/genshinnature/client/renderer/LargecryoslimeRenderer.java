...
public class LargecryoslimeRenderer extends HumanoidMobRenderer<LargecryoslimeEntity, HumanoidModel<LargecryoslimeEntity>> {
	public LargecryoslimeRenderer(EntityRendererProvider.Context context) {
		super(context, new HumanoidModel<LargecryoslimeEntity>(context.bakeLayer(ModelLayers.PLAYER)), 1f);
