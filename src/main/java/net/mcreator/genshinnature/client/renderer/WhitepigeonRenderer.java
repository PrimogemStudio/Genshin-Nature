...
public class WhitepigeonRenderer extends HumanoidMobRenderer<WhitepigeonEntity, HumanoidModel<WhitepigeonEntity>> {
	public WhitepigeonRenderer(EntityRendererProvider.Context context) {
		super(context, new HumanoidModel<WhitepigeonEntity>(context.bakeLayer(ModelLayers.PLAYER)), 0.6f);
