...
public class SnowstriderspawningRenderer extends HumanoidMobRenderer<SnowstriderspawningEntity, HumanoidModel<SnowstriderspawningEntity>> {
	public SnowstriderspawningRenderer(EntityRendererProvider.Context context) {
		super(context, new HumanoidModel<SnowstriderspawningEntity>(context.bakeLayer(ModelLayers.PLAYER)), 1.2f);
