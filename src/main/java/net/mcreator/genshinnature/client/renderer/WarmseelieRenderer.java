...
public class WarmseelieRenderer extends HumanoidMobRenderer<WarmseelieEntity, HumanoidModel<WarmseelieEntity>> {
	public WarmseelieRenderer(EntityRendererProvider.Context context) {
		super(context, new HumanoidModel<WarmseelieEntity>(context.bakeLayer(ModelLayers.PLAYER)), 0.5f);
