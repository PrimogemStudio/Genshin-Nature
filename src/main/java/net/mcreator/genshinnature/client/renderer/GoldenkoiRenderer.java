...
public class GoldenkoiRenderer extends HumanoidMobRenderer<GoldenkoiEntity, HumanoidModel<GoldenkoiEntity>> {
	public GoldenkoiRenderer(EntityRendererProvider.Context context) {
		super(context, new HumanoidModel<GoldenkoiEntity>(context.bakeLayer(ModelLayers.PLAYER)), 0.6f);
