...
public class ScorpionRenderer extends HumanoidMobRenderer<ScorpionEntity, HumanoidModel<ScorpionEntity>> {
	public ScorpionRenderer(EntityRendererProvider.Context context) {
		super(context, new HumanoidModel<ScorpionEntity>(context.bakeLayer(ModelLayers.PLAYER)), 0.5f);
