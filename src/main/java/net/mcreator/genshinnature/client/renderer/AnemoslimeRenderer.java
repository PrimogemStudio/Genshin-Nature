...
public class AnemoslimeRenderer extends HumanoidMobRenderer<AnemoslimeEntity, HumanoidModel<AnemoslimeEntity>> {
	public AnemoslimeRenderer(EntityRendererProvider.Context context) {
		super(context, new HumanoidModel<AnemoslimeEntity>(context.bakeLayer(ModelLayers.PLAYER)), 0.5f);
