...
public class Anemohypostasisphase5Renderer extends MobRenderer<Anemohypostasisphase5Entity, Modelanemo_hypostasis_missiles<Anemohypostasisphase5Entity>> {
	public Anemohypostasisphase5Renderer(EntityRendererProvider.Context context) {
		super(context, new Modelanemo_hypostasis_missiles<Anemohypostasisphase5Entity>(context.bakeLayer(Modelanemo_hypostasis_missiles.LAYER_LOCATION)), 1f);
		this.addLayer(new RenderLayer<Anemohypostasisphase5Entity, Modelanemo_hypostasis_missiles<Anemohypostasisphase5Entity>>(this) {
