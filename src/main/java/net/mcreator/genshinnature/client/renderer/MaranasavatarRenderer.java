...
public class MaranasavatarRenderer extends HumanoidMobRenderer<MaranasavatarEntity, HumanoidModel<MaranasavatarEntity>> {
	public MaranasavatarRenderer(EntityRendererProvider.Context context) {
		super(context, new HumanoidModel<MaranasavatarEntity>(context.bakeLayer(ModelLayers.PLAYER)), 1.3f);
