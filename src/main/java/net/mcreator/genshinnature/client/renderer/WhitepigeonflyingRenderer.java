...
public class WhitepigeonflyingRenderer extends HumanoidMobRenderer<WhitepigeonflyingEntity, HumanoidModel<WhitepigeonflyingEntity>> {
	public WhitepigeonflyingRenderer(EntityRendererProvider.Context context) {
		super(context, new HumanoidModel<WhitepigeonflyingEntity>(context.bakeLayer(ModelLayers.PLAYER)), 0.6f);
