...
public class Pyrohypostasisphase5Renderer extends HumanoidMobRenderer<Pyrohypostasisphase5Entity, HumanoidModel<Pyrohypostasisphase5Entity>> {
	public Pyrohypostasisphase5Renderer(EntityRendererProvider.Context context) {
		super(context, new HumanoidModel<Pyrohypostasisphase5Entity>(context.bakeLayer(ModelLayers.PLAYER)), 1.5f);
		this.addLayer(new HumanoidArmorLayer(this, new HumanoidModel(context.bakeLayer(ModelLayers.PLAYER_INNER_ARMOR)), new HumanoidModel(context.bakeLayer(ModelLayers.PLAYER_OUTER_ARMOR)), context.getModelManager()));
		this.addLayer(new RenderLayer<Pyrohypostasisphase5Entity, HumanoidModel<Pyrohypostasisphase5Entity>>(this) {
