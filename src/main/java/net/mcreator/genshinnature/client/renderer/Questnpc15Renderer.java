...
public class Questnpc15Renderer extends HumanoidMobRenderer<Questnpc15Entity, HumanoidModel<Questnpc15Entity>> {
	public Questnpc15Renderer(EntityRendererProvider.Context context) {
		super(context, new HumanoidModel<Questnpc15Entity>(context.bakeLayer(ModelLayers.PLAYER)), 0.5f);
