...
public class AmateurweaselthiefscaredRenderer extends HumanoidMobRenderer<AmateurweaselthiefscaredEntity, HumanoidModel<AmateurweaselthiefscaredEntity>> {
	public AmateurweaselthiefscaredRenderer(EntityRendererProvider.Context context) {
		super(context, new HumanoidModel<AmateurweaselthiefscaredEntity>(context.bakeLayer(ModelLayers.PLAYER)), 0.5f);
