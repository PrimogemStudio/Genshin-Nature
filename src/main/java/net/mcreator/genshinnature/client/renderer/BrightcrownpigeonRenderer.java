...
public class BrightcrownpigeonRenderer extends HumanoidMobRenderer<BrightcrownpigeonEntity, HumanoidModel<BrightcrownpigeonEntity>> {
	public BrightcrownpigeonRenderer(EntityRendererProvider.Context context) {
		super(context, new HumanoidModel<BrightcrownpigeonEntity>(context.bakeLayer(ModelLayers.PLAYER)), 0.6f);
