...
public class VenomspinefishspawningRenderer extends HumanoidMobRenderer<VenomspinefishspawningEntity, HumanoidModel<VenomspinefishspawningEntity>> {
	public VenomspinefishspawningRenderer(EntityRendererProvider.Context context) {
		super(context, new HumanoidModel<VenomspinefishspawningEntity>(context.bakeLayer(ModelLayers.PLAYER)), 1.2f);
