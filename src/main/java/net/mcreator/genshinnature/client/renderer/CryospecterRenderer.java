...
public class CryospecterRenderer extends HumanoidMobRenderer<CryospecterEntity, HumanoidModel<CryospecterEntity>> {
	public CryospecterRenderer(EntityRendererProvider.Context context) {
		super(context, new HumanoidModel<CryospecterEntity>(context.bakeLayer(ModelLayers.PLAYER)), 0.5f);
		this.addLayer(new HumanoidArmorLayer(this, new HumanoidModel(context.bakeLayer(ModelLayers.PLAYER_INNER_ARMOR)), new HumanoidModel(context.bakeLayer(ModelLayers.PLAYER_OUTER_ARMOR)), context.getModelManager()));
		this.addLayer(new RenderLayer<CryospecterEntity, HumanoidModel<CryospecterEntity>>(this) {
