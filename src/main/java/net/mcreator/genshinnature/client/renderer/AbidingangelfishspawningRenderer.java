...
public class AbidingangelfishspawningRenderer extends HumanoidMobRenderer<AbidingangelfishspawningEntity, HumanoidModel<AbidingangelfishspawningEntity>> {
	public AbidingangelfishspawningRenderer(EntityRendererProvider.Context context) {
		super(context, new HumanoidModel<AbidingangelfishspawningEntity>(context.bakeLayer(ModelLayers.PLAYER)), 0.5f);
