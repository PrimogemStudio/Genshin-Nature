...
public class Electrohypostasisphase7Renderer extends MobRenderer<Electrohypostasisphase7Entity, Modelelectro_hypostasis_triangle<Electrohypostasisphase7Entity>> {
	public Electrohypostasisphase7Renderer(EntityRendererProvider.Context context) {
		super(context, new Modelelectro_hypostasis_triangle<Electrohypostasisphase7Entity>(context.bakeLayer(Modelelectro_hypostasis_triangle.LAYER_LOCATION)), 0.9f);
		this.addLayer(new RenderLayer<Electrohypostasisphase7Entity, Modelelectro_hypostasis_triangle<Electrohypostasisphase7Entity>>(this) {
