...
public class MiniseeliecurcumaRenderer extends HumanoidMobRenderer<MiniseeliecurcumaEntity, HumanoidModel<MiniseeliecurcumaEntity>> {
	public MiniseeliecurcumaRenderer(EntityRendererProvider.Context context) {
		super(context, new HumanoidModel<MiniseeliecurcumaEntity>(context.bakeLayer(ModelLayers.PLAYER)), 0.5f);
