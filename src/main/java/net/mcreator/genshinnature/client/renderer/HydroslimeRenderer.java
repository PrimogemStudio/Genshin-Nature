...
public class HydroslimeRenderer extends HumanoidMobRenderer<HydroslimeEntity, HumanoidModel<HydroslimeEntity>> {
	public HydroslimeRenderer(EntityRendererProvider.Context context) {
		super(context, new HumanoidModel<HydroslimeEntity>(context.bakeLayer(ModelLayers.PLAYER)), 0.5f);
