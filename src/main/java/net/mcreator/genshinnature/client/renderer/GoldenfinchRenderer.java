...
public class GoldenfinchRenderer extends HumanoidMobRenderer<GoldenfinchEntity, HumanoidModel<GoldenfinchEntity>> {
	public GoldenfinchRenderer(EntityRendererProvider.Context context) {
		super(context, new HumanoidModel<GoldenfinchEntity>(context.bakeLayer(ModelLayers.PLAYER)), 0.5f);
