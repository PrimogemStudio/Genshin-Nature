...
public class CryosamachurlRenderer extends HumanoidMobRenderer<CryosamachurlEntity, HumanoidModel<CryosamachurlEntity>> {
	public CryosamachurlRenderer(EntityRendererProvider.Context context) {
		super(context, new HumanoidModel<CryosamachurlEntity>(context.bakeLayer(ModelLayers.PLAYER)), 0.5f);
