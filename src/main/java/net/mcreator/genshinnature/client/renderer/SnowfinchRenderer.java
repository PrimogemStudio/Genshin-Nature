...
public class SnowfinchRenderer extends HumanoidMobRenderer<SnowfinchEntity, HumanoidModel<SnowfinchEntity>> {
	public SnowfinchRenderer(EntityRendererProvider.Context context) {
		super(context, new HumanoidModel<SnowfinchEntity>(context.bakeLayer(ModelLayers.PLAYER)), 0.5f);
