...
public class EmeraldfinchflyingRenderer extends HumanoidMobRenderer<EmeraldfinchflyingEntity, HumanoidModel<EmeraldfinchflyingEntity>> {
	public EmeraldfinchflyingRenderer(EntityRendererProvider.Context context) {
		super(context, new HumanoidModel<EmeraldfinchflyingEntity>(context.bakeLayer(ModelLayers.PLAYER)), 0.5f);
