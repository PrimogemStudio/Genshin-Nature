...
public class PithlizardRenderer extends HumanoidMobRenderer<PithlizardEntity, HumanoidModel<PithlizardEntity>> {
	public PithlizardRenderer(EntityRendererProvider.Context context) {
		super(context, new HumanoidModel<PithlizardEntity>(context.bakeLayer(ModelLayers.PLAYER)), 0.5f);
