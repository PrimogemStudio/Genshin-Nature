...
public class ThundercravenrifthoundwhelpRenderer extends HumanoidMobRenderer<ThundercravenrifthoundwhelpEntity, HumanoidModel<ThundercravenrifthoundwhelpEntity>> {
	public ThundercravenrifthoundwhelpRenderer(EntityRendererProvider.Context context) {
		super(context, new HumanoidModel<ThundercravenrifthoundwhelpEntity>(context.bakeLayer(ModelLayers.PLAYER)), 1f);
		this.addLayer(new HumanoidArmorLayer(this, new HumanoidModel(context.bakeLayer(ModelLayers.PLAYER_INNER_ARMOR)), new HumanoidModel(context.bakeLayer(ModelLayers.PLAYER_OUTER_ARMOR)), context.getModelManager()));
		this.addLayer(new RenderLayer<ThundercravenrifthoundwhelpEntity, HumanoidModel<ThundercravenrifthoundwhelpEntity>>(this) {
