...
public class MysteriousseeliesoulsandRenderer extends HumanoidMobRenderer<MysteriousseeliesoulsandEntity, HumanoidModel<MysteriousseeliesoulsandEntity>> {
	public MysteriousseeliesoulsandRenderer(EntityRendererProvider.Context context) {
		super(context, new HumanoidModel<MysteriousseeliesoulsandEntity>(context.bakeLayer(ModelLayers.PLAYER)), 0.5f);
