...
public class CryocicinRenderer extends HumanoidMobRenderer<CryocicinEntity, HumanoidModel<CryocicinEntity>> {
	public CryocicinRenderer(EntityRendererProvider.Context context) {
		super(context, new HumanoidModel<CryocicinEntity>(context.bakeLayer(ModelLayers.PLAYER)), 0.6f);
