...
public class ShaggysumpterbeastbabyRenderer extends HumanoidMobRenderer<ShaggysumpterbeastbabyEntity, HumanoidModel<ShaggysumpterbeastbabyEntity>> {
	public ShaggysumpterbeastbabyRenderer(EntityRendererProvider.Context context) {
		super(context, new HumanoidModel<ShaggysumpterbeastbabyEntity>(context.bakeLayer(ModelLayers.PLAYER)), 1.3f);
