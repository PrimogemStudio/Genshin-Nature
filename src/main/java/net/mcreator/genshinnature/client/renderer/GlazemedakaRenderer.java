...
public class GlazemedakaRenderer extends HumanoidMobRenderer<GlazemedakaEntity, HumanoidModel<GlazemedakaEntity>> {
	public GlazemedakaRenderer(EntityRendererProvider.Context context) {
		super(context, new HumanoidModel<GlazemedakaEntity>(context.bakeLayer(ModelLayers.PLAYER)), 0.6f);
