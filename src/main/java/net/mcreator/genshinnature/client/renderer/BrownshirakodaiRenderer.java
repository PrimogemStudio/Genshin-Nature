...
public class BrownshirakodaiRenderer extends HumanoidMobRenderer<BrownshirakodaiEntity, HumanoidModel<BrownshirakodaiEntity>> {
	public BrownshirakodaiRenderer(EntityRendererProvider.Context context) {
		super(context, new HumanoidModel<BrownshirakodaiEntity>(context.bakeLayer(ModelLayers.PLAYER)), 0.5f);
