...
public class WitheringtumorRenderer extends HumanoidMobRenderer<WitheringtumorEntity, HumanoidModel<WitheringtumorEntity>> {
	public WitheringtumorRenderer(EntityRendererProvider.Context context) {
		super(context, new HumanoidModel<WitheringtumorEntity>(context.bakeLayer(ModelLayers.PLAYER)), 0.5f);
