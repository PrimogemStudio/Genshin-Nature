...
public class ChildeRenderer extends HumanoidMobRenderer<ChildeEntity, HumanoidModel<ChildeEntity>> {
	public ChildeRenderer(EntityRendererProvider.Context context) {
		super(context, new HumanoidModel<ChildeEntity>(context.bakeLayer(ModelLayers.PLAYER)), 0.5f);
