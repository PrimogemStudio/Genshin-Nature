...
public class CrimsonflankpigeonflyingRenderer extends HumanoidMobRenderer<CrimsonflankpigeonflyingEntity, HumanoidModel<CrimsonflankpigeonflyingEntity>> {
	public CrimsonflankpigeonflyingRenderer(EntityRendererProvider.Context context) {
		super(context, new HumanoidModel<CrimsonflankpigeonflyingEntity>(context.bakeLayer(ModelLayers.PLAYER)), 0.6f);
