...
public class Questnpc9Renderer extends HumanoidMobRenderer<Questnpc9Entity, HumanoidModel<Questnpc9Entity>> {
	public Questnpc9Renderer(EntityRendererProvider.Context context) {
		super(context, new HumanoidModel<Questnpc9Entity>(context.bakeLayer(ModelLayers.PLAYER)), 0.5f);
