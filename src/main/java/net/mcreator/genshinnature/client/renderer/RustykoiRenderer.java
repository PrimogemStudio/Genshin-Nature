...
public class RustykoiRenderer extends HumanoidMobRenderer<RustykoiEntity, HumanoidModel<RustykoiEntity>> {
	public RustykoiRenderer(EntityRendererProvider.Context context) {
		super(context, new HumanoidModel<RustykoiEntity>(context.bakeLayer(ModelLayers.PLAYER)), 0.6f);
