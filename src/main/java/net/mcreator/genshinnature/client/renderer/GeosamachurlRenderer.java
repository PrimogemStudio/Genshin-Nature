...
public class GeosamachurlRenderer extends HumanoidMobRenderer<GeosamachurlEntity, HumanoidModel<GeosamachurlEntity>> {
	public GeosamachurlRenderer(EntityRendererProvider.Context context) {
		super(context, new HumanoidModel<GeosamachurlEntity>(context.bakeLayer(ModelLayers.PLAYER)), 0.5f);
