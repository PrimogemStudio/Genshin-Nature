...
public class CoralbutterflyRenderer extends HumanoidMobRenderer<CoralbutterflyEntity, HumanoidModel<CoralbutterflyEntity>> {
	public CoralbutterflyRenderer(EntityRendererProvider.Context context) {
		super(context, new HumanoidModel<CoralbutterflyEntity>(context.bakeLayer(ModelLayers.PLAYER)), 0.5f);
		this.addLayer(new HumanoidArmorLayer(this, new HumanoidModel(context.bakeLayer(ModelLayers.PLAYER_INNER_ARMOR)), new HumanoidModel(context.bakeLayer(ModelLayers.PLAYER_OUTER_ARMOR)), context.getModelManager()));
		this.addLayer(new RenderLayer<CoralbutterflyEntity, HumanoidModel<CoralbutterflyEntity>>(this) {
