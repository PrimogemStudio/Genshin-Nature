...
public class RuinscoutRenderer extends HumanoidMobRenderer<RuinscoutEntity, HumanoidModel<RuinscoutEntity>> {
	public RuinscoutRenderer(EntityRendererProvider.Context context) {
		super(context, new HumanoidModel<RuinscoutEntity>(context.bakeLayer(ModelLayers.PLAYER)), 2f);
