...
public class MysteriousseelieRenderer extends HumanoidMobRenderer<MysteriousseelieEntity, HumanoidModel<MysteriousseelieEntity>> {
	public MysteriousseelieRenderer(EntityRendererProvider.Context context) {
		super(context, new HumanoidModel<MysteriousseelieEntity>(context.bakeLayer(ModelLayers.PLAYER)), 0.5f);
