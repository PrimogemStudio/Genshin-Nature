...
public class MiniseelieviolaRenderer extends HumanoidMobRenderer<MiniseelieviolaEntity, HumanoidModel<MiniseelieviolaEntity>> {
	public MiniseelieviolaRenderer(EntityRendererProvider.Context context) {
		super(context, new HumanoidModel<MiniseelieviolaEntity>(context.bakeLayer(ModelLayers.PLAYER)), 0.5f);
