...
public class Geohypostasisphase2Renderer extends MobRenderer<Geohypostasisphase2Entity, Modelgeo_hypostasis_phase2<Geohypostasisphase2Entity>> {
	public Geohypostasisphase2Renderer(EntityRendererProvider.Context context) {
		super(context, new Modelgeo_hypostasis_phase2<Geohypostasisphase2Entity>(context.bakeLayer(Modelgeo_hypostasis_phase2.LAYER_LOCATION)), 0.4f);
		this.addLayer(new RenderLayer<Geohypostasisphase2Entity, Modelgeo_hypostasis_phase2<Geohypostasisphase2Entity>>(this) {
