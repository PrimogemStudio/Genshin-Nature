...
public class ElectroregisvineRenderer extends HumanoidMobRenderer<ElectroregisvineEntity, HumanoidModel<ElectroregisvineEntity>> {
	public ElectroregisvineRenderer(EntityRendererProvider.Context context) {
		super(context, new HumanoidModel<ElectroregisvineEntity>(context.bakeLayer(ModelLayers.PLAYER)), 3.5f);
