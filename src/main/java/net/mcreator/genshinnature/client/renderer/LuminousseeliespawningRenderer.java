...
public class LuminousseeliespawningRenderer extends HumanoidMobRenderer<LuminousseeliespawningEntity, HumanoidModel<LuminousseeliespawningEntity>> {
	public LuminousseeliespawningRenderer(EntityRendererProvider.Context context) {
		super(context, new HumanoidModel<LuminousseeliespawningEntity>(context.bakeLayer(ModelLayers.PLAYER)), 0.5f);
