...
public class BluebutterflyRenderer extends HumanoidMobRenderer<BluebutterflyEntity, HumanoidModel<BluebutterflyEntity>> {
	public BluebutterflyRenderer(EntityRendererProvider.Context context) {
		super(context, new HumanoidModel<BluebutterflyEntity>(context.bakeLayer(ModelLayers.PLAYER)), 0.5f);
