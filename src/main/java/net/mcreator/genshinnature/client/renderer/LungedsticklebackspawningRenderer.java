...
public class LungedsticklebackspawningRenderer extends HumanoidMobRenderer<LungedsticklebackspawningEntity, HumanoidModel<LungedsticklebackspawningEntity>> {
	public LungedsticklebackspawningRenderer(EntityRendererProvider.Context context) {
		super(context, new HumanoidModel<LungedsticklebackspawningEntity>(context.bakeLayer(ModelLayers.PLAYER)), 1.2f);
