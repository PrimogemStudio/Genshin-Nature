...
public class StretchypyrofungusRenderer extends HumanoidMobRenderer<StretchypyrofungusEntity, HumanoidModel<StretchypyrofungusEntity>> {
	public StretchypyrofungusRenderer(EntityRendererProvider.Context context) {
		super(context, new HumanoidModel<StretchypyrofungusEntity>(context.bakeLayer(ModelLayers.PLAYER)), 0.5f);
