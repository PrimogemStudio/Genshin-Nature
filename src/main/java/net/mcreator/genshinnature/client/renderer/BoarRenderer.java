...
public class BoarRenderer extends HumanoidMobRenderer<BoarEntity, HumanoidModel<BoarEntity>> {
	public BoarRenderer(EntityRendererProvider.Context context) {
		super(context, new HumanoidModel<BoarEntity>(context.bakeLayer(ModelLayers.PLAYER)), 0.5f);
