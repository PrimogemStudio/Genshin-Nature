...
public class Pyrohypostasisphase7Renderer extends MobRenderer<Pyrohypostasisphase7Entity, Modelpyro_hypostasis_missiles<Pyrohypostasisphase7Entity>> {
	public Pyrohypostasisphase7Renderer(EntityRendererProvider.Context context) {
		super(context, new Modelpyro_hypostasis_missiles<Pyrohypostasisphase7Entity>(context.bakeLayer(Modelpyro_hypostasis_missiles.LAYER_LOCATION)), 0.5f);
		this.addLayer(new RenderLayer<Pyrohypostasisphase7Entity, Modelpyro_hypostasis_missiles<Pyrohypostasisphase7Entity>>(this) {
