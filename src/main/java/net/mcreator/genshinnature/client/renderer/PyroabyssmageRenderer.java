...
public class PyroabyssmageRenderer extends HumanoidMobRenderer<PyroabyssmageEntity, HumanoidModel<PyroabyssmageEntity>> {
	public PyroabyssmageRenderer(EntityRendererProvider.Context context) {
		super(context, new HumanoidModel<PyroabyssmageEntity>(context.bakeLayer(ModelLayers.PLAYER)), 2.7f);
		this.addLayer(new HumanoidArmorLayer(this, new HumanoidModel(context.bakeLayer(ModelLayers.PLAYER_INNER_ARMOR)), new HumanoidModel(context.bakeLayer(ModelLayers.PLAYER_OUTER_ARMOR)), context.getModelManager()));
		this.addLayer(new RenderLayer<PyroabyssmageEntity, HumanoidModel<PyroabyssmageEntity>>(this) {
