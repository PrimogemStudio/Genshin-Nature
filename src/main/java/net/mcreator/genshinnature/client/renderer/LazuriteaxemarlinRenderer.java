...
public class LazuriteaxemarlinRenderer extends HumanoidMobRenderer<LazuriteaxemarlinEntity, HumanoidModel<LazuriteaxemarlinEntity>> {
	public LazuriteaxemarlinRenderer(EntityRendererProvider.Context context) {
		super(context, new HumanoidModel<LazuriteaxemarlinEntity>(context.bakeLayer(ModelLayers.PLAYER)), 0.5f);
