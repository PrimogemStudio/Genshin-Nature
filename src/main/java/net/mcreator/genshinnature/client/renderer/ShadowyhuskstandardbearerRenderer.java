...
public class ShadowyhuskstandardbearerRenderer extends HumanoidMobRenderer<ShadowyhuskstandardbearerEntity, HumanoidModel<ShadowyhuskstandardbearerEntity>> {
	public ShadowyhuskstandardbearerRenderer(EntityRendererProvider.Context context) {
		super(context, new HumanoidModel<ShadowyhuskstandardbearerEntity>(context.bakeLayer(ModelLayers.PLAYER)), 1f);
