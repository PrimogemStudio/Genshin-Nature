...
public class Questnpc13Renderer extends HumanoidMobRenderer<Questnpc13Entity, HumanoidModel<Questnpc13Entity>> {
	public Questnpc13Renderer(EntityRendererProvider.Context context) {
		super(context, new HumanoidModel<Questnpc13Entity>(context.bakeLayer(ModelLayers.PLAYER)), 0.5f);
