...
public class AizenmedakaspawningRenderer extends HumanoidMobRenderer<AizenmedakaspawningEntity, HumanoidModel<AizenmedakaspawningEntity>> {
	public AizenmedakaspawningRenderer(EntityRendererProvider.Context context) {
		super(context, new HumanoidModel<AizenmedakaspawningEntity>(context.bakeLayer(ModelLayers.PLAYER)), 0.6f);
