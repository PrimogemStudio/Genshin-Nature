...
public class DendroslimeRenderer extends HumanoidMobRenderer<DendroslimeEntity, HumanoidModel<DendroslimeEntity>> {
	public DendroslimeRenderer(EntityRendererProvider.Context context) {
		super(context, new HumanoidModel<DendroslimeEntity>(context.bakeLayer(ModelLayers.PLAYER)), 0.5f);
