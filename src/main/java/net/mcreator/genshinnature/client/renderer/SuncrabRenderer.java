...
public class SuncrabRenderer extends HumanoidMobRenderer<SuncrabEntity, HumanoidModel<SuncrabEntity>> {
	public SuncrabRenderer(EntityRendererProvider.Context context) {
		super(context, new HumanoidModel<SuncrabEntity>(context.bakeLayer(ModelLayers.PLAYER)), 0.6f);
