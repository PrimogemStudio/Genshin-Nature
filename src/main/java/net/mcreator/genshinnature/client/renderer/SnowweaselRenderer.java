...
public class SnowweaselRenderer extends HumanoidMobRenderer<SnowweaselEntity, HumanoidModel<SnowweaselEntity>> {
	public SnowweaselRenderer(EntityRendererProvider.Context context) {
		super(context, new HumanoidModel<SnowweaselEntity>(context.bakeLayer(ModelLayers.PLAYER)), 0.5f);
