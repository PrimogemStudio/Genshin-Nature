...
public class ElectrocicinRenderer extends HumanoidMobRenderer<ElectrocicinEntity, HumanoidModel<ElectrocicinEntity>> {
	public ElectrocicinRenderer(EntityRendererProvider.Context context) {
		super(context, new HumanoidModel<ElectrocicinEntity>(context.bakeLayer(ModelLayers.PLAYER)), 0.6f);
		this.addLayer(new HumanoidArmorLayer(this, new HumanoidModel(context.bakeLayer(ModelLayers.PLAYER_INNER_ARMOR)), new HumanoidModel(context.bakeLayer(ModelLayers.PLAYER_OUTER_ARMOR)), context.getModelManager()));
		this.addLayer(new RenderLayer<ElectrocicinEntity, HumanoidModel<ElectrocicinEntity>>(this) {
