...
public class RuindrakeearthwatchRenderer extends HumanoidMobRenderer<RuindrakeearthwatchEntity, HumanoidModel<RuindrakeearthwatchEntity>> {
	public RuindrakeearthwatchRenderer(EntityRendererProvider.Context context) {
		super(context, new HumanoidModel<RuindrakeearthwatchEntity>(context.bakeLayer(ModelLayers.PLAYER)), 2f);
