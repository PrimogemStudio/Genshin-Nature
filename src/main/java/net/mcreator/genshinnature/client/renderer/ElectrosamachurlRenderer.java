...
public class ElectrosamachurlRenderer extends HumanoidMobRenderer<ElectrosamachurlEntity, HumanoidModel<ElectrosamachurlEntity>> {
	public ElectrosamachurlRenderer(EntityRendererProvider.Context context) {
		super(context, new HumanoidModel<ElectrosamachurlEntity>(context.bakeLayer(ModelLayers.PLAYER)), 0.5f);
