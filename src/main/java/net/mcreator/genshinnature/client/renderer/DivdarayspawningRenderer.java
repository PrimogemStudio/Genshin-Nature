...
public class DivdarayspawningRenderer extends HumanoidMobRenderer<DivdarayspawningEntity, HumanoidModel<DivdarayspawningEntity>> {
	public DivdarayspawningRenderer(EntityRendererProvider.Context context) {
		super(context, new HumanoidModel<DivdarayspawningEntity>(context.bakeLayer(ModelLayers.PLAYER)), 1.2f);
