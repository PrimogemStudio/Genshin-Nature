...
public class DendrobulletRenderer extends HumanoidMobRenderer<DendrobulletEntity, HumanoidModel<DendrobulletEntity>> {
	public DendrobulletRenderer(EntityRendererProvider.Context context) {
		super(context, new HumanoidModel<DendrobulletEntity>(context.bakeLayer(ModelLayers.PLAYER)), 0.5f);
		this.addLayer(new HumanoidArmorLayer(this, new HumanoidModel(context.bakeLayer(ModelLayers.PLAYER_INNER_ARMOR)), new HumanoidModel(context.bakeLayer(ModelLayers.PLAYER_OUTER_ARMOR)), context.getModelManager()));
		this.addLayer(new RenderLayer<DendrobulletEntity, HumanoidModel<DendrobulletEntity>>(this) {
