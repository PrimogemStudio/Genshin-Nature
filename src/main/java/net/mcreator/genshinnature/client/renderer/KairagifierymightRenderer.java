...
public class KairagifierymightRenderer extends HumanoidMobRenderer<KairagifierymightEntity, HumanoidModel<KairagifierymightEntity>> {
	public KairagifierymightRenderer(EntityRendererProvider.Context context) {
		super(context, new HumanoidModel<KairagifierymightEntity>(context.bakeLayer(ModelLayers.PLAYER)), 0.5f);
