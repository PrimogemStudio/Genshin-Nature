...
public class HiddendendroslimeRenderer extends HumanoidMobRenderer<HiddendendroslimeEntity, HumanoidModel<HiddendendroslimeEntity>> {
	public HiddendendroslimeRenderer(EntityRendererProvider.Context context) {
		super(context, new HumanoidModel<HiddendendroslimeEntity>(context.bakeLayer(ModelLayers.PLAYER)), 0.5f);
