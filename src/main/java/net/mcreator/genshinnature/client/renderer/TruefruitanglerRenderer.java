...
public class TruefruitanglerRenderer extends HumanoidMobRenderer<TruefruitanglerEntity, HumanoidModel<TruefruitanglerEntity>> {
	public TruefruitanglerRenderer(EntityRendererProvider.Context context) {
		super(context, new HumanoidModel<TruefruitanglerEntity>(context.bakeLayer(ModelLayers.PLAYER)), 0.7f);
