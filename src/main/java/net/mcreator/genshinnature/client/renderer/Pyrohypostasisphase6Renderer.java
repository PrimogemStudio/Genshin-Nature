...
public class Pyrohypostasisphase6Renderer extends MobRenderer<Pyrohypostasisphase6Entity, Modelpyro_hypostasis_tornado<Pyrohypostasisphase6Entity>> {
	public Pyrohypostasisphase6Renderer(EntityRendererProvider.Context context) {
		super(context, new Modelpyro_hypostasis_tornado<Pyrohypostasisphase6Entity>(context.bakeLayer(Modelpyro_hypostasis_tornado.LAYER_LOCATION)), 1.3f);
		this.addLayer(new RenderLayer<Pyrohypostasisphase6Entity, Modelpyro_hypostasis_tornado<Pyrohypostasisphase6Entity>>(this) {
