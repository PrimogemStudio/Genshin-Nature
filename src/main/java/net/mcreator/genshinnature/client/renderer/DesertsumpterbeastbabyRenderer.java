...
public class DesertsumpterbeastbabyRenderer extends HumanoidMobRenderer<DesertsumpterbeastbabyEntity, HumanoidModel<DesertsumpterbeastbabyEntity>> {
	public DesertsumpterbeastbabyRenderer(EntityRendererProvider.Context context) {
		super(context, new HumanoidModel<DesertsumpterbeastbabyEntity>(context.bakeLayer(ModelLayers.PLAYER)), 1.3f);
