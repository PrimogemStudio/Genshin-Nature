...
public class RuinhunterarmRenderer extends HumanoidMobRenderer<RuinhunterarmEntity, HumanoidModel<RuinhunterarmEntity>> {
	public RuinhunterarmRenderer(EntityRendererProvider.Context context) {
		super(context, new HumanoidModel<RuinhunterarmEntity>(context.bakeLayer(ModelLayers.PLAYER)), 0.5f);
