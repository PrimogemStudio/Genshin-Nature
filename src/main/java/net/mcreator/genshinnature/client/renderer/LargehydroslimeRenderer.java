...
public class LargehydroslimeRenderer extends HumanoidMobRenderer<LargehydroslimeEntity, HumanoidModel<LargehydroslimeEntity>> {
	public LargehydroslimeRenderer(EntityRendererProvider.Context context) {
		super(context, new HumanoidModel<LargehydroslimeEntity>(context.bakeLayer(ModelLayers.PLAYER)), 1f);
