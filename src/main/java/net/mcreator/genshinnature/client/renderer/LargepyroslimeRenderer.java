...
public class LargepyroslimeRenderer extends HumanoidMobRenderer<LargepyroslimeEntity, HumanoidModel<LargepyroslimeEntity>> {
	public LargepyroslimeRenderer(EntityRendererProvider.Context context) {
		super(context, new HumanoidModel<LargepyroslimeEntity>(context.bakeLayer(ModelLayers.PLAYER)), 1f);
		this.addLayer(new HumanoidArmorLayer(this, new HumanoidModel(context.bakeLayer(ModelLayers.PLAYER_INNER_ARMOR)), new HumanoidModel(context.bakeLayer(ModelLayers.PLAYER_OUTER_ARMOR)), context.getModelManager()));
		this.addLayer(new RenderLayer<LargepyroslimeEntity, HumanoidModel<LargepyroslimeEntity>>(this) {
