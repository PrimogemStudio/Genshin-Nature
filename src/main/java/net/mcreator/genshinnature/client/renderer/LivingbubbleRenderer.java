...
public class LivingbubbleRenderer extends HumanoidMobRenderer<LivingbubbleEntity, HumanoidModel<LivingbubbleEntity>> {
	public LivingbubbleRenderer(EntityRendererProvider.Context context) {
		super(context, new HumanoidModel<LivingbubbleEntity>(context.bakeLayer(ModelLayers.PLAYER)), 0.7f);
