...
public class LuminousseelieRenderer extends HumanoidMobRenderer<LuminousseelieEntity, HumanoidModel<LuminousseelieEntity>> {
	public LuminousseelieRenderer(EntityRendererProvider.Context context) {
		super(context, new HumanoidModel<LuminousseelieEntity>(context.bakeLayer(ModelLayers.PLAYER)), 0.5f);
		this.addLayer(new HumanoidArmorLayer(this, new HumanoidModel(context.bakeLayer(ModelLayers.PLAYER_INNER_ARMOR)), new HumanoidModel(context.bakeLayer(ModelLayers.PLAYER_OUTER_ARMOR)), context.getModelManager()));
		this.addLayer(new RenderLayer<LuminousseelieEntity, HumanoidModel<LuminousseelieEntity>>(this) {
