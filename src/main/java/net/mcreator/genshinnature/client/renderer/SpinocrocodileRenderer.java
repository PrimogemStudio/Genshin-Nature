...
public class SpinocrocodileRenderer extends HumanoidMobRenderer<SpinocrocodileEntity, HumanoidModel<SpinocrocodileEntity>> {
	public SpinocrocodileRenderer(EntityRendererProvider.Context context) {
		super(context, new HumanoidModel<SpinocrocodileEntity>(context.bakeLayer(ModelLayers.PLAYER)), 1f);
