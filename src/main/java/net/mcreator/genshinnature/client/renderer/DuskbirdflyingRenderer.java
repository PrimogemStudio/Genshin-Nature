...
public class DuskbirdflyingRenderer extends HumanoidMobRenderer<DuskbirdflyingEntity, HumanoidModel<DuskbirdflyingEntity>> {
	public DuskbirdflyingRenderer(EntityRendererProvider.Context context) {
		super(context, new HumanoidModel<DuskbirdflyingEntity>(context.bakeLayer(ModelLayers.PLAYER)), 0.7f);
