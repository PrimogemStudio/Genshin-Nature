...
public class AdornedunagiRenderer extends HumanoidMobRenderer<AdornedunagiEntity, HumanoidModel<AdornedunagiEntity>> {
	public AdornedunagiRenderer(EntityRendererProvider.Context context) {
		super(context, new HumanoidModel<AdornedunagiEntity>(context.bakeLayer(ModelLayers.PLAYER)), 0.5f);
