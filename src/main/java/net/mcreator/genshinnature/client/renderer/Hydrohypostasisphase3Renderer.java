...
public class Hydrohypostasisphase3Renderer extends HumanoidMobRenderer<Hydrohypostasisphase3Entity, HumanoidModel<Hydrohypostasisphase3Entity>> {
	public Hydrohypostasisphase3Renderer(EntityRendererProvider.Context context) {
		super(context, new HumanoidModel<Hydrohypostasisphase3Entity>(context.bakeLayer(ModelLayers.PLAYER)), 0.5f);
