...
public class Hydrohypostasisphase6Renderer extends HumanoidMobRenderer<Hydrohypostasisphase6Entity, HumanoidModel<Hydrohypostasisphase6Entity>> {
	public Hydrohypostasisphase6Renderer(EntityRendererProvider.Context context) {
		super(context, new HumanoidModel<Hydrohypostasisphase6Entity>(context.bakeLayer(ModelLayers.PLAYER)), 0.5f);
