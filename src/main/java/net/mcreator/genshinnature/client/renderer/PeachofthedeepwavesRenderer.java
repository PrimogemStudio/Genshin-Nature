...
public class PeachofthedeepwavesRenderer extends HumanoidMobRenderer<PeachofthedeepwavesEntity, HumanoidModel<PeachofthedeepwavesEntity>> {
	public PeachofthedeepwavesRenderer(EntityRendererProvider.Context context) {
		super(context, new HumanoidModel<PeachofthedeepwavesEntity>(context.bakeLayer(ModelLayers.PLAYER)), 0.7f);
