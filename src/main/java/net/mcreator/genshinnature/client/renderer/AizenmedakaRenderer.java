...
public class AizenmedakaRenderer extends HumanoidMobRenderer<AizenmedakaEntity, HumanoidModel<AizenmedakaEntity>> {
	public AizenmedakaRenderer(EntityRendererProvider.Context context) {
		super(context, new HumanoidModel<AizenmedakaEntity>(context.bakeLayer(ModelLayers.PLAYER)), 0.6f);
