...
public class ElectroabyssmageRenderer extends MobRenderer<ElectroabyssmageEntity, Modelabyssmage_shielded<ElectroabyssmageEntity>> {
	public ElectroabyssmageRenderer(EntityRendererProvider.Context context) {
		super(context, new Modelabyssmage_shielded<ElectroabyssmageEntity>(context.bakeLayer(Modelabyssmage_shielded.LAYER_LOCATION)), 2.7f);
		this.addLayer(new RenderLayer<ElectroabyssmageEntity, Modelabyssmage_shielded<ElectroabyssmageEntity>>(this) {
