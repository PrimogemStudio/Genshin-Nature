...
public class OchimusacankeredflameRenderer extends HumanoidMobRenderer<OchimusacankeredflameEntity, HumanoidModel<OchimusacankeredflameEntity>> {
	public OchimusacankeredflameRenderer(EntityRendererProvider.Context context) {
		super(context, new HumanoidModel<OchimusacankeredflameEntity>(context.bakeLayer(ModelLayers.PLAYER)), 0.5f);
		this.addLayer(new HumanoidArmorLayer(this, new HumanoidModel(context.bakeLayer(ModelLayers.PLAYER_INNER_ARMOR)), new HumanoidModel(context.bakeLayer(ModelLayers.PLAYER_OUTER_ARMOR)), context.getModelManager()));
		this.addLayer(new RenderLayer<OchimusacankeredflameEntity, HumanoidModel<OchimusacankeredflameEntity>>(this) {
