...
public class SacredibisRenderer extends HumanoidMobRenderer<SacredibisEntity, HumanoidModel<SacredibisEntity>> {
	public SacredibisRenderer(EntityRendererProvider.Context context) {
		super(context, new HumanoidModel<SacredibisEntity>(context.bakeLayer(ModelLayers.PLAYER)), 1f);
