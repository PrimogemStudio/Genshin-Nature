...
public class SnowboarRenderer extends HumanoidMobRenderer<SnowboarEntity, HumanoidModel<SnowboarEntity>> {
	public SnowboarRenderer(EntityRendererProvider.Context context) {
		super(context, new HumanoidModel<SnowboarEntity>(context.bakeLayer(ModelLayers.PLAYER)), 0.5f);
