...
public class TeacoloredshirakodaispawningRenderer extends HumanoidMobRenderer<TeacoloredshirakodaispawningEntity, HumanoidModel<TeacoloredshirakodaispawningEntity>> {
	public TeacoloredshirakodaispawningRenderer(EntityRendererProvider.Context context) {
		super(context, new HumanoidModel<TeacoloredshirakodaispawningEntity>(context.bakeLayer(ModelLayers.PLAYER)), 0.5f);
