...
public class LapisgledeRenderer extends HumanoidMobRenderer<LapisgledeEntity, HumanoidModel<LapisgledeEntity>> {
	public LapisgledeRenderer(EntityRendererProvider.Context context) {
		super(context, new HumanoidModel<LapisgledeEntity>(context.bakeLayer(ModelLayers.PLAYER)), 0.7f);
