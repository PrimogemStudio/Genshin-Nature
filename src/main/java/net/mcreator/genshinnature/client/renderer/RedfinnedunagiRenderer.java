...
public class RedfinnedunagiRenderer extends HumanoidMobRenderer<RedfinnedunagiEntity, HumanoidModel<RedfinnedunagiEntity>> {
	public RedfinnedunagiRenderer(EntityRendererProvider.Context context) {
		super(context, new HumanoidModel<RedfinnedunagiEntity>(context.bakeLayer(ModelLayers.PLAYER)), 0.5f);
