...
public class Questnpc11Renderer extends HumanoidMobRenderer<Questnpc11Entity, HumanoidModel<Questnpc11Entity>> {
	public Questnpc11Renderer(EntityRendererProvider.Context context) {
		super(context, new HumanoidModel<Questnpc11Entity>(context.bakeLayer(ModelLayers.PLAYER)), 0.5f);
