...
public class BrownshirakodaispawningRenderer extends HumanoidMobRenderer<BrownshirakodaispawningEntity, HumanoidModel<BrownshirakodaispawningEntity>> {
	public BrownshirakodaispawningRenderer(EntityRendererProvider.Context context) {
		super(context, new HumanoidModel<BrownshirakodaispawningEntity>(context.bakeLayer(ModelLayers.PLAYER)), 0.5f);
