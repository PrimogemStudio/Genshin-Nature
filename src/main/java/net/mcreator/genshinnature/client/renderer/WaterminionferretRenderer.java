...
public class WaterminionferretRenderer extends HumanoidMobRenderer<WaterminionferretEntity, HumanoidModel<WaterminionferretEntity>> {
	public WaterminionferretRenderer(EntityRendererProvider.Context context) {
		super(context, new HumanoidModel<WaterminionferretEntity>(context.bakeLayer(ModelLayers.PLAYER)), 0.5f);
