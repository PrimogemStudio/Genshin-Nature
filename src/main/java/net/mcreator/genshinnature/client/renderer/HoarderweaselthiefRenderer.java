...
public class HoarderweaselthiefRenderer extends HumanoidMobRenderer<HoarderweaselthiefEntity, HumanoidModel<HoarderweaselthiefEntity>> {
	public HoarderweaselthiefRenderer(EntityRendererProvider.Context context) {
		super(context, new HumanoidModel<HoarderweaselthiefEntity>(context.bakeLayer(ModelLayers.PLAYER)), 0.5f);
