...
public class EmeraldfinchRenderer extends HumanoidMobRenderer<EmeraldfinchEntity, HumanoidModel<EmeraldfinchEntity>> {
	public EmeraldfinchRenderer(EntityRendererProvider.Context context) {
		super(context, new HumanoidModel<EmeraldfinchEntity>(context.bakeLayer(ModelLayers.PLAYER)), 0.5f);
