...
public class HydrospecterRenderer extends HumanoidMobRenderer<HydrospecterEntity, HumanoidModel<HydrospecterEntity>> {
	public HydrospecterRenderer(EntityRendererProvider.Context context) {
		super(context, new HumanoidModel<HydrospecterEntity>(context.bakeLayer(ModelLayers.PLAYER)), 0.5f);
		this.addLayer(new HumanoidArmorLayer(this, new HumanoidModel(context.bakeLayer(ModelLayers.PLAYER_INNER_ARMOR)), new HumanoidModel(context.bakeLayer(ModelLayers.PLAYER_OUTER_ARMOR)), context.getModelManager()));
		this.addLayer(new RenderLayer<HydrospecterEntity, HumanoidModel<HydrospecterEntity>>(this) {
