...
public class PyrohypostasisRenderer extends MobRenderer<PyrohypostasisEntity, Modelpyro_hypostasis<PyrohypostasisEntity>> {
	public PyrohypostasisRenderer(EntityRendererProvider.Context context) {
		super(context, new Modelpyro_hypostasis<PyrohypostasisEntity>(context.bakeLayer(Modelpyro_hypostasis.LAYER_LOCATION)), 1f);
		this.addLayer(new RenderLayer<PyrohypostasisEntity, Modelpyro_hypostasis<PyrohypostasisEntity>>(this) {
