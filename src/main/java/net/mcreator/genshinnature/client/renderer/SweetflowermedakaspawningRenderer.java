...
public class SweetflowermedakaspawningRenderer extends HumanoidMobRenderer<SweetflowermedakaspawningEntity, HumanoidModel<SweetflowermedakaspawningEntity>> {
	public SweetflowermedakaspawningRenderer(EntityRendererProvider.Context context) {
		super(context, new HumanoidModel<SweetflowermedakaspawningEntity>(context.bakeLayer(ModelLayers.PLAYER)), 0.6f);
