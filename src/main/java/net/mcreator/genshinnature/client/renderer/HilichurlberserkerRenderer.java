...
public class HilichurlberserkerRenderer extends HumanoidMobRenderer<HilichurlberserkerEntity, HumanoidModel<HilichurlberserkerEntity>> {
	public HilichurlberserkerRenderer(EntityRendererProvider.Context context) {
		super(context, new HumanoidModel<HilichurlberserkerEntity>(context.bakeLayer(ModelLayers.PLAYER)), 0.5f);
