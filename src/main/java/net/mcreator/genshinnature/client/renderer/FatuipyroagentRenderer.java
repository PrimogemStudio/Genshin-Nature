...
public class FatuipyroagentRenderer extends HumanoidMobRenderer<FatuipyroagentEntity, HumanoidModel<FatuipyroagentEntity>> {
	public FatuipyroagentRenderer(EntityRendererProvider.Context context) {
		super(context, new HumanoidModel<FatuipyroagentEntity>(context.bakeLayer(ModelLayers.PLAYER)), 0.5f);
