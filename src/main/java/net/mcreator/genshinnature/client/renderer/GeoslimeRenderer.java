...
public class GeoslimeRenderer extends HumanoidMobRenderer<GeoslimeEntity, HumanoidModel<GeoslimeEntity>> {
	public GeoslimeRenderer(EntityRendererProvider.Context context) {
		super(context, new HumanoidModel<GeoslimeEntity>(context.bakeLayer(ModelLayers.PLAYER)), 0.5f);
