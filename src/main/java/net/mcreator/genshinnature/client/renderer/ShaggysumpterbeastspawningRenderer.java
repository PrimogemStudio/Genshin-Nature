...
public class ShaggysumpterbeastspawningRenderer extends HumanoidMobRenderer<ShaggysumpterbeastspawningEntity, HumanoidModel<ShaggysumpterbeastspawningEntity>> {
	public ShaggysumpterbeastspawningRenderer(EntityRendererProvider.Context context) {
		super(context, new HumanoidModel<ShaggysumpterbeastspawningEntity>(context.bakeLayer(ModelLayers.PLAYER)), 2f);
