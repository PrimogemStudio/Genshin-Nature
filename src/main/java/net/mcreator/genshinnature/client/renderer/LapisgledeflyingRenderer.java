...
public class LapisgledeflyingRenderer extends HumanoidMobRenderer<LapisgledeflyingEntity, HumanoidModel<LapisgledeflyingEntity>> {
	public LapisgledeflyingRenderer(EntityRendererProvider.Context context) {
		super(context, new HumanoidModel<LapisgledeflyingEntity>(context.bakeLayer(ModelLayers.PLAYER)), 0.7f);
