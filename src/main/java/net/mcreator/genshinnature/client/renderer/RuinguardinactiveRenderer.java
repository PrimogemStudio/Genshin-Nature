...
public class RuinguardinactiveRenderer extends HumanoidMobRenderer<RuinguardinactiveEntity, HumanoidModel<RuinguardinactiveEntity>> {
	public RuinguardinactiveRenderer(EntityRendererProvider.Context context) {
		super(context, new HumanoidModel<RuinguardinactiveEntity>(context.bakeLayer(ModelLayers.PLAYER)), 2f);
