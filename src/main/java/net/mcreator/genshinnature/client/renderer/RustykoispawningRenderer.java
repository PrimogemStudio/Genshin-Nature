...
public class RustykoispawningRenderer extends HumanoidMobRenderer<RustykoispawningEntity, HumanoidModel<RustykoispawningEntity>> {
	public RustykoispawningRenderer(EntityRendererProvider.Context context) {
		super(context, new HumanoidModel<RustykoispawningEntity>(context.bakeLayer(ModelLayers.PLAYER)), 0.6f);
