...
public class BettaspawningRenderer extends HumanoidMobRenderer<BettaspawningEntity, HumanoidModel<BettaspawningEntity>> {
	public BettaspawningRenderer(EntityRendererProvider.Context context) {
		super(context, new HumanoidModel<BettaspawningEntity>(context.bakeLayer(ModelLayers.PLAYER)), 1.2f);
