...
public class HilichurlfighterRenderer extends HumanoidMobRenderer<HilichurlfighterEntity, HumanoidModel<HilichurlfighterEntity>> {
	public HilichurlfighterRenderer(EntityRendererProvider.Context context) {
		super(context, new HumanoidModel<HilichurlfighterEntity>(context.bakeLayer(ModelLayers.PLAYER)), 0.5f);
