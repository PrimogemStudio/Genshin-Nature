...
public class Pyrohypostasisphase2Renderer extends MobRenderer<Pyrohypostasisphase2Entity, Modelpyro_hypostasis_fist<Pyrohypostasisphase2Entity>> {
	public Pyrohypostasisphase2Renderer(EntityRendererProvider.Context context) {
		...
		this.addLayer(new RenderLayer<Pyrohypostasisphase2Entity, Modelpyro_hypostasis_fist<Pyrohypostasisphase2Entity>>(this) {
			...
			@Override
			public void render(PoseStack poseStack, MultiBufferSource bufferSource, int light, Pyrohypostasisphase2Entity entity, float limbSwing, float limbSwingAmount, float partialTicks, float ageInTicks, float netHeadYaw, float headPitch) {
	...
	@Override
	public ResourceLocation getTextureLocation(Pyrohypostasisphase2Entity entity) {
		return ResourceLocation.parse("genshin_nature:textures/entities/pyro_hypostasis_fist.png");
	}
}
