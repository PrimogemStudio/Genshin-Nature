...
public class AzurecraneRenderer extends HumanoidMobRenderer<AzurecraneEntity, HumanoidModel<AzurecraneEntity>> {
	public AzurecraneRenderer(EntityRendererProvider.Context context) {
		super(context, new HumanoidModel<AzurecraneEntity>(context.bakeLayer(ModelLayers.PLAYER)), 1f);
