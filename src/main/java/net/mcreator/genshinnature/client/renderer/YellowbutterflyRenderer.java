...
public class YellowbutterflyRenderer extends HumanoidMobRenderer<YellowbutterflyEntity, HumanoidModel<YellowbutterflyEntity>> {
	public YellowbutterflyRenderer(EntityRendererProvider.Context context) {
		super(context, new HumanoidModel<YellowbutterflyEntity>(context.bakeLayer(ModelLayers.PLAYER)), 0.5f);
