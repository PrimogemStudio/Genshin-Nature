...
public class RedtailedweaselRenderer extends HumanoidMobRenderer<RedtailedweaselEntity, HumanoidModel<RedtailedweaselEntity>> {
	public RedtailedweaselRenderer(EntityRendererProvider.Context context) {
		super(context, new HumanoidModel<RedtailedweaselEntity>(context.bakeLayer(ModelLayers.PLAYER)), 0.5f);
