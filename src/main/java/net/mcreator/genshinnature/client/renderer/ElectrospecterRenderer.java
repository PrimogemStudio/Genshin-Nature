...
public class ElectrospecterRenderer extends HumanoidMobRenderer<ElectrospecterEntity, HumanoidModel<ElectrospecterEntity>> {
	public ElectrospecterRenderer(EntityRendererProvider.Context context) {
		super(context, new HumanoidModel<ElectrospecterEntity>(context.bakeLayer(ModelLayers.PLAYER)), 0.5f);
		this.addLayer(new HumanoidArmorLayer(this, new HumanoidModel(context.bakeLayer(ModelLayers.PLAYER_INNER_ARMOR)), new HumanoidModel(context.bakeLayer(ModelLayers.PLAYER_OUTER_ARMOR)), context.getModelManager()));
		this.addLayer(new RenderLayer<ElectrospecterEntity, HumanoidModel<ElectrospecterEntity>>(this) {
