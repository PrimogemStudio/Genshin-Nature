...
public class LargecryoslimenohelmetRenderer extends HumanoidMobRenderer<LargecryoslimenohelmetEntity, HumanoidModel<LargecryoslimenohelmetEntity>> {
	public LargecryoslimenohelmetRenderer(EntityRendererProvider.Context context) {
		super(context, new HumanoidModel<LargecryoslimenohelmetEntity>(context.bakeLayer(ModelLayers.PLAYER)), 1f);
