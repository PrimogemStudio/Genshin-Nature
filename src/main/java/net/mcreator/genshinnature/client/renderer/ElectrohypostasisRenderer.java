...
public class ElectrohypostasisRenderer extends MobRenderer<ElectrohypostasisEntity, Modelelectro_hypostasis<ElectrohypostasisEntity>> {
	public ElectrohypostasisRenderer(EntityRendererProvider.Context context) {
		super(context, new Modelelectro_hypostasis<ElectrohypostasisEntity>(context.bakeLayer(Modelelectro_hypostasis.LAYER_LOCATION)), 1f);
		this.addLayer(new RenderLayer<ElectrohypostasisEntity, Modelelectro_hypostasis<ElectrohypostasisEntity>>(this) {
