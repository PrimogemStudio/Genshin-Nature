...
public class WarmseelieicespikesRenderer extends HumanoidMobRenderer<WarmseelieicespikesEntity, HumanoidModel<WarmseelieicespikesEntity>> {
	public WarmseelieicespikesRenderer(EntityRendererProvider.Context context) {
		super(context, new HumanoidModel<WarmseelieicespikesEntity>(context.bakeLayer(ModelLayers.PLAYER)), 0.5f);
