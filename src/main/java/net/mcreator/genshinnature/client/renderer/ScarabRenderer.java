...
public class ScarabRenderer extends HumanoidMobRenderer<ScarabEntity, HumanoidModel<ScarabEntity>> {
	public ScarabRenderer(EntityRendererProvider.Context context) {
		super(context, new HumanoidModel<ScarabEntity>(context.bakeLayer(ModelLayers.PLAYER)), 0.5f);
