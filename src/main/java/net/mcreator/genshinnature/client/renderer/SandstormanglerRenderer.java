...
public class SandstormanglerRenderer extends HumanoidMobRenderer<SandstormanglerEntity, HumanoidModel<SandstormanglerEntity>> {
	public SandstormanglerRenderer(EntityRendererProvider.Context context) {
		super(context, new HumanoidModel<SandstormanglerEntity>(context.bakeLayer(ModelLayers.PLAYER)), 0.7f);
