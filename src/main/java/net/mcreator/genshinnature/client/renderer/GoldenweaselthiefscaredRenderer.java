...
public class GoldenweaselthiefscaredRenderer extends HumanoidMobRenderer<GoldenweaselthiefscaredEntity, HumanoidModel<GoldenweaselthiefscaredEntity>> {
	public GoldenweaselthiefscaredRenderer(EntityRendererProvider.Context context) {
		super(context, new HumanoidModel<GoldenweaselthiefscaredEntity>(context.bakeLayer(ModelLayers.PLAYER)), 0.5f);
