...
public class BluethunderweaselRenderer extends HumanoidMobRenderer<BluethunderweaselEntity, HumanoidModel<BluethunderweaselEntity>> {
	public BluethunderweaselRenderer(EntityRendererProvider.Context context) {
		super(context, new HumanoidModel<BluethunderweaselEntity>(context.bakeLayer(ModelLayers.PLAYER)), 0.5f);
		this.addLayer(new HumanoidArmorLayer(this, new HumanoidModel(context.bakeLayer(ModelLayers.PLAYER_INNER_ARMOR)), new HumanoidModel(context.bakeLayer(ModelLayers.PLAYER_OUTER_ARMOR)), context.getModelManager()));
		this.addLayer(new RenderLayer<BluethunderweaselEntity, HumanoidModel<BluethunderweaselEntity>>(this) {
