...
public class HiddenlargedendroslimeRenderer extends HumanoidMobRenderer<HiddenlargedendroslimeEntity, HumanoidModel<HiddenlargedendroslimeEntity>> {
	public HiddenlargedendroslimeRenderer(EntityRendererProvider.Context context) {
		super(context, new HumanoidModel<HiddenlargedendroslimeEntity>(context.bakeLayer(ModelLayers.PLAYER)), 1f);
