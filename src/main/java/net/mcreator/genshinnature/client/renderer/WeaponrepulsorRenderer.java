...
public class WeaponrepulsorRenderer extends HumanoidMobRenderer<WeaponrepulsorEntity, HumanoidModel<WeaponrepulsorEntity>> {
	public WeaponrepulsorRenderer(EntityRendererProvider.Context context) {
		super(context, new HumanoidModel<WeaponrepulsorEntity>(context.bakeLayer(ModelLayers.PLAYER)), 0.4f);
