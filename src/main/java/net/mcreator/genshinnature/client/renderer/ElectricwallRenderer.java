...
public class ElectricwallRenderer extends HumanoidMobRenderer<ElectricwallEntity, HumanoidModel<ElectricwallEntity>> {
	public ElectricwallRenderer(EntityRendererProvider.Context context) {
		super(context, new HumanoidModel<ElectricwallEntity>(context.bakeLayer(ModelLayers.PLAYER)), 0.5f);
