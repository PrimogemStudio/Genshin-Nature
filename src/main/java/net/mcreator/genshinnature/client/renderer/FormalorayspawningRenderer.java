...
public class FormalorayspawningRenderer extends HumanoidMobRenderer<FormalorayspawningEntity, HumanoidModel<FormalorayspawningEntity>> {
	public FormalorayspawningRenderer(EntityRendererProvider.Context context) {
		super(context, new HumanoidModel<FormalorayspawningEntity>(context.bakeLayer(ModelLayers.PLAYER)), 1.2f);
