...
public class LargedendroslimeRenderer extends HumanoidMobRenderer<LargedendroslimeEntity, HumanoidModel<LargedendroslimeEntity>> {
	public LargedendroslimeRenderer(EntityRendererProvider.Context context) {
		super(context, new HumanoidModel<LargedendroslimeEntity>(context.bakeLayer(ModelLayers.PLAYER)), 1f);
