...
public class PyroslimeRenderer extends MobRenderer<PyroslimeEntity, Modelpyroslime<PyroslimeEntity>> {
	public PyroslimeRenderer(EntityRendererProvider.Context context) {
		super(context, new Modelpyroslime<PyroslimeEntity>(context.bakeLayer(Modelpyroslime.LAYER_LOCATION)), 0.5f);
		this.addLayer(new RenderLayer<PyroslimeEntity, Modelpyroslime<PyroslimeEntity>>(this) {
