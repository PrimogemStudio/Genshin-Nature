...
public class BootweaselRenderer extends HumanoidMobRenderer<BootweaselEntity, HumanoidModel<BootweaselEntity>> {
	public BootweaselRenderer(EntityRendererProvider.Context context) {
		super(context, new HumanoidModel<BootweaselEntity>(context.bakeLayer(ModelLayers.PLAYER)), 0.5f);
