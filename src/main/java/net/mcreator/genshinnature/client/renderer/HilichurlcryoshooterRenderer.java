...
public class HilichurlcryoshooterRenderer extends HumanoidMobRenderer<HilichurlcryoshooterEntity, HumanoidModel<HilichurlcryoshooterEntity>> {
	public HilichurlcryoshooterRenderer(EntityRendererProvider.Context context) {
		super(context, new HumanoidModel<HilichurlcryoshooterEntity>(context.bakeLayer(ModelLayers.PLAYER)), 0.5f);
