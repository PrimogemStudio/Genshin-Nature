...
public class Modelhilichurl_pyro_grenadier<T extends Entity> extends EntityModel<T> {
	// This layer location should be baked with EntityRendererProvider.Context in the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath("genshin_nature", "modelhilichurl_pyro_grenadier"), "main");
	...
	public Modelhilichurl_pyro_grenadier(ModelPart root) {
