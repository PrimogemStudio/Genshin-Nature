...
public class Modelcryo_hypostasis_clap<T extends Entity> extends EntityModel<T> {
	// This layer location should be baked with EntityRendererProvider.Context in the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath("genshin_nature", "modelcryo_hypostasis_clap"), "main");
	public final ModelPart bb_main;

	public Modelcryo_hypostasis_clap(ModelPart root) {
