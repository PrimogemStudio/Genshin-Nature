...
public class Modelruin_guard_inactive<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath("genshin_nature", "modelruin_guard_inactive"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition cube_r14 = RuinPelvis.addOrReplaceChild("cube_r14",
				...
				PartPose.offsetAndRotation(-4.0F, 16.0F, 6.0F, 0.0F, 0.0F, 0.7854F));
		PartDefinition left_leg_ANIM = RuinGuard.addOrReplaceChild("left_leg_ANIM",
				...
				PartPose.offsetAndRotation(9.4939F, -34.6533F, 8.0F, -2.0333F, 1.4733F, -0.4644F));
		PartDefinition LRuinLegBottom2 = left_leg_ANIM.addOrReplaceChild("LRuinLegBottom2",
				...
				PartPose.offsetAndRotation(20.0F, 0.0F, 0.0F, 0.0F, -0.3054F, 0.0F));
		PartDefinition LRuinLegFoot = LRuinLegBottom2.addOrReplaceChild("LRuinLegFoot",
				CubeListBuilder.create().texOffs(40, 154).addBox(0.0F, -7.0F, -10.0F, 3.0F, 16.0F, 16.0F, new CubeDeformation(0.0F)).texOffs(168, 189).addBox(-1.0F, -7.0F, -17.0F, 4.0F, 4.0F, 7.0F, new CubeDeformation(0.0F)).texOffs(44, 186)
						.addBox(-1.0F, 5.0F, -17.0F, 4.0F, 4.0F, 7.0F, new CubeDeformation(0.0F)).texOffs(45, 91).addBox(-1.0F, -1.0F, -17.0F, 4.0F, 4.0F, 7.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(20.0F, -1.0F, 0.0F, 0.0F, -0.3491F, 0.0F));
		PartDefinition right_leg_ANIM = RuinGuard.addOrReplaceChild("right_leg_ANIM",
				CubeListBuilder.create().texOffs(96, 125).addBox(-1.9117F, -4.402F, -5.0F, 25.0F, 9.0F, 9.0F, new CubeDeformation(0.0F)).texOffs(226, 69).addBox(15.0883F, -5.402F, -6.0F, 3.0F, 11.0F, 11.0F, new CubeDeformation(0.0F))
						...
						.addBox(0.0883F, -5.402F, -6.0F, 3.0F, 11.0F, 11.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-9.5061F, -34.6533F, 8.0F, 2.0333F, 1.4733F, -2.6772F));
		PartDefinition RRuinLegBottom = right_leg_ANIM.addOrReplaceChild("RRuinLegBottom",
				CubeListBuilder.create().texOffs(151, 89).addBox(-0.9117F, -4.402F, -5.0F, 20.0F, 9.0F, 9.0F, new CubeDeformation(0.0F)).texOffs(222, 113).addBox(15.0883F, -5.402F, -6.0F, 3.0F, 11.0F, 11.0F, new CubeDeformation(0.0F)).texOffs(0, 219)
						...
						.addBox(0.0883F, -5.402F, -6.0F, 3.0F, 11.0F, 11.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(21.0F, 0.0F, 0.0F, 0.0F, -0.3054F, 0.0F));
		PartDefinition RRuinLegFoot2 = RRuinLegBottom.addOrReplaceChild("RRuinLegFoot2",
				CubeListBuilder.create().texOffs(78, 159).addBox(0.0F, -7.0F, -10.0F, 3.0F, 16.0F, 16.0F, new CubeDeformation(0.0F)).texOffs(34, 208).addBox(-1.0F, -7.0F, -17.0F, 4.0F, 4.0F, 7.0F, new CubeDeformation(0.0F)).texOffs(128, 191)
						.addBox(-1.0F, 5.0F, -17.0F, 4.0F, 4.0F, 7.0F, new CubeDeformation(0.0F)).texOffs(100, 191).addBox(-1.0F, -1.0F, -17.0F, 4.0F, 4.0F, 7.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(19.0F, -1.0F, 0.0F, 0.0F, -0.3491F, 0.0F));
		...
		PartDefinition LRuinMid = LRuinShoulder.addOrReplaceChild("LRuinMid",
				CubeListBuilder.create().texOffs(17, 208).addBox(-10.0F, -6.0F, -6.0F, 3.0F, 11.0F, 11.0F, new CubeDeformation(0.0F)).texOffs(206, 58).addBox(-15.0F, -6.0F, -6.0F, 3.0F, 11.0F, 11.0F, new CubeDeformation(0.0F)).texOffs(205, 131)
						.addBox(-20.0F, -6.0F, -6.0F, 3.0F, 11.0F, 11.0F, new CubeDeformation(0.0F)).texOffs(203, 102).addBox(-25.0F, -6.0F, -6.0F, 3.0F, 11.0F, 11.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(7.0F, 12.0F, 0.0F, 0.0F, -0.4363F, -1.5708F));
		PartDefinition cube_r16 = LRuinMid.addOrReplaceChild("cube_r16", CubeListBuilder.create().texOffs(94, 18).addBox(24.0F, -43.0F, 7.0F, 29.0F, 9.0F, 9.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-51.0F, 38.0F, -12.0F, 0.0F, 0.0F, 0.0F));
		...
		PartDefinition cube_r17 = LRuinLower.addOrReplaceChild("cube_r17",
		...
		PartDefinition cube_r18 = LPod.addOrReplaceChild("cube_r18",
		...
		PartDefinition cube_r19 = RRuinShoulder.addOrReplaceChild("cube_r19",
		...
		PartDefinition RRuinMid = RRuinShoulder.addOrReplaceChild("RRuinMid",
				...
				PartPose.offsetAndRotation(-12.5061F, 0.3467F, 0.0F, 0.0F, -0.4363F, -0.7854F));
		...
		PartDefinition cube_r20 = RRuinLower.addOrReplaceChild("cube_r20",
		...
		PartDefinition cube_r21 = RPod.addOrReplaceChild("cube_r21",
