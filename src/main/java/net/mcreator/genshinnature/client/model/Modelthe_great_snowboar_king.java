...
public class Modelthe_great_snowboar_king<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath("genshin_nature", "modelthe_great_snowboar_king"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition body = bone.addOrReplaceChild("body", CubeListBuilder.create().texOffs(84, 24).addBox(-15.0F, -30.0F, -21.0F, 30.0F, 48.0F, 24.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -39.0F, 6.0F, 1.5708F, 0.0F, 0.0F));
		PartDefinition head = bone.addOrReplaceChild("head",
				CubeListBuilder.create().texOffs(0, 0).addBox(-12.0F, -12.0F, -24.0F, 24.0F, 24.0F, 24.0F, new CubeDeformation(0.0F)).texOffs(48, 48).addBox(-6.0F, 0.0F, -27.0F, 12.0F, 9.0F, 3.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, -36.0F, -18.0F));
		PartDefinition cube_r1 = head.addOrReplaceChild("cube_r1",
				CubeListBuilder.create().texOffs(63, 73).addBox(-1.5F, -3.0F, -7.5F, 3.0F, 3.0F, 6.0F, new CubeDeformation(0.0F)).texOffs(62, 73).addBox(-1.5F, 0.0F, -4.5F, 3.0F, 3.0F, 6.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(10.5F, 3.0F, -25.5F, 0.0F, -0.1309F, 0.0F));
		PartDefinition cube_r2 = head.addOrReplaceChild("cube_r2",
				CubeListBuilder.create().texOffs(63, 70).addBox(-1.5F, -3.0F, -7.5F, 3.0F, 3.0F, 6.0F, new CubeDeformation(0.0F)).texOffs(63, 71).addBox(-1.5F, 0.0F, -4.5F, 3.0F, 3.0F, 6.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-10.5F, 3.0F, -25.5F, 0.0F, 0.1309F, 0.0F));
