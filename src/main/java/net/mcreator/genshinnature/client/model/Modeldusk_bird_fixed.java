...
public class Modeldusk_bird_fixed<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath("genshin_nature", "modeldusk_bird_fixed"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition bone = partdefinition.addOrReplaceChild("bone",
				CubeListBuilder.create().texOffs(26, 45).addBox(-1.0F, -3.0F, 5.0F, 2.0F, 1.0F, 5.0F, new CubeDeformation(0.0F)).texOffs(43, 37).addBox(-1.0F, -4.0F, 8.0F, 2.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r1 = bone.addOrReplaceChild("cube_r1", CubeListBuilder.create().texOffs(16, 19).addBox(-2.0F, -2.0F, -3.5F, 4.0F, 4.0F, 7.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -5.0F, 2.5F, -0.3491F, 0.0F, 0.0F));
		PartDefinition head = bone.addOrReplaceChild("head",
				...
				PartPose.offset(0.0F, -6.1F, 0.4F));
		PartDefinition left_leg = bone.addOrReplaceChild("left_leg",
				...
				PartPose.offset(-1.4F, -3.6F, 2.0F));
