...
public class Modelfalcon_flying<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath("genshin_nature", "modelfalcon_flying"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition left_leg = bone.addOrReplaceChild("left_leg",
				...
				PartPose.offsetAndRotation(-2.0F, 2.8803F, 0.4207F, 0.5236F, 0.2182F, 0.0F));
		...
		PartDefinition wing1 = bone.addOrReplaceChild("wing1",
				...
				PartPose.offsetAndRotation(2.0F, 0.0303F, -1.6293F, -0.8492F, -0.2324F, -1.7708F));
