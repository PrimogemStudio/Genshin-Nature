...
public class Modelprimal_construct_repulsor<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath("genshin_nature", "modelprimal_construct_repulsor"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition weapon = partdefinition.addOrReplaceChild("weapon", CubeListBuilder.create().texOffs(3, 32).addBox(-3.5F, -3.5F, 0.6667F, 7.0F, 7.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(29, 17)
				...
				PartPose.offsetAndRotation(12.5F, 11.5F, -1.6667F, 0.1745F, -0.3491F, 0.0F));
		PartDefinition weapon2 = partdefinition.addOrReplaceChild("weapon2", CubeListBuilder.create().texOffs(29, 17).addBox(-2.5F, -2.5F, -2.8333F, 5.0F, 5.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(29, 17)
				.addBox(-2.5F, -2.5F, 0.1667F, 5.0F, 5.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(3, 32).mirror().addBox(-3.5F, -3.5F, 0.6667F, 7.0F, 7.0F, 2.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offsetAndRotation(-12.5F, 11.5F, -1.6667F, 0.1745F, 0.3491F, 0.0F));
