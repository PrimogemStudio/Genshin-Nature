...
public class Modelmirror_maiden<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath("genshin_nature", "modelmirror_maiden"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Body = partdefinition.addOrReplaceChild("Body",
				...
				PartPose.offset(0.0F, 0.0F, 0.0F));
		PartDefinition brazo_right = partdefinition.addOrReplaceChild("brazo_right", CubeListBuilder.create().texOffs(32, 48).mirror().addBox(-2.0F, -2.0F, -2.0F, 3.0F, 12.0F, 4.0F, new CubeDeformation(0.0F)).mirror(false).texOffs(40, 32).mirror()
				.addBox(-2.0F, -2.0F, -2.0F, 3.0F, 12.0F, 4.0F, new CubeDeformation(0.25F)).mirror(false), PartPose.offset(-5.0F, 2.0F, 0.0F));
		PartDefinition brazo_left = partdefinition.addOrReplaceChild("brazo_left",
