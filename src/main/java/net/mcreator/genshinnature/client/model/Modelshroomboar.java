...
public class Modelshroomboar<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath("genshin_nature", "modelshroomboar"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition cube_r1 = head.addOrReplaceChild("cube_r1",
				CubeListBuilder.create().texOffs(21, 24).addBox(-0.5F, -1.0F, -2.5F, 1.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(21, 24).addBox(-0.5F, 0.0F, -1.5F, 1.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(3.5F, 1.0F, -8.5F, 0.0F, -0.1309F, 0.0F));
		...
		PartDefinition mushroom = bone.addOrReplaceChild("mushroom",
				CubeListBuilder.create().texOffs(56, 1).addBox(-3.0F, -16.0F, 3.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(27, 0).addBox(-4.0F, -19.0F, 2.0F, 4.0F, 3.0F, 4.0F, new CubeDeformation(0.0F)),
