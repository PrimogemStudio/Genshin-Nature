...
public class Modelanemoslime<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath("genshin_nature", "modelanemoslime"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition wings = partdefinition.addOrReplaceChild("wings",
				CubeListBuilder.create().texOffs(0, 29).addBox(5.0F, -13.0F, -1.0F, 4.0F, 3.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(0, 29).mirror().addBox(-9.0F, -13.0F, -1.0F, 4.0F, 3.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false)
						.texOffs(0, 31).addBox(5.0F, -11.0F, -1.5F, 3.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(0, 30).addBox(5.0F, -12.0F, -1.5F, 4.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(0, 29)
						.addBox(5.0F, -13.0F, -1.5F, 5.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(28, 28).addBox(-10.0F, -13.0F, -1.5F, 5.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(33, 41)
						.addBox(-9.0F, -12.0F, -1.5F, 4.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(0, 36).addBox(-8.0F, -11.0F, -1.5F, 3.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition bb_main = partdefinition.addOrReplaceChild("bb_main",
				CubeListBuilder.create().texOffs(0, 55).addBox(-4.0F, -1.0F, -4.0F, 8.0F, 1.0F, 8.0F, new CubeDeformation(0.0F)).texOffs(0, 55).addBox(4.0F, -2.0F, -4.0F, 1.0F, 1.0F, 8.0F, new CubeDeformation(0.0F)).texOffs(0, 55)
						...
						.addBox(-5.0F, -8.0F, 4.0F, 1.0F, 6.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(0, 59).addBox(-6.0F, -7.0F, 4.0F, 1.0F, 4.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 24.0F, 0.0F));
