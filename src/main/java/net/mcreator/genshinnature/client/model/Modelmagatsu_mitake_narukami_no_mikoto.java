...
public class Modelmagatsu_mitake_narukami_no_mikoto<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath("genshin_nature", "modelmagatsu_mitake_narukami_no_mikoto"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition armRight = partdefinition.addOrReplaceChild("armRight",
				...
				PartPose.offsetAndRotation(-4.0F, 3.5F, 0.0F, 0.0F, 0.0F, 0.4363F));
