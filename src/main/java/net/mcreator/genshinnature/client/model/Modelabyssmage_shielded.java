...
public class Modelabyssmage_shielded<T extends Entity> extends EntityModel<T> {
	// This layer location should be baked with EntityRendererProvider.Context in the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath("genshin_nature", "modelabyssmage_shielded"), "main");
	...
	public Modelabyssmage_shielded(ModelPart root) {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition shield = partdefinition.addOrReplaceChild("shield",
				CubeListBuilder.create().texOffs(18, 73).addBox(11.0F, -40.0F, -8.0F, 2.0F, 40.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(8, 71).addBox(-13.0F, -40.0F, -8.0F, 2.0F, 40.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(8, 71)
						.addBox(-11.0F, -38.0F, -7.5F, 2.0F, 36.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(8, 71).addBox(9.0F, -38.0F, -7.5F, 2.0F, 36.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(8, 71)
						.addBox(9.0F, -38.0F, 8.5F, 2.0F, 36.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(8, 71).addBox(-11.0F, -38.0F, 8.5F, 2.0F, 36.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(8, 71)
						.addBox(-12.5F, -38.0F, -6.0F, 1.0F, 36.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(8, 71).addBox(-12.5F, -38.0F, 6.0F, 1.0F, 36.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(8, 71)
						.addBox(11.5F, -38.0F, 6.0F, 1.0F, 36.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(8, 71).addBox(11.5F, -38.0F, -6.0F, 1.0F, 36.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(0, 71)
						.addBox(-13.0F, -40.0F, 8.0F, 2.0F, 40.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(0, 72).addBox(11.0F, -40.0F, 8.0F, 2.0F, 40.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(17, 88)
						.addBox(11.0F, -40.0F, -6.0F, 2.0F, 2.0F, 14.0F, new CubeDeformation(0.0F)).texOffs(17, 88).addBox(-13.0F, -40.0F, -6.0F, 2.0F, 2.0F, 14.0F, new CubeDeformation(0.0F)).texOffs(17, 88)
						.addBox(-13.0F, -2.0F, -6.0F, 2.0F, 2.0F, 14.0F, new CubeDeformation(0.0F)).texOffs(17, 88).addBox(11.0F, -2.0F, -6.0F, 2.0F, 2.0F, 14.0F, new CubeDeformation(0.0F)).texOffs(16, 94)
						.addBox(-11.0F, -40.0F, 8.0F, 22.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(16, 93).addBox(-11.0F, -40.0F, -8.0F, 22.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(16, 93)
						.addBox(-11.0F, -2.0F, -8.0F, 22.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(16, 93).addBox(-11.0F, -2.0F, 8.0F, 22.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)),
	...
	public void renderToBuffer(PoseStack poseStack, VertexConsumer vertexConsumer, int packedLight, int packedOverlay, int rgb) {
		...
		shield.render(poseStack, vertexConsumer, packedLight, packedOverlay, rgb);
	}
}
