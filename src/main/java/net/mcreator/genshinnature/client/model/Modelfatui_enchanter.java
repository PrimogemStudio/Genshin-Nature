...
public class Modelfatui_enchanter<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath("genshin_nature", "modelfatui_enchanter"), "main");
	...
	public final ModelPart gema;
	public final ModelPart palo1;
	public final ModelPart palo2;
	public final ModelPart right_arm2;
	public final ModelPart right_sleve;
	public final ModelPart right_sleve2;
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition head = partdefinition.addOrReplaceChild("head", CubeListBuilder.create().texOffs(24, 19).addBox(-4.0F, -8.0F, -4.0F, 8.0F, 8.0F, 8.0F, new CubeDeformation(0.0F)).texOffs(0, 11)
				.addBox(-4.0F, -8.0F, -4.0F, 8.0F, 8.0F, 8.0F, new CubeDeformation(0.5F)).texOffs(0, 0).addBox(-5.0F, -3.8F, -5.0F, 10.0F, 1.0F, 10.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 0.0F, 0.0F));
		...
		PartDefinition right_arm = partdefinition.addOrReplaceChild("right_arm", CubeListBuilder.create().texOffs(60, 47).addBox(-2.0F, -2.0F, -2.0F, 3.0F, 6.0F, 4.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-5.0F, 2.0F, 0.0F, -0.8727F, 0.0F, 0.0F));
		...
		PartDefinition gema = baston.addOrReplaceChild("gema", CubeListBuilder.create().texOffs(24, 11).addBox(-2.0F, -2.0F, -2.0F, 4.0F, 4.0F, 4.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-5.7654F, -32.6369F, -6.376F, -1.3177F, -0.6021F, 0.7505F));
		PartDefinition palo1 = baston.addOrReplaceChild("palo1", CubeListBuilder.create().texOffs(32, 51).addBox(-0.5F, 0.3333F, -0.5F, 1.0F, 23.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(58, 22)
				.addBox(-2.0F, -8.6667F, -2.0F, 4.0F, 3.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(0, 0).addBox(-1.0F, -2.6667F, -1.0F, 2.0F, 3.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-5.5F, -23.3333F, -6.5F, 0.0F, -0.7854F, 0.0F));
		...
		PartDefinition right_arm2 = right_arm.addOrReplaceChild("right_arm2", CubeListBuilder.create().texOffs(0, 59).addBox(-1.5F, -3.537F, -3.3003F, 3.0F, 6.0F, 4.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-0.5F, 7.0F, 0.0F, -0.3927F, 0.0F, 0.0F));
		...
		PartDefinition right_sleve2 = right_sleve.addOrReplaceChild("right_sleve2", CubeListBuilder.create().texOffs(48, 16).addBox(-12.0F, -2.6105F, -1.9171F, 3.0F, 6.0F, 4.0F, new CubeDeformation(0.25F)),
