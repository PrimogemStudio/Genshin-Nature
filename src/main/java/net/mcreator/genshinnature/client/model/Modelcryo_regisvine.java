...
public class Modelcryo_regisvine<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath("genshin_nature", "modelcryo_regisvine"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition cube_r6 = bone.addOrReplaceChild("cube_r6", CubeListBuilder.create().texOffs(94, 92).addBox(-4.0F, -20.5F, -2.0F, 9.0F, 28.0F, 8.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r7 = head.addOrReplaceChild("cube_r7",
				CubeListBuilder.create().texOffs(96, 101).addBox(-4.5F, -15.6264F, -2.7579F, 9.0F, 20.0F, 7.0F, new CubeDeformation(0.0F)).texOffs(106, 14).addBox(-2.5F, -18.6264F, 3.2421F, 5.0F, 3.0F, 6.0F, new CubeDeformation(0.0F)).texOffs(25, 30)
		...
		PartDefinition cube_r14 = leftarm.addOrReplaceChild("cube_r14", CubeListBuilder.create().texOffs(21, 96).mirror().addBox(-1.9995F, -3.3704F, -1.0152F, 21.0F, 5.0F, 5.0F, new CubeDeformation(0.0F)).mirror(false),
		...
		PartDefinition cube_r17 = rightarm.addOrReplaceChild("cube_r17", CubeListBuilder.create().texOffs(21, 96).mirror().addBox(-1.9995F, -3.3704F, -1.0152F, 21.0F, 5.0F, 5.0F, new CubeDeformation(0.0F)).mirror(false),
