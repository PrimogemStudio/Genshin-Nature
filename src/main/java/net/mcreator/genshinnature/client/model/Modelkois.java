...
public class Modelkois<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath("genshin_nature", "modelkois"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition bone = partdefinition.addOrReplaceChild("bone", CubeListBuilder.create().texOffs(0, 26).addBox(-2.0F, -5.0F, 10.0F, 4.0F, 4.0F, 12.0F, new CubeDeformation(0.0F)).texOffs(0, 47)
				.addBox(-2.5F, -5.5F, -2.0F, 5.0F, 5.0F, 12.0F, new CubeDeformation(0.0F)).texOffs(0, 0).addBox(-3.0F, -6.0F, -9.0F, 6.0F, 6.0F, 7.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 23.0F, -8.0F));
		PartDefinition cube_r1 = bone.addOrReplaceChild("cube_r1", CubeListBuilder.create().texOffs(17, 20).addBox(-0.5F, -3.5F, -0.5F, 1.0F, 3.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.51F, -5.5F, -5.5F, -0.0873F, 0.0F, 0.0F));
		PartDefinition cube_r2 = bone.addOrReplaceChild("cube_r2", CubeListBuilder.create().texOffs(33, 6).addBox(-0.5F, -2.3257F, -0.4924F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.51F, -5.5F, -3.5F, -0.48F, 0.0F, 0.0F));
		PartDefinition cube_r3 = bone.addOrReplaceChild("cube_r3", CubeListBuilder.create().texOffs(7, 16).addBox(-0.5F, -2.3488F, -1.9253F, 1.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.5F, -9.4351F, -8.8087F, 0.2182F, 0.0F, 0.0F));
