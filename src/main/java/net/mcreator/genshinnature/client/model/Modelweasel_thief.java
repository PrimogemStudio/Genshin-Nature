...
public class Modelweasel_thief<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath("genshin_nature", "modelweasel_thief"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition cube_r3 = bag.addOrReplaceChild("cube_r3", CubeListBuilder.create().texOffs(17, 25).addBox(-2.5F, -3.0F, -0.5F, 5.0F, 6.0F, 3.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-0.5F, -10.0F, 0.5F, 0.3054F, 0.0F, 0.0F));
	...
	public void renderToBuffer(PoseStack poseStack, VertexConsumer vertexConsumer, int packedLight, int packedOverlay, int rgb) {
		...
		bag.render(poseStack, vertexConsumer, packedLight, packedOverlay, rgb);
	}
}
