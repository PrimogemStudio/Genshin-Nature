...
public class Modelfinches_flying<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath("genshin_nature", "modelfinches_flying"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition bone = partdefinition.addOrReplaceChild("bone", CubeListBuilder.create().texOffs(20, 0).addBox(-2.5F, -2.0975F, -5.4243F, 5.0F, 5.0F, 7.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.5F, 18.0975F, 0.4243F, 0.1745F, 0.0F, 0.0F));
		PartDefinition cube_r1 = bone.addOrReplaceChild("cube_r1", CubeListBuilder.create().texOffs(48, 0).addBox(-1.5F, -1.0F, 0.5F, 3.0F, 1.0F, 5.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 2.4025F, 1.0757F, 0.2618F, 0.0F, 0.0F));
		PartDefinition cube_r2 = bone.addOrReplaceChild("cube_r2", CubeListBuilder.create().texOffs(34, 44).addBox(-1.0F, -2.0F, 0.0F, 2.0F, 4.0F, 6.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-2.5F, -1.0975F, -2.4243F, -1.0516F, 0.1803F, 1.5486F));
		PartDefinition cube_r3 = bone.addOrReplaceChild("cube_r3", CubeListBuilder.create().texOffs(34, 44).addBox(-1.0F, -2.0F, 0.0F, 2.0F, 4.0F, 6.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(2.5F, -1.0975F, -2.4243F, -1.0516F, -0.1803F, -1.5486F));
		PartDefinition head = bone.addOrReplaceChild("head",
				...
				PartPose.offset(0.0F, -2.0975F, -3.4243F));
		...
		PartDefinition left_leg = bone.addOrReplaceChild("left_leg",
				...
				PartPose.offsetAndRotation(1.0F, 2.6525F, -2.1743F, 0.7854F, 0.0F, 0.0F));
