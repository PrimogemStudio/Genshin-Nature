...
public class Modelgeo_hypostasis_hands<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath("genshin_nature", "modelgeo_hypostasis_hands"), "main");
