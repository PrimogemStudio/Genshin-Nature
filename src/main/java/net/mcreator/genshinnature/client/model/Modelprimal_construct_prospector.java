...
public class Modelprimal_construct_prospector<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath("genshin_nature", "modelprimal_construct_prospector"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition cube_r9 = bone4.addOrReplaceChild("cube_r9", CubeListBuilder.create().texOffs(36, 0).addBox(-2.0F, -2.0F, -0.5F, 4.0F, 4.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-0.8839F, 0.8839F, 0.0F, 0.0F, 0.0F, -0.7854F));
		PartDefinition weapon = partdefinition.addOrReplaceChild("weapon", CubeListBuilder.create().texOffs(3, 32).mirror().addBox(-2.0F, -1.7195F, -1.0075F, 4.0F, 4.0F, 2.0F, new CubeDeformation(0.0F)).mirror(false).texOffs(43, 29).mirror()
				.addBox(-2.0F, -7.7195F, -0.9975F, 4.0F, 6.0F, 2.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(17.0F, 6.7195F, -1.0025F, 0.0F, -0.3491F, 0.0F));
		PartDefinition cube_r10 = weapon.addOrReplaceChild("cube_r10", CubeListBuilder.create().texOffs(29, 20).mirror().addBox(-1.0F, -3.0F, -1.0F, 6.0F, 4.0F, 2.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offsetAndRotation(2.0F, 2.2805F, 0.0025F, 0.0F, 0.0F, 0.4363F));
		PartDefinition cube_r11 = weapon.addOrReplaceChild("cube_r11", CubeListBuilder.create().texOffs(29, 20).addBox(-5.0F, -3.0F, -1.0F, 6.0F, 4.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-2.0F, 2.2805F, 0.0025F, 0.0F, 0.0F, -0.4363F));
		PartDefinition weapon2 = partdefinition.addOrReplaceChild("weapon2", CubeListBuilder.create().texOffs(3, 32).mirror().addBox(-2.5F, -1.5F, 0.6567F, 4.0F, 4.0F, 2.0F, new CubeDeformation(0.0F)).mirror(false).texOffs(43, 29).mirror()
				.addBox(-2.5F, -7.5F, 0.6667F, 4.0F, 6.0F, 2.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(-16.5F, 6.5F, -2.6667F, 0.0F, 0.3491F, 0.0F));
		PartDefinition cube_r12 = weapon2.addOrReplaceChild("cube_r12", CubeListBuilder.create().texOffs(29, 20).mirror().addBox(-1.0F, -3.0F, -1.0F, 6.0F, 4.0F, 2.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offsetAndRotation(1.5F, 2.5F, 1.6667F, 0.0F, 0.0F, 0.4363F));
		PartDefinition cube_r13 = weapon2.addOrReplaceChild("cube_r13", CubeListBuilder.create().texOffs(29, 20).addBox(-5.0F, -3.0F, -1.0F, 6.0F, 4.0F, 2.0F, new CubeDeformation(0.0F)),
