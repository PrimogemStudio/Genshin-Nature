...
public class Modelelectro_regisvine_hidden<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath("genshin_nature", "modelelectro_regisvine_hidden"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition cube_r6 = head.addOrReplaceChild("cube_r6", CubeListBuilder.create().texOffs(25, 30).mirror().addBox(-1.5F, -2.1493F, -0.5711F, 3.0F, 3.0F, 6.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offsetAndRotation(-3.0F, -8.6706F, -18.0576F, 1.4366F, -0.1726F, -0.9047F));
		PartDefinition cube_r7 = head.addOrReplaceChild("cube_r7", CubeListBuilder.create().texOffs(25, 30).addBox(-1.5F, -2.1493F, -0.5711F, 3.0F, 3.0F, 6.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(3.0F, -8.6706F, -18.0576F, 1.4366F, 0.1726F, 0.9047F));
		...
		PartDefinition cube_r8 = bone2.addOrReplaceChild("cube_r8", CubeListBuilder.create().texOffs(0, 0).mirror().addBox(5.0409F, 0.9138F, 0.7932F, 19.0F, 1.0F, 13.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 1.2698F, 0.4108F, 0.7236F));
		...
		PartDefinition cube_r9 = bone5.addOrReplaceChild("cube_r9",
				CubeListBuilder.create().texOffs(0, 0).addBox(-17.9591F, 0.9138F, 0.7932F, 19.0F, 1.0F, 13.0F, new CubeDeformation(0.0F)).texOffs(104, 0).addBox(-13.9591F, -3.0862F, 9.7932F, 7.0F, 3.0F, 5.0F, new CubeDeformation(0.0F))
						.texOffs(104, 0).addBox(-13.9591F, -3.0862F, -0.2068F, 7.0F, 3.0F, 5.0F, new CubeDeformation(0.0F)).texOffs(104, 0).addBox(-23.9591F, -3.0862F, 9.7932F, 7.0F, 3.0F, 5.0F, new CubeDeformation(0.0F)).texOffs(104, 0)
						.addBox(-23.9591F, -3.0862F, -0.2068F, 7.0F, 3.0F, 5.0F, new CubeDeformation(0.0F)).texOffs(104, 0).addBox(-33.9591F, -3.0862F, 9.7932F, 7.0F, 3.0F, 5.0F, new CubeDeformation(0.0F)).texOffs(104, 0)
						.addBox(-43.9591F, -3.0862F, 9.7932F, 7.0F, 3.0F, 5.0F, new CubeDeformation(0.0F)).texOffs(104, 0).addBox(-33.9591F, -3.0862F, -0.2068F, 7.0F, 3.0F, 5.0F, new CubeDeformation(0.0F)).texOffs(104, 0)
						.addBox(-43.9591F, -3.0862F, -0.2068F, 7.0F, 3.0F, 5.0F, new CubeDeformation(0.0F)).texOffs(0, 50).addBox(-47.9591F, -3.0862F, 4.7932F, 49.0F, 3.0F, 5.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-4.4983F, 0.5772F, -3.4661F, 1.4153F, 0.1536F, 0.7734F));
		...
		PartDefinition cube_r10 = bone7.addOrReplaceChild("cube_r10",
				CubeListBuilder.create().texOffs(104, 0).addBox(43.0409F, -3.0862F, 9.7932F, 7.0F, 3.0F, 5.0F, new CubeDeformation(0.0F)).texOffs(104, 0).addBox(43.0409F, -3.0862F, -0.2068F, 7.0F, 3.0F, 5.0F, new CubeDeformation(0.0F))
						.texOffs(104, 0).addBox(33.0409F, -3.0862F, 9.7932F, 7.0F, 3.0F, 5.0F, new CubeDeformation(0.0F)).texOffs(104, 0).addBox(33.0409F, -3.0862F, -0.2068F, 7.0F, 3.0F, 5.0F, new CubeDeformation(0.0F)).texOffs(104, 0)
						.addBox(23.0409F, -3.0862F, 9.7932F, 7.0F, 3.0F, 5.0F, new CubeDeformation(0.0F)).texOffs(104, 0).addBox(23.0409F, -3.0862F, -0.2068F, 7.0F, 3.0F, 5.0F, new CubeDeformation(0.0F)).texOffs(104, 0)
						.addBox(13.0409F, -3.0862F, -0.2068F, 7.0F, 3.0F, 5.0F, new CubeDeformation(0.0F)).texOffs(104, 0).addBox(13.0409F, -3.0862F, 9.7932F, 7.0F, 3.0F, 5.0F, new CubeDeformation(0.0F)).texOffs(0, 50).mirror()
						.addBox(5.0409F, -3.0862F, 4.7932F, 49.0F, 3.0F, 5.0F, new CubeDeformation(0.0F)).mirror(false),
		...
		PartDefinition cube_r11 = bone8.addOrReplaceChild("cube_r11",
				CubeListBuilder.create().texOffs(104, 0).addBox(13.6332F, -4.0568F, 8.8536F, 7.0F, 3.0F, 5.0F, new CubeDeformation(0.0F)).texOffs(104, 0).addBox(13.6332F, -4.0568F, -1.1464F, 7.0F, 3.0F, 5.0F, new CubeDeformation(0.0F)).texOffs(0, 50)
						.mirror().addBox(5.6332F, -4.0568F, 3.8536F, 49.0F, 3.0F, 5.0F, new CubeDeformation(0.0F)).mirror(false).texOffs(104, 0).addBox(23.6332F, -4.0568F, 8.8536F, 7.0F, 3.0F, 5.0F, new CubeDeformation(0.0F)).texOffs(104, 0)
						...
						.addBox(33.6332F, -4.0568F, 8.8536F, 7.0F, 3.0F, 5.0F, new CubeDeformation(0.0F)).texOffs(104, 0).addBox(43.6332F, -4.0568F, 8.8536F, 7.0F, 3.0F, 5.0F, new CubeDeformation(0.0F)).texOffs(104, 0)
						.addBox(43.6332F, -4.0568F, -1.1464F, 7.0F, 3.0F, 5.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 1.4153F, 0.1536F, 0.7734F));
		...
		PartDefinition cube_r12 = bone6.addOrReplaceChild("cube_r12",
				CubeListBuilder.create().texOffs(0, 0).addBox(-17.3668F, 0.9432F, -0.1464F, 19.0F, 1.0F, 13.0F, new CubeDeformation(0.0F)).texOffs(104, 0).addBox(-44.3668F, -4.0568F, 8.8536F, 7.0F, 3.0F, 5.0F, new CubeDeformation(0.0F))
						.texOffs(104, 0).addBox(-44.3668F, -4.0568F, -1.1464F, 7.0F, 3.0F, 5.0F, new CubeDeformation(0.0F)).texOffs(104, 0).addBox(-34.3668F, -4.0568F, 8.8536F, 7.0F, 3.0F, 5.0F, new CubeDeformation(0.0F)).texOffs(104, 0)
						.addBox(-34.3668F, -4.0568F, -1.1464F, 7.0F, 3.0F, 5.0F, new CubeDeformation(0.0F)).texOffs(104, 0).addBox(-24.3668F, -4.0568F, 8.8536F, 7.0F, 3.0F, 5.0F, new CubeDeformation(0.0F)).texOffs(104, 0)
						.addBox(-24.3668F, -4.0568F, -1.1464F, 7.0F, 3.0F, 5.0F, new CubeDeformation(0.0F)).texOffs(104, 0).addBox(-14.3668F, -4.0568F, 8.8536F, 7.0F, 3.0F, 5.0F, new CubeDeformation(0.0F)).texOffs(0, 50)
						.addBox(-48.3668F, -4.0568F, 3.8536F, 49.0F, 3.0F, 5.0F, new CubeDeformation(0.0F)).texOffs(104, 0).addBox(-14.3668F, -4.0568F, -1.1464F, 7.0F, 3.0F, 5.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 1.4153F, 0.1536F, 0.7734F));
		...
		PartDefinition cube_r13 = bone4.addOrReplaceChild("cube_r13", CubeListBuilder.create().texOffs(0, 0).mirror().addBox(5.6332F, 0.9432F, -0.1464F, 19.0F, 1.0F, 13.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offsetAndRotation(-2.9502F, 4.3243F, -0.7707F, 1.3591F, 0.7551F, 0.6511F));
		...
		PartDefinition cube_r15 = rightarm.addOrReplaceChild("cube_r15", CubeListBuilder.create().texOffs(28, 108).mirror().addBox(-1.9995F, -3.4037F, -1.0152F, 21.0F, 5.0F, 5.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offsetAndRotation(19.1418F, 21.2136F, -3.3504F, 1.3598F, 0.056F, 0.2559F));
		PartDefinition cube_r16 = rightarm.addOrReplaceChild("cube_r16", CubeListBuilder.create().texOffs(0, 86).addBox(3.0409F, 3.9138F, 4.7932F, 30.0F, 5.0F, 5.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r18 = leftarm.addOrReplaceChild("cube_r18", CubeListBuilder.create().texOffs(28, 108).mirror().addBox(-1.9995F, -3.3997F, -1.0152F, 21.0F, 5.0F, 5.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offsetAndRotation(19.0869F, 20.1019F, -4.4707F, 1.3598F, 0.056F, 0.2559F));
		PartDefinition cube_r19 = leftarm.addOrReplaceChild("cube_r19", CubeListBuilder.create().texOffs(0, 86).addBox(3.0409F, 3.9138F, 4.7932F, 30.0F, 5.0F, 5.0F, new CubeDeformation(0.0F)),
