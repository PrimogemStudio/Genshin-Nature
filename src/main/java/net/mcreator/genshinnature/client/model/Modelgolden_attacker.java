...
public class Modelgolden_attacker<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath("genshin_nature", "modelgolden_attacker"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition head_r3 = head.addOrReplaceChild("head_r3",
				...
				PartPose.offsetAndRotation(0.0125F, 2.9787F, -9.315F, 0.2182F, 0.0F, 0.0F));
		...
		PartDefinition cube_r1 = body.addOrReplaceChild("cube_r1", CubeListBuilder.create().texOffs(0, 53).addBox(-1.0F, -1.3282F, 0.5884F, 2.0F, 2.0F, 9.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(1.0F, -5.3561F, 22.9545F, 0.1309F, 0.0F, 0.0F));
		PartDefinition cube_r2 = body.addOrReplaceChild("cube_r2", CubeListBuilder.create().texOffs(0, 45).addBox(-3.0F, -3.5F, 27.5F, 4.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(2.0F, -11.0F, -6.5F, -0.2618F, 0.0F, 0.0F));
		PartDefinition cube_r3 = body.addOrReplaceChild("cube_r3", CubeListBuilder.create().texOffs(0, 45).addBox(0.0F, -3.5F, 18.5F, 4.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(0, 45)
				.addBox(-3.0F, -3.5F, 13.5F, 4.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(0, 26).addBox(-4.0F, -4.0F, 0.5F, 8.0F, 4.0F, 11.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(1.0F, -10.0F, -3.5F, -0.2618F, 0.0F, 0.0F));
		PartDefinition lefthand = partdefinition.addOrReplaceChild("lefthand",
				...
				PartPose.offsetAndRotation(8.9745F, 15.3064F, 0.4619F, 0.0F, 0.2182F, 0.0F));
		PartDefinition cube_r4 = lefthand.addOrReplaceChild("cube_r4", CubeListBuilder.create().texOffs(54, 49).addBox(0.0325F, -1.8098F, -7.1351F, 1.0F, 1.0F, 4.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-0.7405F, 2.8651F, -10.1104F, 0.2618F, -0.829F, 0.0F));
		PartDefinition cube_r5 = lefthand.addOrReplaceChild("cube_r5", CubeListBuilder.create().texOffs(54, 49).addBox(1.1898F, -0.6715F, -6.3054F, 1.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-0.7405F, 2.8651F, -10.1104F, 0.0F, -0.3491F, 0.0F));
		PartDefinition cube_r6 = lefthand.addOrReplaceChild("cube_r6", CubeListBuilder.create().texOffs(54, 49).addBox(-0.2506F, -0.6715F, -6.2563F, 1.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-0.7405F, 2.8651F, -10.1104F, 0.0F, -0.2182F, 0.0F));
		PartDefinition cube_r7 = lefthand.addOrReplaceChild("cube_r7", CubeListBuilder.create().texOffs(54, 49).addBox(1.0473F, -1.7235F, -6.2071F, 1.0F, 1.0F, 4.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-0.7405F, 2.8651F, -10.1104F, 0.3054F, 0.3491F, 0.0F));
		PartDefinition cube_r8 = lefthand.addOrReplaceChild("cube_r8", CubeListBuilder.create().texOffs(54, 49).addBox(1.991F, -3.5715F, -7.8006F, 1.0F, 1.0F, 3.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-0.7405F, 2.8651F, -10.1104F, 0.5236F, -0.2182F, 0.0F));
		PartDefinition cube_r9 = lefthand.addOrReplaceChild("cube_r9", CubeListBuilder.create().texOffs(48, 58).addBox(-1.123F, -1.2287F, -4.239F, 4.0F, 2.0F, 4.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-0.7405F, 2.8651F, -10.1104F, 0.0F, -0.3054F, 0.0F));
		PartDefinition cube_r10 = lefthand.addOrReplaceChild("cube_r10", CubeListBuilder.create().texOffs(29, 43).addBox(-1.0F, -1.0F, -1.0F, 2.0F, 2.0F, 5.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.7505F, -2.3064F, -1.411F, 0.6981F, 0.0F, 0.0F));
		PartDefinition cube_r11 = lefthand.addOrReplaceChild("cube_r11", CubeListBuilder.create().texOffs(21, 45).addBox(-1.0F, -1.0F, -0.5F, 2.0F, 3.0F, 1.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition righthand = partdefinition.addOrReplaceChild("righthand",
				...
				PartPose.offsetAndRotation(-7.1906F, 15.3002F, 1.0825F, 0.0F, -0.2182F, 0.0F));
		...
		PartDefinition cube_r17 = righthand.addOrReplaceChild("cube_r17", CubeListBuilder.create().texOffs(48, 58).mirror().addBox(-2.0F, 3.0F, -9.0F, 4.0F, 2.0F, 4.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offsetAndRotation(-0.6171F, -1.3573F, -6.1481F, 0.0F, 0.1309F, 0.0F));
		PartDefinition cube_r18 = righthand.addOrReplaceChild("cube_r18", CubeListBuilder.create().texOffs(29, 43).addBox(-1.0F, -1.0F, -1.0F, 2.0F, 2.0F, 5.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-0.6171F, -2.3002F, -2.0546F, 0.6981F, 0.0F, 0.0F));
		PartDefinition cube_r19 = righthand.addOrReplaceChild("cube_r19", CubeListBuilder.create().texOffs(21, 45).addBox(-1.0F, -1.0F, -0.5F, 2.0F, 3.0F, 1.0F, new CubeDeformation(0.0F)),
